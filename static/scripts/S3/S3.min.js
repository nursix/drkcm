...
p[0].nodeType;return{element:p,isWindow:r,isDocument:v,offset:r||v?{left:0,top:0}:a(m).offset(),scrollLeft:p.scrollLeft(),scrollTop:p.scrollTop(),width:p.outerWidth(),height:p.outerHeight()}}};a.fn.position=function(m){if(!m||!m.of)return n.apply(this,arguments);m=a.extend({},m);var p="string"===typeof m.of?a(document).find(m.of):a(m.of),r=a.position.getWithinInfo(m.within),v=a.position.getScrollInfo(r),x=(m.collision||"flip").split(" "),A={};var t=d(p);p[0].preventDefault&&(m.at="left top");var u=
t.width;var y=t.height;var w=t.offset;var D=a.extend({},w);a.each(["my","at"],function(){var z=(m[this]||"").split(" ");1===z.length&&(z=h.test(z[0])?z.concat(["center"]):f.test(z[0])?["center"].concat(z):["center","center"]);z[0]=h.test(z[0])?z[0]:"center";z[1]=f.test(z[1])?z[1]:"center";var C=k.exec(z[0]);var F=k.exec(z[1]);A[this]=[C?C[0]:0,F?F[0]:0];m[this]=[q.exec(z[0])[0],q.exec(z[1])[0]]});1===x.length&&(x[1]=x[0]);"right"===m.at[0]?D.left+=u:"center"===m.at[0]&&(D.left+=u/2);"bottom"===m.at[1]?
D.top+=y:"center"===m.at[1]&&(D.top+=y/2);var B=b(A.at,u,y);D.left+=B[0];D.top+=B[1];return this.each(function(){var z,C=a(this),F=C.outerWidth(),E=C.outerHeight(),G=parseInt(a.css(this,"marginLeft"),10)||0,H=parseInt(a.css(this,"marginTop"),10)||0,I=F+G+(parseInt(a.css(this,"marginRight"),10)||0)+v.width,K=E+H+(parseInt(a.css(this,"marginBottom"),10)||0)+v.height,M=a.extend({},D),S=b(A.my,C.outerWidth(),C.outerHeight());"right"===m.my[0]?M.left-=F:"center"===m.my[0]&&(M.left-=F/2);"bottom"===m.my[1]?
M.top-=E:"center"===m.my[1]&&(M.top-=E/2);M.left+=S[0];M.top+=S[1];var Q={marginLeft:G,marginTop:H};a.each(["left","top"],function(L,P){if(a.ui.position[x[L]])a.ui.position[x[L]][P](M,{targetWidth:u,targetHeight:y,elemWidth:F,elemHeight:E,collisionPosition:Q,collisionWidth:I,collisionHeight:K,offset:[B[0]+S[0],B[1]+S[1]],my:m.my,at:m.at,within:r,elem:C})});m.using&&(z=function(L){var P=w.left-M.left,R=P+u-F,O=w.top-M.top,U=O+y-E,N={target:{element:p,left:w.left,top:w.top,width:u,height:y},element:{element:C,
left:M.left,top:M.top,width:F,height:E},horizontal:0>R?"left":0<P?"right":"center",vertical:0>U?"top":0<O?"bottom":"middle"};u<F&&e(P+R)<u&&(N.horizontal="center");y<E&&e(O+U)<y&&(N.vertical="middle");c(e(P),e(R))>c(e(O),e(U))?N.important="horizontal":N.important="vertical";m.using.call(this,L,N)});C.offset(a.extend(M,{using:z}))})};a.ui.position={fit:{left:function(m,p){var r=p.within,v=r.isWindow?r.scrollLeft:r.offset.left,x=r.width,A=m.left-p.collisionPosition.marginLeft;r=v-A;var t=A+p.collisionWidth-
x-v;p.collisionWidth>x?0<r&&0>=t?(p=m.left+r+p.collisionWidth-x-v,m.left+=r-p):m.left=0<t&&0>=r?v:r>t?v+x-p.collisionWidth:v:m.left=0<r?m.left+r:0<t?m.left-t:c(m.left-A,m.left)},top:function(m,p){var r=p.within,v=r.isWindow?r.scrollTop:r.offset.top,x=p.within.height,A=m.top-p.collisionPosition.marginTop;r=v-A;var t=A+p.collisionHeight-x-v;p.collisionHeight>x?0<r&&0>=t?(p=m.top+r+p.collisionHeight-x-v,m.top+=r-p):m.top=0<t&&0>=r?v:r>t?v+x-p.collisionHeight:v:m.top=0<r?m.top+r:0<t?m.top-t:c(m.top-A,
m.top)}},flip:{left:function(m,p){var r=p.within,v=r.offset.left+r.scrollLeft,x=r.width,A=r.isWindow?r.scrollLeft:r.offset.left,t=m.left-p.collisionPosition.marginLeft;r=t-A;var u=t+p.collisionWidth-x-A;t="left"===p.my[0]?-p.elemWidth:"right"===p.my[0]?p.elemWidth:0;var y="left"===p.at[0]?p.targetWidth:"right"===p.at[0]?-p.targetWidth:0,w=-2*p.offset[0];if(0>r){if(p=m.left+t+y+w+p.collisionWidth-x-v,0>p||p<e(r))m.left+=t+y+w}else 0<u&&(p=m.left-p.collisionPosition.marginLeft+t+y+w-A,0<p||e(p)<u)&&
(m.left+=t+y+w)},top:function(m,p){var r=p.within,v=r.offset.top+r.scrollTop,x=r.height,A=r.isWindow?r.scrollTop:r.offset.top,t=m.top-p.collisionPosition.marginTop;r=t-A;var u=t+p.collisionHeight-x-A;t="top"===p.my[1]?-p.elemHeight:"bottom"===p.my[1]?p.elemHeight:0;var y="top"===p.at[1]?p.targetHeight:"bottom"===p.at[1]?-p.targetHeight:0,w=-2*p.offset[1];if(0>r){if(p=m.top+t+y+w+p.collisionHeight-x-v,0>p||p<e(r))m.top+=t+y+w}else 0<u&&(p=m.top-p.collisionPosition.marginTop+t+y+w-A,0<p||e(p)<u)&&(m.top+=
t+y+w)}},flipfit:{left:function(){a.ui.position.flip.left.apply(this,arguments);a.ui.position.fit.left.apply(this,arguments)},top:function(){a.ui.position.flip.top.apply(this,arguments);a.ui.position.fit.top.apply(this,arguments)}}}})();return a.ui.position});
...
q.monthNamesShort:null)||this._defaults.monthNamesShort,x=(q?q.monthNames:null)||this._defaults.monthNames,A=q=-1,t=-1,u=-1,y=!1,w=function(F){(F=l+1<f.length&&f.charAt(l+1)===F)&&l++;return F},D=function(F){var E=w(F);E="@"===F?14:"!"===F?20:"y"===F&&E?4:"o"===F?3:2;F=new RegExp("^\\d{"+("y"===F?E:1)+","+E+"}");F=k.substring(n).match(F);if(!F)throw"Missing number at position "+n;n+=F[0].length;return parseInt(F[0],10)},B=function(F,E,G){var H=-1;F=a.map(w(F)?G:E,function(I,K){return[[K,I]]}).sort(function(I,
K){return-(I[1].length-K[1].length)});a.each(F,function(I,K){I=K[1];if(k.substr(n,I.length).toLowerCase()===I.toLowerCase())return H=K[0],n+=I.length,!1});if(-1!==H)return H+1;throw"Unknown name at position "+n;},z=function(){if(k.charAt(n)!==f.charAt(l))throw"Unexpected literal at position "+n;n++};for(l=0;l<f.length;l++)if(y)"'"!==f.charAt(l)||w("'")?z():y=!1;else switch(f.charAt(l)){case "d":t=D("d");break;case "D":B("D",p,r);break;case "o":u=D("o");break;case "m":A=D("m");break;case "M":A=B("M",
v,x);break;case "y":q=D("y");break;case "@":var C=new Date(D("@"));q=C.getFullYear();A=C.getMonth()+1;t=C.getDate();break;case "!":C=new Date((D("!")-this._ticksTo1970)/1E4);q=C.getFullYear();A=C.getMonth()+1;t=C.getDate();break;case "'":w("'")?z():y=!0;break;default:z()}if(n<k.length&&(p=k.substr(n),!/^\s+/.test(p)))throw"Extra/unparsed characters found in date: "+p;-1===q?q=(new Date).getFullYear():100>q&&(q+=(new Date).getFullYear()-(new Date).getFullYear()%100+(q<=m?0:-100));if(-1<u){A=1;t=u;
do{m=this._getDaysInMonth(q,A-1);if(t<=m)break;A++;t-=m}while(1)}C=this._daylightSavingAdjust(new Date(q,A-1,t));if(C.getFullYear()!==q||C.getMonth()+1!==A||C.getDate()!==t)throw"Invalid date";return C},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:62135596800*1E7,formatDate:function(f,k,q){if(!k)return"";var l,n=(q?q.dayNamesShort:
null)||this._defaults.dayNamesShort,m=(q?q.dayNames:null)||this._defaults.dayNames,p=(q?q.monthNamesShort:null)||this._defaults.monthNamesShort;q=(q?q.monthNames:null)||this._defaults.monthNames;var r=function(u){(u=l+1<f.length&&f.charAt(l+1)===u)&&l++;return u},v=function(u,y,w){y=""+y;if(r(u))for(;y.length<w;)y="0"+y;return y},x=function(u,y,w,D){return r(u)?D[y]:w[y]},A="",t=!1;if(k)for(l=0;l<f.length;l++)if(t)"'"!==f.charAt(l)||r("'")?A+=f.charAt(l):t=!1;else switch(f.charAt(l)){case "d":A+=
v("d",k.getDate(),2);break;case "D":A+=x("D",k.getDay(),n,m);break;case "o":A+=v("o",Math.round(((new Date(k.getFullYear(),k.getMonth(),k.getDate())).getTime()-(new Date(k.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":A+=v("m",k.getMonth()+1,2);break;case "M":A+=x("M",k.getMonth(),p,q);break;case "y":A+=r("y")?k.getFullYear():(10>k.getFullYear()%100?"0":"")+k.getFullYear()%100;break;case "@":A+=k.getTime();break;case "!":A+=1E4*k.getTime()+this._ticksTo1970;break;case "'":r("'")?A+="'":
t=!0;break;default:A+=f.charAt(l)}return A},_possibleChars:function(f){var k,q="",l=!1,n=function(m){(m=k+1<f.length&&f.charAt(k+1)===m)&&k++;return m};for(k=0;k<f.length;k++)if(l)"'"!==f.charAt(k)||n("'")?q+=f.charAt(k):l=!1;else switch(f.charAt(k)){case "d":case "m":case "y":case "@":q+="0123456789";break;case "D":case "M":return null;case "'":n("'")?q+="'":l=!0;break;default:q+=f.charAt(k)}return q},_get:function(f,k){return void 0!==f.settings[k]?f.settings[k]:this._defaults[k]},_setDateFromField:function(f,
...
this._get(f,"defaultDate"),new Date))},_determineDate:function(f,k,q){var l=function(m){var p=new Date;p.setDate(p.getDate()+m);return p},n=function(m){try{return a.datepicker.parseDate(a.datepicker._get(f,"dateFormat"),m,a.datepicker._getFormatConfig(f))}catch(t){}var p=(m.toLowerCase().match(/^c/)?a.datepicker._getDate(f):null)||new Date,r=p.getFullYear(),v=p.getMonth();p=p.getDate();for(var x=/([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g,A=x.exec(m);A;){switch(A[2]||"d"){case "d":case "D":p+=parseInt(A[1],
10);break;case "w":case "W":p+=7*parseInt(A[1],10);break;case "m":case "M":v+=parseInt(A[1],10);p=Math.min(p,a.datepicker._getDaysInMonth(r,v));break;case "y":case "Y":r+=parseInt(A[1],10),p=Math.min(p,a.datepicker._getDaysInMonth(r,v))}A=x.exec(m)}return new Date(r,v,p)};if(k=(k=null==k||""===k?q:"string"===typeof k?n(k):"number"===typeof k?isNaN(k)?q:l(k):new Date(k.getTime()))&&"Invalid Date"===k.toString()?q:k)k.setHours(0),k.setMinutes(0),k.setSeconds(0),k.setMilliseconds(0);return this._daylightSavingAdjust(k)},
...
"isRTL");var r=this._get(f,"showButtonPanel");var v=this._get(f,"hideIfNoPrevNext");var x=this._get(f,"navigationAsDateFormat");var A=this._getNumberOfMonths(f),t=this._get(f,"showCurrentAtPos");var u=this._get(f,"stepMonths");var y=1!==A[0]||1!==A[1],w=this._daylightSavingAdjust(f.currentDay?new Date(f.currentYear,f.currentMonth,f.currentDay):new Date(9999,9,9)),D=this._getMinMaxDate(f,"min"),B=this._getMinMaxDate(f,"max");t=f.drawMonth-t;var z=f.drawYear;0>t&&(t+=12,z--);if(B){var C=this._daylightSavingAdjust(new Date(B.getFullYear(),
B.getMonth()-A[0]*A[1]+1,B.getDate()));for(C=D&&C<D?D:C;this._daylightSavingAdjust(new Date(z,t,1))>C;)t--,0>t&&(t=11,z--)}f.drawMonth=t;f.drawYear=z;C=this._get(f,"prevText");C=x?this.formatDate(C,this._daylightSavingAdjust(new Date(z,t-u,1)),this._getFormatConfig(f)):C;C=this._canAdjustMonth(f,-1,z,t)?a("<a>").attr({"class":"ui-datepicker-prev ui-corner-all","data-handler":"prev","data-event":"click",title:C}).append(a("<span>").addClass("ui-icon ui-icon-circle-triangle-"+(p?"e":"w")).text(C))[0].outerHTML:
v?"":a("<a>").attr({"class":"ui-datepicker-prev ui-corner-all ui-state-disabled",title:C}).append(a("<span>").addClass("ui-icon ui-icon-circle-triangle-"+(p?"e":"w")).text(C))[0].outerHTML;var F=this._get(f,"nextText");F=x?this.formatDate(F,this._daylightSavingAdjust(new Date(z,t+u,1)),this._getFormatConfig(f)):F;v=this._canAdjustMonth(f,1,z,t)?a("<a>").attr({"class":"ui-datepicker-next ui-corner-all","data-handler":"next","data-event":"click",title:F}).append(a("<span>").addClass("ui-icon ui-icon-circle-triangle-"+
(p?"w":"e")).text(F))[0].outerHTML:v?"":a("<a>").attr({"class":"ui-datepicker-next ui-corner-all ui-state-disabled",title:F}).append(a("<span>").attr("class","ui-icon ui-icon-circle-triangle-"+(p?"w":"e")).text(F))[0].outerHTML;u=this._get(f,"currentText");F=this._get(f,"gotoCurrent")&&f.currentDay?w:m;u=x?this.formatDate(u,F,this._getFormatConfig(f)):u;var E="";f.inline||(E=a("<button>").attr({type:"button","class":"ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all","data-handler":"hide",
"data-event":"click"}).text(this._get(f,"closeText"))[0].outerHTML);x="";r&&(x=a("<div class='ui-datepicker-buttonpane ui-widget-content'>").append(p?E:"").append(this._isInRange(f,F)?a("<button>").attr({type:"button","class":"ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all","data-handler":"today","data-event":"click"}).text(u):"").append(p?"":E)[0].outerHTML);r=parseInt(this._get(f,"firstDay"),10);r=isNaN(r)?0:r;u=this._get(f,"showWeek");F=this._get(f,"dayNames");E=this._get(f,
"dayNamesMin");var G=this._get(f,"monthNames");var H=this._get(f,"monthNamesShort");var I=this._get(f,"beforeShowDay");var K=this._get(f,"showOtherMonths");var M=this._get(f,"selectOtherMonths");var S=this._getDefaultDate(f);var Q="";for(k=0;k<A[0];k++){var L="";this.maxRows=4;for(q=0;q<A[1];q++){var P=this._daylightSavingAdjust(new Date(z,t,f.selectedDay));var R=" ui-corner-all";var O="";if(y){O+="<div class='ui-datepicker-group";if(1<A[1])switch(q){case 0:O+=" ui-datepicker-group-first";R=" ui-corner-"+
(p?"right":"left");break;case A[1]-1:O+=" ui-datepicker-group-last";R=" ui-corner-"+(p?"left":"right");break;default:O+=" ui-datepicker-group-middle",R=""}O+="'>"}O+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+R+"'>"+(/all|left/.test(R)&&0===k?p?v:C:"")+(/all|right/.test(R)&&0===k?p?C:v:"")+this._generateMonthYearHeader(f,t,z,D,B,0<k||0<q,G,H)+"</div><table class='ui-datepicker-calendar'><thead><tr>";var U=u?"<th class='ui-datepicker-week-col'>"+this._get(f,"weekHeader")+
"</th>":"";for(R=0;7>R;R++){var N=(R+r)%7;U+="<th scope='col'"+(5<=(R+r+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+F[N]+"'>"+E[N]+"</span></th>"}O+=U+"</tr></thead><tbody>";U=this._getDaysInMonth(z,t);z===f.selectedYear&&t===f.selectedMonth&&(f.selectedDay=Math.min(f.selectedDay,U));R=(this._getFirstDayOfMonth(z,t)-r+7)%7;U=Math.ceil((R+U)/7);this.maxRows=U=y?this.maxRows>U?this.maxRows:U:U;N=this._daylightSavingAdjust(new Date(z,t,1-R));for(l=0;l<U;l++){O+="<tr>";var ca=u?"<td class='ui-datepicker-week-col'>"+
this._get(f,"calculateWeek")(N)+"</td>":"";for(R=0;7>R;R++){var da=I?I.apply(f.input?f.input[0]:null,[N]):[!0,""];var ha=(n=N.getMonth()!==t)&&!M||!da[0]||D&&N<D||B&&N>B;ca+="<td class='"+(5<=(R+r+6)%7?" ui-datepicker-week-end":"")+(n?" ui-datepicker-other-month":"")+(N.getTime()===P.getTime()&&t===f.selectedMonth&&f._keyEvent||S.getTime()===N.getTime()&&S.getTime()===P.getTime()?" "+this._dayOverClass:"")+(ha?" "+this._unselectableClass+" ui-state-disabled":"")+(n&&!K?"":" "+da[1]+(N.getTime()===
...
"")+"' href='#' aria-current='"+(N.getTime()===w.getTime()?"true":"false")+"' data-date='"+N.getDate()+"'>"+N.getDate()+"</a>")+"</td>";N.setDate(N.getDate()+1);N=this._daylightSavingAdjust(N)}O+=ca+"</tr>"}t++;11<t&&(t=0,z++);O+="</tbody></table>"+(y?"</div>"+(0<A[0]&&q===A[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");L+=O}Q+=L}f._keyEvent=!1;return Q+x},_generateMonthYearHeader:function(f,k,q,l,n,m,p,r){var v=this._get(f,"changeMonth"),x=this._get(f,"changeYear"),A=this._get(f,"showMonthAfterYear");
var t=this._get(f,"selectMonthLabel");var u=this._get(f,"selectYearLabel"),y="<div class='ui-datepicker-title'>",w="";if(m||!v)w+="<span class='ui-datepicker-month'>"+p[k]+"</span>";else{p=l&&l.getFullYear()===q;var D=n&&n.getFullYear()===q;w+="<select class='ui-datepicker-month' aria-label='"+t+"' data-handler='selectMonth' data-event='change'>";for(t=0;12>t;t++)(!p||t>=l.getMonth())&&(!D||t<=n.getMonth())&&(w+="<option value='"+t+"'"+(t===k?" selected='selected'":"")+">"+r[t]+"</option>");w+="</select>"}A||
(y+=w+(!m&&v&&x?"":"&#xa0;"));if(!f.yearshtml)if(f.yearshtml="",m||!x)y+="<span class='ui-datepicker-year'>"+q+"</span>";else{r=this._get(f,"yearRange").split(":");var B=(new Date).getFullYear();p=function(z){z=z.match(/c[+\-].*/)?q+parseInt(z.substring(1),10):z.match(/[+\-].*/)?B+parseInt(z,10):parseInt(z,10);return isNaN(z)?B:z};k=p(r[0]);r=Math.max(k,p(r[1]||""));k=l?Math.max(k,l.getFullYear()):k;r=n?Math.min(r,n.getFullYear()):r;for(f.yearshtml+="<select class='ui-datepicker-year' aria-label='"+
u+"' data-handler='selectYear' data-event='change'>";k<=r;k++)f.yearshtml+="<option value='"+k+"'"+(k===q?" selected='selected'":"")+">"+k+"</option>";f.yearshtml+="</select>";y+=f.yearshtml;f.yearshtml=null}y+=this._get(f,"yearSuffix");A&&(y+=(!m&&v&&x?"":"&#xa0;")+w);return y+"</div>"},_adjustInstDate:function(f,k,q){var l=f.selectedYear+("Y"===q?k:0),n=f.selectedMonth+("M"===q?k:0);k=Math.min(f.selectedDay,this._getDaysInMonth(l,n))+("D"===q?k:0);l=this._restrictMinMax(f,this._daylightSavingAdjust(new Date(l,
...
f+"Datepicker"].apply(a.datepicker,[this[0]].concat(k)):this.each(function(){"string"===typeof f?a.datepicker["_"+f+"Datepicker"].apply(a.datepicker,[this].concat(k)):a.datepicker._attachDatepicker(this,f)})};a.datepicker=new d;a.datepicker.initialized=!1;a.datepicker.uuid=(new Date).getTime();a.datepicker.version="1.13.1";return a.datepicker});
...
g.options.snap.release.call(g.element,b,a.extend(g._uiHash(),{snapItem:g.snapElements[c].item})),g.snapElements[c].snapping=!1;else{if("inner"!==e.snapMode){var v=Math.abs(p-l)<=h;var x=Math.abs(r-q)<=h;var A=Math.abs(n-k)<=h;var t=Math.abs(m-f)<=h;v&&(d.position.top=g._convertPositionTo("relative",{top:p-g.helperProportions.height,left:0}).top);x&&(d.position.top=g._convertPositionTo("relative",{top:r,left:0}).top);A&&(d.position.left=g._convertPositionTo("relative",{top:0,left:n-g.helperProportions.width}).left);
t&&(d.position.left=g._convertPositionTo("relative",{top:0,left:m}).left)}var u=v||x||A||t;"outer"!==e.snapMode&&(v=Math.abs(p-q)<=h,x=Math.abs(r-l)<=h,A=Math.abs(n-f)<=h,t=Math.abs(m-k)<=h,v&&(d.position.top=g._convertPositionTo("relative",{top:p,left:0}).top),x&&(d.position.top=g._convertPositionTo("relative",{top:r-g.helperProportions.height,left:0}).top),A&&(d.position.left=g._convertPositionTo("relative",{top:0,left:n}).left),t&&(d.position.left=g._convertPositionTo("relative",{top:0,left:m-
g.helperProportions.width}).left));!g.snapElements[c].snapping&&(v||x||A||t||u)&&g.options.snap.snap&&g.options.snap.snap.call(g.element,b,a.extend(g._uiHash(),{snapItem:g.snapElements[c].item}));g.snapElements[c].snapping=v||x||A||t||u}}}});a.ui.plugin.add("draggable","stack",{start:function(b,d,g){b=a.makeArray(a(g.options.stack)).sort(function(e,h){return(parseInt(a(e).css("zIndex"),10)||0)-(parseInt(a(h).css("zIndex"),10)||0)});if(b.length){var c=parseInt(a(b[0]).css("zIndex"),10)||0;a(b).each(function(e){a(this).css("zIndex",
...
m,v=d.minWidth&&d.minWidth>n,x=d.minHeight&&d.minHeight>m;d.grid=f;v&&(n+=k);x&&(m+=q);p&&(n-=k);r&&(m-=q);if(/^(se|s|e)$/.test(h))b.size.width=n,b.size.height=m;else if(/^(ne)$/.test(h))b.size.width=n,b.size.height=m,b.position.top=e.top-g;else if(/^(sw)$/.test(h))b.size.width=n,b.size.height=m,b.position.left=e.left-l;else{if(0>=m-q||0>=n-k)var A=b._getPaddingPlusBorderDimensions(this);0<m-q?(b.size.height=m,b.position.top=e.top-g):(m=q-A.height,b.size.height=m,b.position.top=e.top+c.height-m);
0<n-k?(b.size.width=n,b.position.left=e.left-l):(n=k-A.width,b.size.width=n,b.position.left=e.left+c.width-n)}}});return a.ui.resizable});
...
var n=1==this._get(c,"showMinutes"),m=this._get(c,"amPmText"),p=this._get(c,"rows"),r=0,v=0,x=h=0,A=0,t=0,u=[],y=this._get(c,"hours"),w=0;var D=this._get(c,"hourText");var B=this._get(c,"showCloseButton"),z=this._get(c,"closeButtonText"),C=this._get(c,"showNowButton"),F=this._get(c,"nowButtonText"),E=this._get(c,"showDeselectButton"),G=this._get(c,"deselectButtonText"),H=B||C||E;for(e=y.starts;e<=y.ends;e++)u.push(e);e=Math.ceil(u.length/p);if(k){for(w=0;w<u.length;w++)12>u[w]?h++:x++;w=0;r=Math.floor(h/
u.length*p);v=Math.floor(x/u.length*p);p!=r+v&&(h&&(!x||!r||v&&h/r>=x/v)?r++:v++);A=Math.min(r,1);t=r+1;e=0==r?Math.ceil(x/v):0==v?Math.ceil(h/r):Math.ceil(Math.max(h/r,x/v))}h='<table class="ui-timepicker-table ui-widget-content ui-corner-all"><tr>';if(l){h+='<td class="ui-timepicker-hours"><div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+D+'</div><table class="ui-timepicker">';for(l=1;l<=p;l++){h+="<tr>";l==A&&k&&(h+='<th rowspan="'+r.toString()+'" class="periods" scope="row">'+
m[0]+"</th>");l==t&&k&&(h+='<th rowspan="'+v.toString()+'" class="periods" scope="row">'+m[1]+"</th>");for(D=1;D<=e;D++)k&&l<t&&12<=u[w]?h+=this._generateHTMLHourCell(c,void 0,f,q):(h+=this._generateHTMLHourCell(c,u[w],f,q),w++);h+="</tr>"}h+="</table></td>"}n&&(h=h+'<td class="ui-timepicker-minutes">'+this._generateHTMLMinutes(c),h+="</td>");h+="</tr>";H&&(f='<tr><td colspan="3"><div class="ui-timepicker-buttonpane ui-widget-content">',C&&(f+='<button type="button" class="ui-timepicker-now ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+
c.id.replace(/\\\\/g,"\\")+'" >'+F+"</button>"),E&&(f+='<button type="button" class="ui-timepicker-deselect ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+c.id.replace(/\\\\/g,"\\")+'" >'+G+"</button>"),B&&(f+='<button type="button" class="ui-timepicker-close ui-state-default ui-corner-all"  data-timepicker-instance-id="#'+c.id.replace(/\\\\/g,"\\")+'" >'+z+"</button>"),h+=f+"</div></td></tr>");return h+"</table>"},_updateMinuteDisplay:function(c){var e=this._generateHTMLMinutes(c);
...
k.push(e);k.sort(function(v,x){return v-x});l=Math.round(k.length/f+.49);if(p&&0==p.apply(c.input?c.input[0]:null,[c.hours,c.minutes]))for(n=0;n<k.length;n+=1)if(e=k[n],p.apply(c.input?c.input[0]:null,[c.hours,e])){c.minutes=e;break}h+='<div class="ui-timepicker-title ui-widget-header ui-helper-clearfix ui-corner-all">'+r+'</div><table class="ui-timepicker">';n=0;for(q=1;q<=f;q++){for(h+="<tr>";n<q*l;)e=k[n],p="",void 0!==e&&(p=10>e&&m?"0"+e.toString():e.toString()),h+=this._generateHTMLMinuteCell(c,
...
formattedTime:"",formattedDateTime:"",timezoneList:null,units:["hour","minute","second","millisec","microsec"],support:{},control:null,setDefaults:function(l){g(this._defaults,l||{});return this},_newInst:function(l,n){var m=new b,p={},r={};for(x in this._defaults)if(this._defaults.hasOwnProperty(x)){var v=l.attr("time:"+x);if(v)try{p[x]=eval(v)}catch(t){p[x]=v}}var x={beforeShow:function(t,u){if(a.isFunction(m._defaults.evnts.beforeShow))return m._defaults.evnts.beforeShow.call(l[0],t,u,m)},onChangeMonthYear:function(t,
u,y){a.isFunction(m._defaults.evnts.onChangeMonthYear)&&m._defaults.evnts.onChangeMonthYear.call(l[0],t,u,y,m)},onClose:function(t,u){!0===m.timeDefined&&""!==l.val()&&m._updateDateTime(u);a.isFunction(m._defaults.evnts.onClose)&&m._defaults.evnts.onClose.call(l[0],t,u,m)}};for(A in x)x.hasOwnProperty(A)&&(r[A]=n[A]||this._defaults[A]||null);m._defaults=a.extend({},this._defaults,p,n,x,{evnts:r,timepicker:m});m.amNames=a.map(m._defaults.amNames,function(t){return t.toUpperCase()});m.pmNames=a.map(m._defaults.pmNames,
...
if(!l)return!1;a.extend(this,l)}return!0},_afterInject:function(){var l=this.inst.settings;a.isFunction(l.afterInject)&&l.afterInject.call(this)},_injectTimePicker:function(){var l=this.inst.dpDiv,n=this.inst.settings,m=this,p="",r="",v=null,x={},A={},t=null,u=0,y=0;if(0===l.find("div.ui-timepicker-div").length&&n.showTimepicker){t='<div class="ui-timepicker-div'+(n.isRTL?" ui-timepicker-rtl":"")+(n.oneLine&&"select"===n.controlType?" ui-timepicker-oneLine":"")+'"><dl><dt class="ui_tpicker_time_label'+
(n.showTime?"":" ui_tpicker_unit_hide")+'">'+n.timeText+'</dt><dd class="ui_tpicker_time '+(n.showTime?"":" ui_tpicker_unit_hide")+'"><input class="ui_tpicker_time_input" '+(n.timeInput?"":"disabled")+"/></dd>";u=0;for(y=this.units.length;u<y;u++){p=this.units[u];r=p.substr(0,1).toUpperCase()+p.substr(1);v=null!==n["show"+r]?n["show"+r]:this.support[p];x[p]=parseInt(n[p+"Max"]-(n[p+"Max"]-n[p+"Min"])%n["step"+r],10);A[p]=0;t+='<dt class="ui_tpicker_'+p+"_label"+(v?"":" ui_tpicker_unit_hide")+'">'+
n[p+"Text"]+'</dt><dd class="ui_tpicker_'+p+(v?"":" ui_tpicker_unit_hide")+'"><div class="ui_tpicker_'+p+"_slider"+(v?"":" ui_tpicker_unit_hide")+'"></div>';if(v&&0<n[p+"Grid"]){t+='<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>';if("hour"===p)for(r=n[p+"Min"];r<=x[p];r+=parseInt(n[p+"Grid"],10))A[p]++,v=a.datepicker.formatTime(this.support.ampm?"hht":"HH",{hour:r},n),t+='<td data-for="'+p+'">'+v+"</td>";else for(r=n[p+"Min"];r<=x[p];r+=parseInt(n[p+"Grid"],10))A[p]++,t+=
...
l.find(".ui-datepicker-header, .ui-datepicker-calendar").hide());u=0;for(y=m.units.length;u<y;u++)p=m.units[u],r=p.substr(0,1).toUpperCase()+p.substr(1),v=null!==n["show"+r]?n["show"+r]:this.support[p],m[p+"_slider"]=m.control.create(m,w.find(".ui_tpicker_"+p+"_slider"),p,m[p],n[p+"Min"],x[p],n["step"+r]),v&&0<n[p+"Grid"]&&(t=100*A[p]*n[p+"Grid"]/(x[p]-n[p+"Min"]),w.find(".ui_tpicker_"+p+" table").css({width:t+"%",marginLeft:n.isRTL?"0":t/(-2*A[p])+"%",marginRight:n.isRTL?t/(-2*A[p])+"%":"0",borderCollapse:"collapse"}).find("td").click(function(z){var C=
a(this),F=C.html();z=parseInt(F.replace(/[^0-9]/g),10);F=F.replace(/[^apm]/ig);C=C.data("for");"hour"===C&&(-1!==F.indexOf("p")&&12>z?z+=12:-1!==F.indexOf("a")&&12===z&&(z=0));m.control.value(m,m[C+"_slider"],p,z);m._onTimeChange();m._onSelectHandler()}).css({cursor:"pointer",width:100/A[p]+"%",textAlign:"center",overflow:"hidden"}));this.timezone_select=w.find(".ui_tpicker_timezone").append("<select></select>").find("select");a.fn.append.apply(this.timezone_select,a.map(n.timezoneList,function(z,
C){return a("<option />").val("object"===typeof z?z.value:z).text("object"===typeof z?z.label:z)}));"undefined"!==typeof this.timezone&&null!==this.timezone&&""!==this.timezone?-1*(new Date(this.inst.selectedYear,this.inst.selectedMonth,this.inst.selectedDay,12)).getTimezoneOffset()===this.timezone?q(m):this.timezone_select.val(this.timezone):"undefined"!==typeof this.hour&&null!==this.hour&&""!==this.hour?this.timezone_select.val(n.timezone):q(m);this.timezone_select.change(function(){m._onTimeChange();
m._onSelectHandler();m._afterInject()});n=l.find(".ui-datepicker-buttonpane");n.length?n.before(w):l.append(w);this.$timeObj=w.find(".ui_tpicker_time_input");this.$timeObj.change(function(){var z=a.datepicker.parseTime(m.inst.settings.timeFormat,this.value),C=new Date;z?(C.setHours(z.hour),C.setMinutes(z.minute),C.setSeconds(z.second),a.datepicker._setTime(m.inst,C)):(this.value=m.formattedTime,this.blur())});null!==this.inst&&(l=this.timeDefined,this._onTimeChange(),this.timeDefined=l);if(this._defaults.addSliderAccess){var D=
this._defaults.sliderAccessArgs,B=this._defaults.isRTL;D.isRTL=B;setTimeout(function(){if(0===w.find(".ui-slider-access").length){w.find(".ui-slider:visible").sliderAccess(D);var z=w.find(".ui-slider-access:eq(0)").outerWidth(!0);z&&w.find("table:visible").each(function(){var C=a(this),F=C.outerWidth(),E=C.css(B?"marginRight":"marginLeft").toString().replace("%",""),G=F-z,H={width:G,marginRight:0,marginLeft:0};H[B?"marginRight":"marginLeft"]=E*G/F+"%";C.css(H)})}},10)}m._limitMinMaxDateTime(this.inst,
...
"hour"):!1,n=this.minute_slider?this.control.value(this,this.minute_slider,"minute"):!1,m=this.second_slider?this.control.value(this,this.second_slider,"second"):!1,p=this.millisec_slider?this.control.value(this,this.millisec_slider,"millisec"):!1,r=this.microsec_slider?this.control.value(this,this.microsec_slider,"microsec"):!1,v=this.timezone_select?this.timezone_select.val():!1,x=this._defaults,A=x.pickerTimeFormat||x.timeFormat,t=x.pickerTimeSuffix||x.timeSuffix;"object"===typeof l&&(l=!1);"object"===
typeof n&&(n=!1);"object"===typeof m&&(m=!1);"object"===typeof p&&(p=!1);"object"===typeof r&&(r=!1);"object"===typeof v&&(v=!1);!1!==l&&(l=parseInt(l,10));!1!==n&&(n=parseInt(n,10));!1!==m&&(m=parseInt(m,10));!1!==p&&(p=parseInt(p,10));!1!==r&&(r=parseInt(r,10));!1!==v&&(v=v.toString());var u=x[12>l?"amNames":"pmNames"][0],y=l!==parseInt(this.hour,10)||n!==parseInt(this.minute,10)||m!==parseInt(this.second,10)||p!==parseInt(this.millisec,10)||r!==parseInt(this.microsec,10)||0<this.ampm.length&&12>
l!==(-1!==a.inArray(this.ampm.toUpperCase(),this.amNames))||null!==this.timezone&&v!==this.timezone.toString();y&&(!1!==l&&(this.hour=l),!1!==n&&(this.minute=n),!1!==m&&(this.second=m),!1!==p&&(this.millisec=p),!1!==r&&(this.microsec=r),!1!==v&&(this.timezone=v),this.inst||(this.inst=a.datepicker._getInst(this.$input[0])),this._limitMinMaxDateTime(this.inst,!0));this.support.ampm&&(this.ampm=u);this.formattedTime=a.datepicker.formatTime(x.timeFormat,this,x);this.$timeObj&&(A===x.timeFormat?this.$timeObj.val(this.formattedTime+
t):this.$timeObj.val(a.datepicker.formatTime(A,this,x)+t),this.$timeObj[0].setSelectionRange&&this.$timeObj[0].setSelectionRange(this.$timeObj[0].selectionStart,this.$timeObj[0].selectionEnd));this.timeDefined=!0;y&&this._updateDateTime()}},_onSelectHandler:function(){var l=this._defaults.onSelect||this.inst.settings.onSelect,n=this.$input?this.$input[0]:null;l&&n&&l.apply(n,[this.formattedDateTime,this])},_updateDateTime:function(l){l=this.inst||l;var n=a.datepicker._daylightSavingAdjust(0<l.currentYear?
...
this._defaults.defaultValue){this.$input.val(this._defaults.defaultValue);var l=a.datepicker._getInst(this.$input.get(0)),n=a.datepicker._get(l,"timepicker");if(n&&n._defaults.timeOnly&&l.input.val()!==l.lastVal)try{a.datepicker._updateDatepicker(l)}catch(m){a.timepicker.log(m)}}},_controls:{slider:{create:function(l,n,m,p,r,v,x){var A=l._defaults.isRTL;return n.prop("slide",null).slider({orientation:"horizontal",value:A?-1*p:p,min:A?-1*v:r,max:A?-1*r:v,step:x,slide:function(t,u){l.control.value(l,
a(this),m,A?-1*u.value:u.value);l._onTimeChange()},stop:function(t,u){l._onSelectHandler()}})},options:function(l,n,m,p,r){if(l._defaults.isRTL){if("string"===typeof p)return"min"===p||"max"===p?void 0!==r?n.slider(p,-1*r):Math.abs(n.slider(p)):n.slider(p);l=p.min;m=p.max;p.min=p.max=null;void 0!==l&&(p.max=-1*l);void 0!==m&&(p.min=-1*m);return n.slider(p)}return"string"===typeof p&&void 0!==r?n.slider(p,r):n.slider(p)},value:function(l,n,m,p){return l._defaults.isRTL?void 0!==p?n.slider("value",
-1*p):Math.abs(n.slider("value")):void 0!==p?n.slider("value",p):n.slider("value")}},select:{create:function(l,n,m,p,r,v,x){for(var A='<select class="ui-timepicker-select ui-state-default ui-corner-all" data-unit="'+m+'" data-min="'+r+'" data-max="'+v+'" data-step="'+x+'">',t=l._defaults.pickerTimeFormat||l._defaults.timeFormat;r<=v;r+=x)A+='<option value="'+r+'"'+(r===p?" selected":"")+">",A="hour"===m?A+a.datepicker.formatTime(a.trim(t.replace(/[^ht ]/ig,"")),{hour:r},l._defaults):"millisec"===
m||"microsec"===m||10<=r?A+r:A+("0"+r.toString()),A+="</option>";A+="</select>";n.children("select").remove();a(A).appendTo(n).change(function(u){l._onTimeChange();l._onSelectHandler();l._afterInject()});return n},options:function(l,n,m,p,r){m={};var v=n.children("select");if("string"===typeof p){if(void 0===r)return v.data(p);m[p]=r}else m=p;return l.control.create(l,n,v.data("unit"),v.val(),0<=m.min?m.min:v.data("min"),m.max||v.data("max"),m.step||v.data("step"))},value:function(l,n,m,p){l=n.children("select");
...
a(this);m.datepicker(a.timepicker._newInst(m,l)._defaults)})}});a.datepicker.parseDateTime=function(l,n,m,p,r){l=k(l,n,m,p,r);l.timeObj&&(n=l.timeObj,l.date.setHours(n.hour,n.minute,n.second,n.millisec),l.date.setMicroseconds(n.microsec));return l.date};a.datepicker.parseTime=function(l,n,m){m=g(g({},a.timepicker._defaults),m||{});l.replace(/'.*?'/g,"").indexOf("Z");var p=function(v,x,A){var t=function(w,D){var B=[];w&&a.merge(B,w);D&&a.merge(B,D);B=a.map(B,function(z){return z.replace(/[.*+?|()\[\]{}\\]/g,
"\\$&")});return"("+B.join("|")+")?"},u="^"+v.toString().replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g,function(w){var D=w.length;switch(w.charAt(0).toLowerCase()){case "h":return 1===D?"(\\d?\\d)":"(\\d{"+D+"})";case "m":return 1===D?"(\\d?\\d)":"(\\d{"+D+"})";case "s":return 1===D?"(\\d?\\d)":"(\\d{"+D+"})";case "l":return"(\\d?\\d?\\d)";case "c":return"(\\d?\\d?\\d)";case "z":return"(z|[-+]\\d\\d:?\\d\\d|\\S+)?";case "t":return t(A.amNames,A.pmNames);default:return"("+w.replace(/'/g,
"").replace(/(\.|\$|\^|\\|\/|\(|\)|\[|\]|\?|\+|\*)/g,function(B){return"\\"+B})+")?"}}).replace(/\s/g,"\\s?")+A.timeSuffix+"$";v=function(w){w=w.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|c{1}|t{1,2}|z|'.*?')/g);var D={h:-1,m:-1,s:-1,l:-1,c:-1,t:-1,z:-1};if(w)for(var B=0;B<w.length;B++)-1===D[w[B].toString().charAt(0)]&&(D[w[B].toString().charAt(0)]=B+1);return D}(v);var y="";x=x.match(new RegExp(u,"i"));u={hour:0,minute:0,second:0,millisec:0,microsec:0};return x?(-1!==v.t&&(void 0===x[v.t]||
0===x[v.t].length?(y="",u.ampm=""):(y=-1!==a.inArray(x[v.t].toUpperCase(),a.map(A.amNames,function(w,D){return w.toUpperCase()}))?"AM":"PM",u.ampm=A["AM"===y?"amNames":"pmNames"][0])),-1!==v.h&&(u.hour="AM"===y&&"12"===x[v.h]?0:"PM"===y&&"12"!==x[v.h]?parseInt(x[v.h],10)+12:Number(x[v.h])),-1!==v.m&&(u.minute=Number(x[v.m])),-1!==v.s&&(u.second=Number(x[v.s])),-1!==v.l&&(u.millisec=Number(x[v.l])),-1!==v.c&&(u.microsec=Number(x[v.c])),-1!==v.z&&void 0!==x[v.z]&&(u.timezone=a.timepicker.timezoneOffsetNumber(x[v.z])),
u):!1},r=function(v,x,A){try{var t=new Date("2012-01-01 "+x);if(isNaN(t.getTime())&&(t=new Date("2012-01-01T"+x),isNaN(t.getTime())&&(t=new Date("01/01/2012 "+x),isNaN(t.getTime()))))throw"Unable to parse time with native Date: "+x;return{hour:t.getHours(),minute:t.getMinutes(),second:t.getSeconds(),millisec:t.getMilliseconds(),microsec:t.getMicroseconds(),timezone:-1*t.getTimezoneOffset()}}catch(u){try{return p(v,x,A)}catch(y){a.timepicker.log("Unable to parse \ntimeString: "+x+"\ntimeFormat: "+
...
n._defaults.separator;var x=n._defaults.altTimeSuffix?n._defaults.altTimeSuffix:n._defaults.timeSuffix;x=""+(a.datepicker.formatTime(null!==n._defaults.altTimeFormat?n._defaults.altTimeFormat:n._defaults.timeFormat,n,n._defaults)+x);n._defaults.timeOnly||n._defaults.altFieldTimeOnly||null===p||(x=n._defaults.altFormat?a.datepicker.formatDate(n._defaults.altFormat,p,r)+v+x:n.formattedDate+v+x);a(m).val(l.input.val()?x:"")}}else a.datepicker._base_updateAlternate(l)};a.datepicker._base_doKeyUp=a.datepicker._doKeyUp;
...
a.datepicker._optionDatepicker=function(l,n,m){var p=this._getInst(l);if(!p)return null;if(p=this._get(p,"timepicker")){var r=null,v=null,x=null,A=p._defaults.evnts,t={};if("string"===typeof n)if("minDate"===n||"minDateTime"===n)r=m;else if("maxDate"===n||"maxDateTime"===n)v=m;else if("onSelect"===n)x=m;else{if(A.hasOwnProperty(n)){if("undefined"===typeof m)return A[n];t[n]=m;var u={}}}else if("object"===typeof n)for(y in n.minDate?r=n.minDate:n.minDateTime?r=n.minDateTime:n.maxDate?v=n.maxDate:n.maxDateTime&&
(v=n.maxDateTime),A)A.hasOwnProperty(y)&&n[y]&&(t[y]=n[y]);for(y in t)t.hasOwnProperty(y)&&(A[y]=t[y],u||=a.extend({},n),delete u[y]);if(u&&d(u))return;r?(r=0===r?new Date:new Date(r),p._defaults.minDate=r,p._defaults.minDateTime=r):v?(v=0===v?new Date:new Date(v),p._defaults.maxDate=v,p._defaults.maxDateTime=v):x&&(p._defaults.onSelect=x);if(r||v){p=a(l);var y=p.datetimepicker("getDate");l=this._base_optionDatepicker.call(a.datepicker,l,u||n,m);p.datetimepicker("setDate",y);return l}}return void 0===
...
function(l,n,m){a.timepicker.handleRange("datepicker",l,n,m)};a.timepicker.handleRange=function(l,n,m,p){function r(A,t){var u=n[l]("getDate"),y=m[l]("getDate");A=A[l]("getDate");if(null!==u){var w=new Date(u.getTime()),D=new Date(u.getTime());w.setMilliseconds(w.getMilliseconds()+p.minInterval);D.setMilliseconds(D.getMilliseconds()+p.maxInterval);if(0<p.minInterval&&w>y)m[l]("setDate",w);else if(0<p.maxInterval&&D<y)m[l]("setDate",D);else if(u>y)t[l]("setDate",A)}}function v(A,t,u){A.val()&&(A=A[l].call(A,
"getDate"),null!==A&&0<p.minInterval&&("minDate"===u&&A.setMilliseconds(A.getMilliseconds()+p.minInterval),"maxDate"===u&&A.setMilliseconds(A.getMilliseconds()-p.minInterval)),A.getTime&&t[l].call(t,"option",u,A))}p=a.extend({},{minInterval:0,maxInterval:0,start:{},end:{}},p);var x=!1;"timepicker"===l&&(x=!0,l="datetimepicker");a.fn[l].call(n,a.extend({timeOnly:x,onClose:function(A,t){r(a(this),m)},onSelect:function(A){v(a(this),m,"minDate")}},p,p.start));a.fn[l].call(m,a.extend({timeOnly:x,onClose:function(A,
t){r(a(this),n)},onSelect:function(A){v(a(this),n,"maxDate")}},p,p.end));r(n,m);v(n,m,"minDate");v(m,n,"maxDate");return a([n.get(0),m.get(0)])};a.timepicker.log=function(){window.console&&window.console.log&&window.console.log.apply&&window.console.log.apply(window.console,Array.prototype.slice.call(arguments))};a.timepicker._util={_extendRemove:g,_isEmptyObject:d,_convert24to12:e,_detectSupport:c,_selectLocalTimezone:q,_computeEffectiveSetting:h,_splitDateTime:f,_parseDateTimeInternal:k};Date.prototype.getMicroseconds||
...
this.$inputs=this.$labels.children("input");this.element.is(':data("ech-multiselectfilter")')&&this.element.data("ech-multiselectfilter").updateCache(!0)},resync:function(e){var h=this.$inputs,f=this.element.find("option");if(h.length===f.length){var k={};h.not(e?":disabled":"").each(function(){k[this.value]=this});f.not(e?":disabled":"").each(function(){this.value in k&&(k[this.value].checked=this.selected)});this._trigger("resync");this.update()}else this.refresh()},update:function(e){if(!this.options.listbox){var h=
this.options,f=h.selectedList,k=h.selectedText,q=this.$inputs,l=q.length;q=q.filter(":checked");var n=q.length;f=n?"function"===typeof k?k.call(this,n,l,q.get()):/\d/.test(f)&&0<f&&n<=f?q.map(function(){return a(this).next().text().replace(/\n$/,"")}).get().join(h.selectedListSeparator):k.replace("#",n).replace("#",l):h.noneSelectedText;this._setButtonValue(f,e);-1===h.wrapText.indexOf("button")&&this._setButtonWidth(!0);this._isOpen&&this._savedButtonHeight!=this.$button.outerHeight(!1)&&this.position()}},
...
this.classList.add("ui-state-focus")},blur:function(){this.classList.remove("ui-state-focus")}}).find("span").on("click.multiselect,click",e)},_handleButtonKeyboardNav:function(e){if(this._isOpen||this.element[0].multiple||38!==e.which&&40!==e.which)switch(e.which){case 27:case 37:case 38:this.close();break;case 40:case 39:this.open()}else{var h=this.$inputs,f=h.index(h.filter(":checked"));38===e.which&&f?h.eq(f-1).trigger("click"):40===e.which&&f<h.length-1&&h.eq(f+1).trigger("click")}},_bindCheckboxEvents:function(){var e=
this;e.$checkboxes.on("click.multiselect",".ui-multiselect-grouplabel",function(h){h.preventDefault();if(!e.options.groupsSelectable)return!1;var f=a(this).next("ul").children(":not(.ui-multiselect-excluded)").find("input").not(":disabled"),k=f.get(),q=this.textContent;if(!1!==e._trigger("beforeoptgrouptoggle",h,{inputs:k,label:q})){var l=e.options.maxSelected;l&&e.$inputs.filter(":checked").length+f.length>l||(e._toggleChecked(f.filter(":checked").length!==f.length,f),e._trigger("optgrouptoggle",
...
typeof l&&l.constructor==Object&&h.show(l));h=f.find(".ui-multiselect-filter");h.length?h.first().find("input").trigger("focus"):q.length?q.eq(0).trigger("focus").parent("label").eq(0).trigger("mouseover").trigger("mouseenter"):k.length?k.filter(":not(.ui-state-disabled)").eq(0).trigger("mouseover").trigger("mouseenter").find("input").trigger("focus"):f.find("a").first().trigger("focus");window.scrollTo(n,m);e.addClass("ui-state-active");this._isOpen=!0;this._trigger("open")}},close:function(){if(!1!==
this._trigger("beforeclose")&&!this.options.listbox){var e=this.$menu,h=this.options.closeEffect,f=this.$button;h?"string"==typeof h?e.hide(h,this.speed):"object"==typeof h&&h.constructor==Array?e.hide(h[0],h[1]||this.speed):"object"==typeof h&&h.constructor==Object&&e.hide(h):e.css("display","none");f.removeClass("ui-state-active").trigger("blur").trigger("mouseleave");this.element.trigger("blur");this._isOpen=!1;this._trigger("close");f.trigger("focus")}},position:function(){var e=this.$button;
...
e=h?this._multiselectOptgroupFilter(e).find("input"):null;var l=h?e.length:0,n=h?e.filter(":checked").length:0;!f||f>=(h?q-n+l-n:k-q)?(h?this._toggleChecked("!",e):this._toggleChecked("!"),this._trigger("flipAll")):this.buttonMessage("<center><b>Flip All Not Permitted.</b></center>")},collapseAll:function(e){this._trigger("beforeCollapseAll");("undefined"===typeof e?this.$checkboxes.find(".ui-multiselect-optgroup"):this._multiselectOptgroupFilter(e)).addClass("ui-multiselect-collapsed").children(".ui-multiselect-collapser").attr("title",
...
getButton:function(){return this.$button},getMenu:function(){return this.$menu},getLabels:function(){return this.$labels},getCollapsed:function(){return this.$checkboxes.find(".ui-multiselect-collapsed")},value:function(e){return"undefined"!==typeof e?(this.element.val(e),this.resync(),this.element):this.element.val()},htmlAllowedFor:function(e){return-1<this.options.htmlText.indexOf(e)},addOption:function(e,h,f){var k=this.htmlAllowedFor("options")?"html":"text";e=a(document.createElement("option")).attr(e)[k](h);
h=e.get(0);"undefined"===typeof f?(this.element.append(e),this.$checkboxes.append(this._makeOption(h))):(this._nativeOptgroupFilter(f).append(e),this._multiselectOptgroupFilter(f).append(this._makeOption(h)));this._updateCache()},_nativeOptgroupFilter:function(e){return this.element.children("OPTGROUP").filter(function(h){return"number"===typeof e?h===e:this.getAttribute("label")===e})},_multiselectOptgroupFilter:function(e){return this.$menu.find(".ui-multiselect-optgroup").filter(function(h){return"number"===
typeof e?h===e:this.getElementsByClassName("ui-multiselect-grouplabel")[0].textContent===e})},removeOption:function(e){e&&(this.element.find("option[value="+e+"]").remove(),this.$labels.find("input[value="+e+"]").parents("li").remove(),this._updateCache())},_setOption:function(e,h){var f=this.$header,k=this.$menu;switch(e){case "header":"boolean"===typeof h?f.toggle(h):"string"===typeof h&&(this.$headerLinkContainer.children("li:not(:last-child)").remove(),this.$headerLinkContainer.prepend("<li>"+
...
S3.queryString={parse:function(a){return"string"!==typeof a?{}:(a=a.trim().replace(/^(\?|#)/,""))?a.trim().split("&").reduce(function(b,d){var g=d.replace(/\+/g," ").split("=");d=g[0];g=g[1];d=decodeURIComponent(d);g=void 0===g?null:decodeURIComponent(g);b.hasOwnProperty(d)?Array.isArray(b[d])?b[d].push(g):b[d]=[b[d],g]:b[d]=g;return b},{}):{}},stringify:function(a){return a?Object.keys(a).map(function(b){var d=a[b];return Array.isArray(d)?d.map(function(g){return encodeURIComponent(b)+"="+encodeURIComponent(g)}).join("&"):
...
$("#close-iframe-map").css({display:"none"})},0==f.length?(a=$("<iframe id='iframe-map' data-feature='"+a+"' style='border-style:none' width='100%' height='"+b+"' src='"+e+"' >"),b=$("<a class='button tiny' id='close-iframe-map'>"+i18n.close_map+"</a>"),b.on("click",d),h.slideDown("medium"),h.append(a),h.append($('<div style="margin-bottom:10px">').append(b))):f.attr("data-feature")==a?f.slideToggle("medium",g):(f.attr({src:e,"data-feature":a}),f.slideDown("medium",g)))},s3_viewMapMulti=function(a,
b,d,g){a=S3.Ap.concat("/gis/display_feature//?module=")+a+"&resource="+b+"&instance="+d+"&jresource="+g;var c=$("#map").html();a='<iframe width="640" height="480" src="'+a+'"></iframe>';b=$('<a href="#">'+i18n.close_map+"</a>");b.on("click",function(e){$("#map").html(c);e.preventDefault()});$("#map").html(a);$("#map").append($("<div style='margin-bottom:10px'>").append(b))};S3.popupWin=null;
...
g=function(f,k,q){$("a#"+f+"_add").each(function(){var l=this.search,n=[],m=!1;l&&l.substring(1).split("&").forEach(function(p){decodeURIComponent(p.split("=")[0])!=k&&n.push(p)});void 0!==q&&null!==q&&(m=encodeURIComponent(k)+"="+encodeURIComponent(q),n.push(m),m=!0);l=n.length?"?"+n.join("&"):"";l=this.protocol+"//"+this.host+this.pathname+l+this.hash;l=$(this).attr("href",l);m?l.parent().show():l.parent().hide()})},c=function(f,k){var q=[],l=0;if(0===f.length)((f=k.showEmptyField)||void 0===f)&&
q.push('<option value="">'+(k.msgNoRecords||"-")+"</option>");else{var n=k.fncPrep,m=null;if(n)try{m=n(f)}catch(t){}n=k.lookupField||"id";for(var p=k.fncRepresent,r,v,x,A=0;A<f.length;A++)r=f[A],v=r[n],0===A&&(l=v),x=p?p(r,m):r.name,r=r._tooltip?' title="'+r._tooltip+'"':"",q.push("<option"+r+' value="'+v+'">'+x+"</option>");k.optional&&(l=0,q.unshift('<option value=""></option>'))}return{options:q.join(""),defaultValue:l}},e=function(f,k,q,l,n){var m=!1;if(1<f.length)if("checkbox"==f.first().attr("type")){if(f.first().closest(".checkboxes-widget-s3")){s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, skipping");
return}}else m=!0;m&&l.getWidgetHTML&&(s3_debug("filterOptionsS3 warning: getWidgetHTML=true not suitable for multiple target widgets (e.g. inline rows)"),f=f.first(),m=!1);m=m?f.first():f;var p=m.data("update-request");if(p)try{p.abort()}catch(t){}var r=l.lookupResource;if(""===q||null===q||void 0===q)f.val("").prop("disabled",!0),f.multiselect("instance")&&f.multiselect("refresh").multiselect("disable"),f.trigger("change"),g(r,k);else{if(l.lookupURL)p=l.lookupURL,q&&(p=p.concat(q));else if(p=S3.Ap.concat("/",
l.lookupPrefix,"/",r,".json"),q){var v=r+"."+k+"="+q;p=-1!=p.indexOf("?")?p.concat("&"+v):p.concat("?"+v)}if(v=l.tooltip)v="tooltip="+v,p=-1!=p.indexOf("?")?p.concat("&"+v):p.concat("?"+v);if((v=l.represent)||"undefined"==typeof v)p=-1!=p.indexOf("?")?p.concat("&represent=1"):p.concat("?represent=1");v=null;if(l.getWidgetHTML){v=l.targetWidget||f.attr("name");var x=$('[name = "'+v+'"]');v=!0;var A=!1;if(v=x.hasClass("groupedopts-widget")?x.groupedopts("visible"):x.data("visible")||x.is(":visible"))A=
!0,x.data("visible",!0),x.hasClass("groupedopts-widget")?x.groupedopts("hide"):x.hide(),b(x,r);v=$.ajaxS3({url:p,dataType:"html",success:function(t){var u=x;if(""!==t){var y=!1,w=!1;u.hasClass("groupedopts-widget")?y=!0:u.hasClass("multiselect-widget")&&(w=!0);var D;(y||w)&&"select"==u.prop("tagName").toLowerCase()&&(D=u.val());u.html(t).trigger("change").prop("disabled",!1);if(y||w){if(D){t=[];w=0;for(var B=D.length,z;w<B;w++)z=D[w],u.find("option[value="+z+"]").length&&t.push(z);u.val(t).trigger("change")}y?
u.groupedopts("refresh"):u.multiselect("refresh")}}else u.prop("disabled",!0);x=u;A&&(x.hasClass("groupedopts-widget")?x.find("option").length&&x.groupedopts("show"):x.show());d(x,r);g(r,k,q);n||S3ClearNavigateAwayConfirm()}})}else f.each(function(){var t=$(this);(t.hasClass("groupedopts-widget")?t.groupedopts("visible"):t.data("visible")||t.is(":visible"))?(t.data("visible",!0),t.hasClass("groupedopts-widget")?t.groupedopts("hide"):t.hide(),b(t,r)):t.data("visible",!1)}),v=$.ajaxS3({url:p,dataType:"json",
success:function(t){var u=c(t,l),y=0===t.length?!0:!1;f.each(function(){var w=$(this);a:if(w.hasClass("checkboxes-widget-s3"))s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, updateOptions aborted"),w=void 0;else{var D=u.options,B=u.defaultValue,z=[];if(!y){var C;if(w.hasClass("checkboxes-widget-s3")){w=void 0;break a}else{(C=w.val())||(C=w.prop("value"));Array.isArray(C)||(C=[C]);for(var F=0,E=C.length,G;F<E;F++)(G=C[F])&&$(D).filter("option[value="+G+"]").length&&z.push(G)}z.length&&
(B=z)}"INPUT"==w.prop("tagName")&&(z=$("<select>").addClass(w.attr("class")).attr("id",w.attr("id")).attr("name",w.attr("name")).data("visible",w.data("visible")).hide(),w.replaceWith(z),w=z);z=""===D;w.html(D).val(B).trigger("change").prop("disabled",z);w.hasClass("groupedopts-widget")?w.groupedopts("refresh"):w.hasClass("multiselect-widget")&&(w.multiselect("refresh"),z?w.multiselect("disable"):w.multiselect("enable"))}w.data("visible")&&(w.hasClass("groupedopts-widget")?y||w.groupedopts("show"):
w.show());d(w,r)});g(r,k,q);n||S3ClearNavigateAwayConfirm()}});m.data("update-request",v)}},h=function(f){var k="";if("checkbox"==f.attr("type")){var q=f.closest(".checkboxes-widget-s3");q&&(f=q)}if(f.hasClass("checkboxes-widget-s3"))k=[],f.find("input:checked").each(function(){k.push($(this).val())});else if(f.hasClass("s3-hierarchy-input")){if(k="",q=f.val())q=JSON.parse(q),q.constructor===Array?q.length&&(k=q[0]):q&&(k=q)}else 1==f.length&&(k=f.val());return[f,k]};$.filterOptionsS3=function(f){var k=
f.trigger;k=f.event?f.event:"string"==typeof k?k:k.name;var q=f.lookupKey||k,l=a(f.trigger),n=a(f.target);if(n){var m=$(n);if(m.length){var p=m.closest("form");if(l&&(m=p.find(l),m.length)){$(l).each(function(){var v=$(this);var x=v.closest(".inline-form");if(!x.length||!x.hasClass("empty-row")&&"none"!=x.css("display"))x="row"==f.scope?v.closest(".edit-row.inline-form,.add-row.inline-form"):p,v=h(v),x=x.find(n),e(x,q,v[1],f,!1)});var r="triggerUpdate."+k;p.off("change.s3options",l).on("change.s3options",
l,function(){var v=h($(this));p.trigger(r,v)});p.on(r,function(v,x,A){v=("row"==f.scope?x.closest(".edit-row.inline-form,.add-row.inline-form"):p).find(n);e(v,q,A,f,!0)})}}}}})(jQuery);
...
function(){},f=a.editable.types[c.type].buttons||a.editable.types.defaults.buttons,k=a.editable.types[c.type].content||a.editable.types.defaults.content,q=a.editable.types[c.type].element||a.editable.types.defaults.element,l=a.editable.types[c.type].reset||a.editable.types.defaults.reset,n=a.editable.types[c.type].destroy||a.editable.types.defaults.destroy,m=c.callback||function(){},p=c.intercept||function(t){return t},r=c.onedit||function(){},v=c.onsubmit||function(){},x=c.onreset||function(){},
A=c.onerror||l;c.tooltip&&a(this).attr("title",c.tooltip);return this.each(function(){var t=this;a(this).data("event.editable",c.event);a(this).html().trim()||a(this).html(c.placeholder);"destroy"===d?n.apply(a(this).find("form"),[c,t]):(a(this).on(c.event,function(u){if(!0!==a(this).data("disabled.editable")&&9!==u.which&&!t.editing&&!1!==r.apply(this,[c,t,u])){if(c.before&&"function"===typeof c.before)c.before(u);else if(c.before&&"function"!==typeof c.before)throw"The 'before' option needs to be provided as a function!";
u.preventDefault();u.stopPropagation();c.tooltip&&a(t).removeAttr("title");a(this).html().toLowerCase().replace(/(;|"|\/)/g,"")===c.placeholder.toLowerCase().replace(/(;|"|\/)/g,"")&&a(this).html("");t.editing=!0;t.revert=a(t).text();a(t).html("");var y=a("<form />");c.cssclass&&("inherit"===c.cssclass?y.attr("class",a(t).attr("class")):y.attr("class",c.cssclass));c.style&&("inherit"===c.style?(y.attr("style",a(t).attr("style")),y.css("display",a(t).css("display"))):y.attr("style",c.style));c.label&&
y.append("<label>"+c.label+"</label>");c.formid&&y.attr("id",c.formid);var w=q.apply(y,[c,t]);c.inputcssclass&&("inherit"===c.inputcssclass?w.attr("class",a(t).attr("class")):w.attr("class",c.inputcssclass));var D=!1;if(c.loadurl){var B=t.setTimeout(function(){w.disabled=!0},100);a(t).html(c.loadtext);u={};u[c.id]=t.id;"function"===typeof c.loaddata?a.extend(u,c.loaddata.apply(t,[t.revert,c])):a.extend(u,c.loaddata);a.ajax({type:c.loadtype,url:c.loadurl,data:u,async:!1,cache:!1,success:function(C){t.clearTimeout(B);
z=C;w.disabled=!1}})}else if(c.data){var z=c.data;"function"===typeof c.data&&(z=c.data.apply(t,[t.revert,c]))}else z=t.revert;k.apply(y,[z,c,t]);w.attr("name",c.name);"none"!==c.width&&(u=c.width-(w.outerWidth(!0)-c.width),w.width(u));f.apply(y,[c,t]);c.showfn&&"function"===typeof c.showfn&&y.hide();a(t).html("");a(t).append(y);c.showfn&&"function"===typeof c.showfn&&c.showfn(y);e.apply(y,[c,t]);y.find(":input:visible:enabled:first").trigger("focus");c.select&&w.trigger("select");a(this).on("keydown",
function(C){27===C.which?(C.preventDefault(),l.apply(y,[c,t])):13==C.which&&C.shiftKey&&(C.preventDefault(),y.trigger("submit"))});if("cancel"===c.onblur)w.on("blur",function(C){B=t.setTimeout(function(){l.apply(y,[c,t])},500)});else if("submit"===c.onblur)w.on("blur",function(C){B=t.setTimeout(function(){y.trigger("submit")},200)});else if("function"===typeof c.onblur)w.on("blur",function(C){!1===c.onblur.apply(t,[w.val(),c,y])&&l.apply(y,[c,t])});y.on("submit",function(C){C.preventDefault();C.stopPropagation();
if(D)return!1;D=!0;B&&t.clearTimeout(B);if(D=!1!==v.apply(y,[c,t]))if(D=!1!==h.apply(y,[c,t]))if("function"===typeof c.target){C=function(H,I){D=!1;!1!==I&&(a(t).html(H),t.editing=!1,m.apply(t,[t.innerText,c]),a(t).html().trim()||a(t).html(c.placeholder))};var F=c.target.apply(t,[w.val(),c,C]);!1!==F&&void 0!==F&&C(F,F)}else{var E={};E[c.name]=w.val();E[c.id]=t.id;"function"===typeof c.submitdata?a.extend(E,c.submitdata.apply(t,[t.revert,c,E])):a.extend(E,c.submitdata);"PUT"===c.method&&(E._method=
"put");a(t).html(c.indicator);var G={type:"POST",complete:function(H,I){D=!1},data:E,dataType:"html",url:c.target,success:function(H,I){H=p.apply(t,[H,I]);"html"===G.dataType&&a(t).html(H);t.editing=!1;m.apply(t,[H,c,E]);a(t).html().trim()||a(t).html(c.placeholder)},error:function(H,I,K){A.apply(y,[c,t,H])}};a.extend(G,c.ajaxoptions);a.ajax(G)}a(t).attr("title",c.tooltip);return!1})}}),t.reset=function(u){t.editing&&!1!==x.apply(u,[c,t])&&(a(t).text(t.revert),t.editing=!1,a(t).html().trim()||a(t).html(c.placeholder),
c.tooltip&&a(t).attr("title",c.tooltip))},t.destroy=function(u){a(t).off(a(t).data("event.editable")).removeData("disabled.editable").removeData("event.editable");t.clearTimeouts();t.editing&&l.apply(u,[c,t])},t.clearTimeout=function(u){var y=a(t).data("timeouts");clearTimeout(u);if(y){var w=y.indexOf(u);-1<w?(y.splice(w,1),0>=y.length&&a(t).removeData("timeouts")):console.warn("jeditable clearTimeout could not find timeout "+u)}},t.clearTimeouts=function(){var u=a(t).data("timeouts");if(u){for(var y=
0,w=u.length;y<w;++y)clearTimeout(u[y]);u.length=0;a(t).removeData("timeouts")}},t.setTimeout=function(u,y){var w=a(t).data("timeouts"),D=setTimeout(function(){u();t.clearTimeout(D)},y);w||(w=[],a(t).data("timeouts",w));w.push(D);return D})})}};var b=function(d){var g=document.createElement("input");g.setAttribute("type",d);return"text"!==g.type?d:"text"};a.editable={types:{defaults:{element:function(d,g){d=a('<input type="hidden"></input>');a(this).append(d);return d},content:function(d,g,c){a(this).find(":input:first").val(d)},
...
h){},ajaxCache:!0,ajaxProcess:function(e){return e=e.replace(/<(script|style|title)[^<]+<\/(script|style|title)>/gm,"").replace(/<(link|meta)[^>]+>/g,"")},ajaxSettings:{dataType:"html"},debug:!1}};var b,d={},g=0,c=0;a.fn.attrProp=a.fn.prop||a.fn.attr;a.fn.cluetip=function(e,h){function f(D,B){var z=D||"";B=B||"";"object"==typeof B?a.each(B,function(C,F){z+="-"+C+"-"+F}):"string"==typeof B&&(z+=B);return z}function k(D,B,z){z="";B=B.dropShadow&&B.dropShadowSteps?+B.dropShadowSteps:0;if(a.support.boxShadow)return B&&
(z="1px 1px "+B+"px rgba(0,0,0,0.5)"),D.css(a.support.boxShadow,z),!1;z=D.find(".cluetip-drop-shadow");if(B==z.length)return z;z.remove();z=[];for(var C=0;C<B;)z[C++]='<div style="top:'+C+"px;left:"+C+'px;"></div>';return z=a(z.join("")).css({position:"absolute",backgroundColor:"#000",zIndex:A-1,opacity:.1}).addClass("cluetip-drop-shadow").prependTo(D)}var q,l;"object"==typeof e&&(h=e,e=null);if("destroy"==e){var n=this.data("cluetip");n&&(a(n.selector).remove(),a.removeData(this,"title"),a.removeData(this,
"cluetip"));a(document).unbind(".cluetip");return this.unbind(".cluetip")}h=a.extend(!0,{},a.cluetip.defaults,h||{});g++;n=a.cluetip.backCompat||!h.multiple?"cluetip":"cluetip-"+g;var m="#"+n,p=a.cluetip.backCompat?"#":".",r=a.cluetip.setup.insertionType,v=a.cluetip.setup.insertionElement||"body";r=/appendTo|prependTo|insertBefore|insertAfter/.test(r)?r:"appendTo";var x=a(m);if(!x.length){x=a(a.cluetip.template)[r](v).attr("id",n).css({position:"absolute",display:"none"});var A=+h.cluezIndex;var t=
x.find(p+"cluetip-outer").css({position:"relative",zIndex:A});var u=x.find(p+"cluetip-inner");var y=x.find(p+"cluetip-title")}b=a("#cluetip-waitimage");b.length||(b=a("<div></div>").attr("id","cluetip-waitimage").css({position:"absolute"}));b.insertBefore(x).hide();var w=(parseInt(x.css("paddingLeft"),10)||0)+(parseInt(x.css("paddingRight"),10)||0);this.each(function(D){function B(){return!1}function z(J,T){var V=J.status;T.beforeSend(J.xhr,T);if("error"==V)T[V](J.xhr,J.textStatus);else if("success"==
V)T[V](J.data,J.textStatus,J.xhr);T.complete(J.xhr,T.textStatus)}var C=this,F=a(this),E=a.extend(!0,{},h,a.metadata?F.metadata():a.meta?F.data():F.data("cluetip")||{}),G=!1,H=!1,I=0,K=E[E.attribute]||("href"==E.attribute?F.attr(E.attribute):F.attrProp(E.attribute)||F.attr(E.attribute)),M=E.cluetipClass;A=+E.cluezIndex;F.data("cluetip",{title:C.title,zIndex:A,selector:m});if(!K&&!E.splitTitle&&!e)return!0;E.local&&E.localPrefix&&(K=E.localPrefix+K);E.local&&E.hideLocal&&K&&a(K+":first").hide();var S=
parseInt(E.topOffset,10),Q=parseInt(E.leftOffset,10),L,P,R=isNaN(parseInt(E.height,10))?"auto":/\D/g.test(E.height)?E.height:E.height+"px",O,U,N,ca,da,ha=parseInt(E.width,10)||275,Z=ha+w+E.dropShadowSteps,ia=this.offsetWidth,ea,X,aa,ka,fa="title"!=E.attribute?F.attrProp(E.titleAttribute)||"":"";if(E.splitTitle){var la=fa.split(E.splitTitle);fa=E.showTitle||""===la[0]?la.shift():""}E.escapeTitle&&(fa=fa.replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;"));var qa=function(J){if(!1===E.onActivate.call(C,
J))return!1;H=!0;x=a(m).css({position:"absolute"});t=x.find(p+"cluetip-outer");u=x.find(p+"cluetip-inner");y=x.find(p+"cluetip-title");q=x.find(p+"cluetip-arrows");x.removeClass().css({width:ha});K==F.attr("href")&&F.css("cursor",E.cursor);E.hoverClass&&F.addClass(E.hoverClass);U=F.offset().top;ea=F.offset().left;ia=F.innerWidth();J.type==focus?(aa=ea+ia/2+Q,x.css({left:X}),ca=U+S):(aa=J.pageX,ca=J.pageY);"area"!=C.tagName.toLowerCase()&&(O=a(document).scrollTop(),ka=a(window).width());if("fixed"==
E.positionBy)X=ia+ea+Q,x.css({left:X});else{X=ia>ea&&ea>Z||ea+ia+Z+Q>ka?ea-Z-Q:ia+ea+Q;if("area"==C.tagName.toLowerCase()||"mouse"==E.positionBy||ia+Z>ka)aa+20+Z>ka?(x.addClass("cluetip-"+M),X=0<=aa-Z-Q?aa-Z-Q-parseInt(x.css("marginLeft"),10)+parseInt(u.css("marginRight"),10):aa-Z/2):X=aa+Q;var T=0>X?J.pageY+S:J.pageY;if(0>X||"bottomTop"==E.positionBy)X=aa+Z/2>ka?ka/2-Z/2:Math.max(aa-Z/2,0)}q.css({zIndex:F.data("cluetip").zIndex+1});x.css({left:X,zIndex:F.data("cluetip").zIndex});P=a(window).height();
if(e)"function"==typeof e&&(e=e.call(C)),u.html(e),ma(T);else if(la){J=la.length;u.html(J?la[0]:"");if(1<J)for(var V=1;V<J;V++)u.append('<div class="split-body">'+la[V]+"</div>");ma(T)}else if(E.local||0===K.indexOf("#"))E.local&&(J=a(K+(/^#\S+$/.test(K)?"":":eq("+D+")")).clone(!0).show(),E.localIdSuffix&&J.attr("id",J[0].id+E.localIdSuffix),u.html(J),ma(T));else if(/\.(jpe?g|tiff?|gif|png)(?:\?.*)?$/i.test(K))u.html('<img src="'+K+'" alt="'+fa+'" />'),ma(T);else{var W=E.ajaxSettings.beforeSend,na=
E.ajaxSettings.error,sa=E.ajaxSettings.success,ta=E.ajaxSettings.complete;var oa=f(K,E.ajaxSettings.data);J=a.extend(!0,{},E.ajaxSettings,{cache:E.ajaxCache,url:K,beforeSend:function(Y,ba){W&&W.call(C,Y,x,u,ba);t.children().empty();E.waitImage&&b.css({top:ca+20,left:aa+20,zIndex:F.data("cluetip").zIndex-1}).show()},error:function(Y,ba){h.ajaxCache&&!d[oa]&&(d[oa]={status:"error",textStatus:ba,xhr:Y});H&&(na?na.call(C,Y,ba,x,u):u.html("<i>sorry, the contents could not be loaded</i>"))},success:function(Y,
ba,ja){h.ajaxCache&&!d[oa]&&(d[oa]={status:"success",data:Y,textStatus:ba,xhr:ja});G=E.ajaxProcess.call(C,Y);"object"==typeof G&&null!==G&&(fa=G.title,G=G.content);H&&(sa&&sa.call(C,Y,ba,x,u),u.html(G))},complete:function(Y,ba){ta&&ta.call(C,Y,ba,x,u);var ja=u[0].getElementsByTagName("img");c=ja.length;Y=0;for(ba=ja.length;Y<ba;Y++)ja[Y].complete&&c--;c&&!a.browser.opera?a(ja).bind("load.ct error.ct",function(){c--;0===c&&(b.hide(),a(ja).unbind(".ct"),H&&ma(T))}):(b.hide(),H&&ma(T))}});d[oa]?z(d[oa],
J):a.ajax(J)}},ma=function(J){var T=fa||E.showTitle&&"&nbsp;";var V="";var W="";x.addClass("cluetip-"+M);if(E.truncate){var na=u.text().slice(0,E.truncate)+"...";u.html(na)}T?y.show().html(T):y.hide();E.sticky&&(T=a('<div class="cluetip-close"><a href="#">'+E.closeText+"</a></div>"),"bottom"==E.closePosition?T.appendTo(u):"title"==E.closePosition?T.prependTo(y):T.prependTo(u),T.bind("click.cluetip",function(){pa();return!1}),E.mouseOutClose?x.bind("mouseleave.cluetip",function(){pa()}):x.unbind("mouseleave.cluetip"));
t.css({zIndex:F.data("cluetip").zIndex,overflow:"auto"==R?"visible":"auto",height:R});L="auto"==R?Math.max(x.outerHeight(),x.height()):parseInt(R,10);N=U;da=O+P;"fixed"==E.positionBy?N=U-E.dropShadowSteps+S:X<aa&&Math.max(X,0)+Z>aa||"bottomTop"==E.positionBy?U+L+S>da&&ca-O>L+S?(N=ca-L-S,W="top"):(N=ca+S,W="bottom"):N=U+L+S>da?L>=P?O:da-L-S:"block"==F.css("display")||"area"==C.tagName.toLowerCase()||"mouse"==E.positionBy?J-S:U-E.dropShadowSteps;""===W&&(W=X<ea?"left":"right");T=" clue-"+W+"-"+M+" cluetip-"+
M;"rounded"==M&&(T+=" ui-corner-all");x.css({top:N+"px"}).attrProp({className:"cluetip ui-widget ui-widget-content ui-cluetip"+T});E.arrows?(/(left|right)/.test(W)&&(W=x.height()-q.height(),V=0<=X&&0<J?U-N-E.dropShadowSteps:0,V=(W>V?V:W)+"px"),q.css({top:V}).show()):q.hide();(l=k(x,E))&&l.length&&l.hide().css({height:L,width:ha,zIndex:F.data("cluetip").zIndex-1}).show();x.hide()[E.fx.open](E.fx.openSpeed||0);a.fn.bgiframe&&x.bgiframe();0<E.delayedClose&&(I=setTimeout(pa,E.delayedClose));E.onShow.call(C,
x,u)},ra=function(J){H=!1;b.hide();if(!E.sticky||/click|toggle/.test(E.activation))pa(),clearTimeout(I);E.hoverClass&&F.removeClass(E.hoverClass)},pa=function(J){J=J&&J.data("cluetip")?J:F;var T=J.data("cluetip")&&J.data("cluetip").selector,V=a(T||"div.cluetip"),W=V.find(p+"cluetip-inner"),na=V.find(p+"cluetip-arrows");V.hide().removeClass();E.onHide.call(J[0],V,W);T&&(J.removeClass("cluetip-clicked"),J.css("cursor",""));T&&fa&&J.attrProp(E.titleAttribute,fa);E.arrows&&na.css({top:""})};a(document).unbind("hideCluetip.cluetip").bind("hideCluetip.cluetip",
function(J){pa(a(J.target))});if(/click|toggle/.test(E.activation))F.bind("click.cluetip",function(J){x.is(":hidden")||!F.is(".cluetip-clicked")?(qa(J),a(".cluetip-clicked").removeClass("cluetip-clicked"),F.addClass("cluetip-clicked")):ra(J);return!1});else if("focus"==E.activation)F.bind("focus.cluetip",function(J){F.attrProp("title","");qa(J)}),F.bind("blur.cluetip",function(J){F.attrProp("title",F.data("cluetip").title);ra(J)});else{F[E.clickThrough?"unbind":"bind"]("click.cluetip",B);var ua=function(J){if(E.tracking){var T=
...
function(J){F.attrProp("title","")}).bind("mouseleave.cluetip",function(J){F.attrProp("title",F.data("cluetip").title)})}});return this};(function(){a.support=a.support||{};for(var e=document.createElement("div").style,h=["boxShadow"],f=["moz","Moz","webkit","o"],k=0,q=h.length;k<q;k++){var l=h[k],n=l.charAt(0).toUpperCase()+l.slice(1);if("undefined"!==typeof e[l])a.support[l]=l;else for(var m=0,p=f.length;m<p;m++)if("undefined"!==typeof e[f[m]+n]){a.support[l]=f[m]+n;break}}})();a.fn.cluetip.defaults=
...
return this._get_days_in_month(b.getFullYear(),b.getMonth())},_add_months:function(b,d){a(this.element);var g=b.getDate();b.setDate(1);b.setMonth(b.getMonth()+d);b.setDate(Math.min(g,this._get_days_in_month_big(b)));return b}})})(jQuery);S3.supply={};S3.supply.fncPrepItem=function(a){for(var b=0;b<a.length;b++)if(1==a[b].quantity)return a[b].name;return""};S3.supply.fncRepresentItem=function(a,b){return 1==a.quantity?a.name:a.name+" ("+a.quantity+" x "+b+")"};
...
this.eventNamespace+this.id,k=this;a.when.apply(null,e).then(function(){k.submitInProgress=!1;g.off(f).trigger("submit")},function(){for(var q in c)c[q].isRejected()&&(c[q]=a.Deferred());k.submitInProgress=!1;g.find('input[type="submit"]').prop("disabled",!1)})},_collectData:function(g,c,e){var h=this.formname,f=g.data,k={},q=null;if("none"==c)var l=a("#add-row-"+h);else{l=a("#edit-row-"+h);var n=l.data("rowindex");"undefined"!=typeof n&&(q=f[n])}if(l.length&&(f=new a.Event("validate"),l.triggerHandler(f),
...
var q;if(a("#add-row-"+g).hasClass("required")){var l=!0;for(q in k)"_id"!=q&&""!==k[q]&&(l=!1);if(l&&a("#add-"+g+"-none").length&&a("#read-row-"+g+"-0").length)return h.hide(),c.removeClass("hide").show(),a.Deferred().resolve()}var n=this;return this._validate(f,"none",k).then(function(m){if(null!==m){m._changed=!0;var p=f.data.push(m)-1;m._index=p;n._serialize();if(e){for(var r=[],v=f.fields,x,A,t,u=0,y=v.length;u<y;u++)x=v[u].name,A=a("#upload_"+g+"_"+x+"_none"),A.length&&(t="upload_"+g+"_"+x+
"_"+p,a("#"+t).remove(),A.attr({id:t,name:t})),r.push(m[x].text);n._resetAddRow();m=n._renderReadRow(g,p,r);n._appendReadRow(g,m);n._showHeaders()}}e&&(h.hide(),c.removeClass("hide").show())},function(){e&&(h.hide(),c.removeClass("hide").show())})},_updateRow:function(g){var c=this.formname,e=a("#rdy-"+c+"-0"),h;if(h=e.length?!0:!1){e.hide();var f=a("#throbber-"+c+"-0").removeClass("hide").show();this._removeErrors()}var k=this._deserialize(),q=this._collectData(k,"0",g);if(null===q)return h&&(f.hide(),
e.removeClass("hide").show()),a.Deferred().reject();if(q._delete)return k.data[g]._delete=!0,this._serialize(),a.Deferred().resolve();var l=this;return this._validate(k,"0",q).then(function(n){if(null!==n&&(n._id=k.data[g]._id,n._changed=!0,n._index=g,k.data[g]=n,l._serialize(),h)){var m=[],p=k.fields,r,v=function(){l._markChanged(l);l._catchSubmit()};for(r=0;r<p.length;r++){var x=p[r].name;m.push(n[x].text);var A=a("#sub_"+c+"_"+c+"_i_"+x+"_edit_default");var t=a("#sub_"+c+"_"+c+"_i_"+x+"_edit_0");
"file"==t.attr("type")?(A=A.clone(),A.attr("id",t.attr("id")).attr("name",t.attr("name")).change(v),t.replaceWith(A)):(A=A.val(),t.val(A));A=a("#dummy_sub_"+c+"_"+c+"_i_"+x+"_edit_default").val();a("#dummy_sub_"+c+"_"+c+"_i_"+x+"_edit_0").val(A)}n=a("#edit-row-"+c);n.removeClass("changed");m=l._renderReadRow(c,g,m);n.hide().data("rowindex",null);m.removeClass("hide").show();l._enableAddRow();l._showHeaders()}h&&(f.hide(),e.removeClass("hide").show())},function(){h&&(f.hide(),e.removeClass("hide").show())})},
_removeRow:function(g){var c=this.formname,e=c+"-"+g;if(!confirm(i18n.delete_confirmation))return!1;this._deserialize().data[g]._delete=!0;this._serialize();a("#read-row-"+e).remove();this._showHeaders();a('input[name^="upload_'+c+'_"][name$="_'+g+'"]').remove();g=a("#edit-row-"+c);g.hasClass("required")&&!a("#read-row-"+c+"-0").length&&(a("#add-row-"+c).addClass("required"),g.removeClass("required"),this._catchSubmit());return!0},_validateAll:function(){var g=this,c=[];a(g.element).find(".inline-form.changed, .inline-form.required").each(function(){var k=
...
c.push(g._addRow()):c.push(g._updateRow(k.data("rowindex"))))});var e=a(this.element).closest("form"),h=e.data("pendingValidations"),f=this.eventNamespace+this.id;a.when.apply(null,c).then(function(){h[f]&&(h[f].resolve(),delete h[f]);e.off("validateInline"+f)},function(){h[f]&&h[f].reject()})},_bindEvents:function(){var g=a(this.element),c=this.eventNamespace,e=this;g.on("click"+c,".read-row",function(h){if(!a(this).closest(".inline-component").hasClass("readonly")){var f=h.target;if(!f||"A"!=f.tagName||
...
c,function(){a(this).off("change"+c).one("change"+c,function(){e._markChanged(this);e._catchSubmit()})});h.find("input.s3-hierarchy-input").on("change"+c,function(){e._markChanged(this);e._catchSubmit()});h.find("input").on("keypress"+c,function(f){return 13==f.which?(f.preventDefault(),!1):!0})});g.find(".add-row").each(function(){a(this).find("input").on("keyup"+c,function(h){switch(h.which){case 13:e._addRow()}})});g.find(".edit-row").each(function(){a(this).find("input").on("keyup"+c,function(h){var f=
a(this).closest(".edit-row").data("rowindex");switch(h.which){case 13:e._updateRow(f);break;case 27:e._cancelEdit(f)}})});g.find(".inline-open-add").on("click"+c,function(h){h.preventDefault();a("#add-row-"+e.formname).removeClass("hide").show();a(this).hide()});return!0},_unbindEvents:function(){var g=a(this.element),c=this.eventNamespace;g.find(".inline-locationselector-widget").off(c);g.find(".add-row,.edit-row").each(function(){a(this).find("input,textarea,select").off(c)});g.find(".inline-open-add").off(c);
g.off(c);return!0}})})(jQuery);$(function(){$(".inline-component").inlinecomponent(S3.inlineComponentsOpts||{})});S3.search={};
(function(){var a=function(t,u){if("GET"==t.type){t.type="POST";var y=function(Q){var L=Q[0];return"$filter"==Q||"$$"==Q.slice(0,2)||"_"!=L&&(-1!=Q.search(/\./)||"("==L&&-1!=Q.search(/\)/))},w=t.url.split("#"),D=w[0],B=null,z=null;1<w.length&&(B=w[1]);w=D.split("?");D=w[0];1<w.length&&(z=w[1]);var C=t.data,F={};w={};var E,G,H,I,K=function(Q,L,P){if(Array.isArray(P))for(H=0,E=P.length;H<E;H++)K(Q,L,P[H]);else Q.hasOwnProperty(L)?Array.isArray(Q[L])?Q[L].push(P):Q[L]=[Q[L],P]:Q[L]=P};if(C){var M=0;
for(G=C.length;M<G;M++){var S=C[M];K(w,S.name,S.value)}}if(z)for(I in C=S3.queryString.parse(z),C)z=C[I],y(I)?K(F,I,z):K(w,I,z);t.data="ajax"==u?JSON.stringify(F):F;t.processData=!1;u=D+"?$search="+u;(y=S3.queryString.stringify(w))&&(u+="&"+y);null!==B&&(u+="#"+B);t.url=u}};S3.search.searchRewriteAjaxOptions=a;var b={timeout:1E4,retryLimit:5,dataType:"json",contentType:"application/json; charset=utf-8",processData:!1,async:!0,type:"POST"};$.searchS3=function(t){t=$.extend({},b,t);a(t,"ajax");return $.ajaxS3(t)};
$.searchDownloadS3=function(t,u){var y=$.extend({},b,{url:t});t=document.createElement("form");y.type="GET";a(y,"form");t.action=y.url;t.method="POST";t.target=u||"_self";t.enctype="multipart/form-data";if(u=y.data)for(var w in u)y=document.createElement("textarea"),y.name=w,y.value=JSON.stringify(u[w]),t.appendChild(y);t.style.display="none";document.body.appendChild(t);t.trigger("submit")};var d={},g=function(t){return t?(t=t.replace(/"/,'\\"'),-1!=t.search(/,/)&&(t='"'+t+'"'),t):t},c=function(t){if(!t)return t;
for(var u=[],y=!1,w=0,D=0;D<t.length;D++){var B=t[D];u[w]=u[w]||"";'"'==B?y=!y:","!=B||y?u[w]+=B:("NONE"==u[w]&&(u[w]=null),++w)}return u},e=function(t){void 0===t&&(t=$("body").find("form.filter-form").first());t.data("noAutoSubmit",1);t.find(".text-filter").val("");t.find(".options-filter, .location-filter").each(function(){var u=$(this);if("select"==this.tagName.toLowerCase())u.val(""),u.hasClass("groupedopts-filter-widget")&&u.groupedopts("instance")?u.groupedopts("refresh"):u.hasClass("multiselect-filter-widget")&&
u.multiselect("instance")&&u.multiselect("refresh");else{var y=u.attr("id");$("input[name='"+y+"']:checked").each(function(){$(this).trigger("click")})}u.hasClass("location-filter")&&v(this)});t.find(".map-filter").each(function(){var u=$(this);u.val("");u=u.attr("id");u=S3.gis.maps[u+"-map"].s3.polygonButton;"drawpolygonclear-off"==u.getIconClass()&&u.items[0].btnEl.dom.click()});t.find(".range-filter-input").val("").trigger("change.slider");t.find(".date-filter-input").each(function(){$(this).calendarWidget("clear")});
t.find(".hierarchy-filter").each(function(){var u=$(this);u.hasClass("s3-cascade-select")?u.cascadeSelect("reset"):u.hierarchicalopts("reset")});t.find(".age-filter-input").val("");t.find(".filter-manager-widget").each(function(){var u=$(this);void 0!==u.filtermanager&&u.filtermanager("clear")});t.data("noAutoSubmit",0);t.trigger("optionChanged")},h=/__(?!link\.)([a-z_]+)$/,f=function(t){"undefined"==typeof t&&(t=$("body").find("form.filter-form").first());var u,y,w=[],D,B,z,C,F,E;t.find(".text-filter:visible").each(function(){D=
$(this);y=D.attr("id");B=$("#"+y+"-data").val();if(z=D.val().trim()){C=z.split(" ");var G=D.data("match"),H=[];for(u=0;u<C.length;u++)if(F=$.trim(C[u]),""!==F){var I=g("*"+F+"*");"any"==G?H.push(I):w.push([B,I])}"any"==G&&w.push([B,H.join(",")])}else w.push([B,null])});t.find(".s3-groupedopts-widget:visible").prev(".options-filter.groupedopts-filter-widget").add(t.find(".ui-multiselect:visible").prev(".options-filter.multiselect-filter-widget")).add(t.find(".options-filter:visible,.options-filter.multiselect-filter-widget.active")).each(function(){D=
$(this);y=D.attr("id");B=$("#"+y+"-data").val();E=$("input:radio[name='"+y+"_filter']:checked").val();switch(E){case "any":B=B.replace(/__contains$|__belongs$/,"__anyof");break;case "all":B=B.replace(/__anyof$|__belongs$/,"__contains")}if("select"==this.tagName.toLowerCase()){if(z="",C=D.val())for(C instanceof Array||(C=C.split(",")),u=0;u<C.length;u++){var G=g(C[u]);z=""===z?G:z+","+G}}else z="",$("input[name='"+y+"']:checked").each(function(){z=""===z?g($(this).val()):z+","+g($(this).val())});""===
z||"*"==z?w.push([B,null]):w.push([B,z])});t.find(".map-filter").each(function(){D=$(this);y=D.attr("id");B=$("#"+y+"-data").val();(z=D.val())?w.push([B,z]):w.push([B,null])});t.find(".range-filter-input:visible").each(function(){D=$(this);y=D.attr("id");B=$("#"+y+"-data").val();(z=D.val())?w.push([B,z]):w.push([B,null])});t.find(".date-filter-input:visible").each(function(){D=$(this);y=D.attr("id");B=$("#"+y+"-data").val();z=D.val();E=y.split("-").pop();if(D.hasClass("datetimepicker"))var G=function(O){return O.getFullYear()+
"-"+("0"+(O.getMonth()+1)).slice(-2)+"-"+("0"+O.getDate()).slice(-2)+"T"+("0"+O.getHours()).slice(-2)+":"+("0"+O.getMinutes()).slice(-2)+":"+("0"+O.getSeconds()).slice(-2)};else{var H="";D.hasClass("hide-time")&&(H="le"==E?"T23:59:59":"T00:00:00");G=function(O){return O.getFullYear()+"-"+("0"+(O.getMonth()+1)).slice(-2)+"-"+("0"+O.getDate()).slice(-2)+H}}var I=!1;"le"==E&&(I=!0);if(D.hasClass("negative")){if(I){var K=!1;I=y.slice(0,-3);var M=$("#"+I+"-ge");var S=M.val();if(S){K=!0;M=M.calendarWidget("getJSDate",
!1);var Q=G(M);var L=$("#"+I+"-ge-data").val();L=L.replace(h,"")}if(z){K=!0;M=D.calendarWidget("getJSDate",!0);var P=G(M);var R=B.replace(h,"")}K&&(G="("+$("#"+I+"-negative").val()+" eq NONE)",S&&(G+=" or ("+L+' lt "'+Q+'")'),z&&(G+=" or ("+R+' gt "'+P+'")'),P=$("#"+I+"-filterby"),P.length&&(P=P.val(),I=$("#"+I+"-filter_opts").val(),G+=" or ("+P+' belongs "'+I+'")'),w.push(["$filter",G]))}}else z?(M=D.calendarWidget("getJSDate",I),P=G(M),I&&D.hasClass("end_date")||D.hasClass("optional")?(I=B.replace(h,
""),w.push(["$filter","("+I+" "+E+' "'+P+'") or ('+I+" eq NONE)"])):w.push([B,P])):w.push([B,null])});t.find(".s3-groupedopts-widget:visible").prev(".location-filter.groupedopts-filter-widget").add(t.find(".ui-multiselect:visible").prev(".location-filter.multiselect-filter-widget").add(t.find(".location-filter:visible,.location-filter.multiselect-filter-widget.active"))).each(function(){D=$(this);y=D.attr("id");B=$("#"+y+"-data").val();z="";if("select"==this.tagName.toLowerCase()){if(C=$(this).val(),
C)for(u=0;u<C.length;u++){var G=g(C[u]);z=""===z?G:z+","+G}}else $("input[name='"+y+"']:checked").each(function(){z=""===z?g($(this).val()):z+","+g($(this).val())});""===z?w.push([B,null]):w.push([B,z])});t.find(".hierarchy-filter:visible").each(function(){D=$(this);y=D.attr("id");B=$("#"+y+"-data").val();z="";if(C=D.hasClass("s3-cascade-select")?D.cascadeSelect("get"):D.hierarchicalopts("get"))for(u=0;u<C.length;u++)z=""===z?z+C[u]:z+","+C[u];""===z?w.push([B,null]):w.push([B,z])});t.find(".age-filter-input:visible").each(function(){D=
$(this);y=D.attr("id");B=$("#"+y+"-data").val();z=D.val();var G=z-0;if(z&&!isNaN(G)){var H=B.match(h);H&&"gt"==H[1]&&(G+=1);H=new Date;H.setYear(H.getFullYear()-G);H=H.getFullYear()+"-"+("0"+(H.getMonth()+1)).slice(-2)+"-"+("0"+H.getDate()).slice(-2);w.push([B,H])}else w.push([B,null])});$(".value-filter:visible",t).each(function(){D=$(this);y=D.attr("id");B=$("#"+y+"-data").val();D.prop("checked")?w.push([B,"None"]):w.push([B,null])});return w};S3.search.getCurrentFilters=f;S3.search.setCurrentFilters=
function(t,u){void 0===t&&(t=$("body").find("form.filter-form").first());t.data("noAutoSubmit",1);var y,w={},D,B,z;var C=0;for(D=u.length;C<D;C++){var F=u[C];var E=F[0];var G="string"==typeof F[1]?c(F[1]):F[1];w.hasOwnProperty(E)?w[E]=w[E].concat(G):w[E]=G}t.find(".text-filter").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();if(w.hasOwnProperty(E)){B.is(":visible")||B.hasClass("active")||A(t);G=w[E];z="";if(G){var H;C=0;for(D=G.length;C<D;C++)if(H=G[C])0<C&&(z+=" "),"*"==H[0]&&
(H=H.slice(1)),"*"==H.slice(-1)&&(H=H.slice(0,-1)),z+=H}B.val(z)}});t.find(".options-filter").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();var H=$('input:radio[name="'+y+'_filter"]:checked').val();if(this.tagName&&"select"==this.tagName.toLowerCase()){var I=!1,K=E.replace(h,"");if(w.hasOwnProperty(K+"__eq"))G=w[K+"__eq"],I=!0;else if(w.hasOwnProperty(K))G=w[K],I=!0;else if(w.hasOwnProperty(E))G=w[E],I=!0;else if("any"==H||"all"==H)w.hasOwnProperty(K+"__anyof")?(G=w[K+"__anyof"],
I=!0,$('input:radio[name="'+y+'_filter"][value="any"]').prop("checked",!0)):w.hasOwnProperty(K+"__contains")&&(G=w[K+"__contains"],I=!0,$('input:radio[name="'+y+'_filter"][value="all"]').prop("checked",!0));I&&(B.is(":visible")||B.hasClass("active")||A(t),B.val(G),B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hasClass("multiselect-filter-widget")&&B.multiselect("instance")&&B.multiselect("refresh"))}});t.find(".map-filter").each(function(){B=$(this);
y=B.attr("id");E=$("#"+y+"-data").val();if(w.hasOwnProperty(E))if(B.is(":visible")||B.hasClass("active")||A(t),G=w[E],G){B.val(G[0]);var H=y+"-map";S3.gis.maps[H].s3.polygonButtonLoaded()}else B.val(""),H=y+"-map",S3.gis.maps[H].s3.layerRefreshed()});t.find(".range-filter-input").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();w.hasOwnProperty(E)&&(B.is(":visible")||B.hasClass("active")||A(t),(G=w[E])?B.val(G[0]):B.val(""))});t.find(".date-filter-input").each(function(){var H=$(this),
I=$("#"+H.attr("id")+"-data").val(),K=I.replace(h,""),M=!1;w.hasOwnProperty(I)?M=w[I]:w.hasOwnProperty(K)&&(M=w[K]);!1!==M&&(H.is(":visible")||H.hasClass("active")||A(t),M?(I=M[0].replace(" ","T"),H.calendarWidget("setJSDate",new Date(I))):H.calendarWidget("clear"))});t.find(".location-filter").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();var H=$('input:radio[name="'+y+'_filter"]:checked').val();if(this.tagName&&"select"==this.tagName.toLowerCase()){var I=!1;if(w.hasOwnProperty(E))G=
w[E],I=!0;else if("any"==H||"all"==H)H=E.replace(h,""),w.hasOwnProperty(H+"__anyof")?(G=w[H+"__anyof"],I=!0,$('input:radio[name="'+y+'_filter"][value="any"]').prop("checked",!0)):w.hasOwnProperty(H+"__contains")&&(G=w[H+"__contains"],I=!0,$('input:radio[name="'+y+'_filter"][value="all"]').prop("checked",!0));I&&(B.is(":visible")||B.hasClass("active")||A(t),B.val(G),B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hasClass("multiselect-filter-widget")&&
B.multiselect("instance")&&B.multiselect("refresh"),v(this))}});t.find(".hierarchy-filter:visible").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();w.hasOwnProperty(E)&&(B.is(":visible")||B.hasClass("active")||A(t),G=w[E],B.hasClass("s3-cascade-select")?B.cascadeSelect("set",G):B.hierarchicalopts("set",G))});t.data("noAutoSubmit",0);t.trigger("optionChanged")};var k=function(t,u){void 0===u&&(u=f());t=t.split("?");var y={},w={},D,B=[];u=u.filter(function(H){return"$filter"==H[0]?
(B.push(H),!1):!0});B.length&&u.push(B.reduce(function(H,I){return["$filter","("+H[1]+") and ("+I[1]+")"]}));var z=0;for(D=u.length;z<D;z++){var C=u[z];var F=C[0];C=C[1];null===C?y.hasOwnProperty(F)||(w[F]=!0):(w.hasOwnProperty(F)&&(w[F]=!1),y[F]=!0)}var E=[];if(1!=S3.search.stripFilters&&1<t.length){var G=t[1].split("&");z=0;for(D=G.length;z<D;z++)C=G[z].split("="),1<C.length&&(F=decodeURIComponent(C[0]),w[F]||y[F]||E.push(G[z]))}z=0;for(D=u.length;z<D;z++)C=u[z],F=C[0],C=C[1],y[F]&&E.push(F+"="+
encodeURIComponent(C));u=E.join("&");t=t[0];u&&(t=t+"?"+u);return t};S3.search.filterURL=k;S3.search.ajaxUpdateOptions=function(t,u){var y=$(t);t=y.find("input.filter-ajax-url");t.length&&(t=$(t[0]).val());$.ajax({url:t,dataType:"json"}).done(function(w){y.data("noAutoSubmit",1);for(var D in w){var B=$("#"+D);if(B.length){var z=w[D];if(B.hasClass("options-filter")){if("select"==B[0].tagName.toLowerCase()){var C=B.siblings(".no-options-available");if(z.hasOwnProperty("empty"))B.html(""),B.hasClass("multiselect-filter-widget")&&
B.multiselect("instance")?(B.multiselect("refresh"),B.multiselect("instance").button.hide()):B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hide(),C.length&&(C.html(z.empty),C.removeClass("hide").show());else{var F=B.val(),E=[],G="",H;if(z.hasOwnProperty("groups")){var I=0;for(H=z.groups.length;I<H;I++){var K=z.groups[I];K.label&&(G+='<optgroup label="'+K.label+'">');for(var M=0,S=K.items.length;M<S;M++){var Q=K.items[M];var L=Q[0].toString();F&&0<=$.inArray(L,
F)&&E.push(L);G+='<option value="'+L+'"';(L=Q[3])&&(G+=' title="'+L+'"');Q=Q[1];G+=">"+Q+"</option>"}K.label&&(G+="</optgroup>")}}else for(I=0,H=z.length;I<H;I++)Q=z[I],L=Q[0],L=null===L?"None":L.toString(),Q=Q[1],F&&0<=$.inArray(L,F)&&E.push(L),G+='<option value="'+L+'">'+Q+"</option>";B.html(G);E&&B.val(E);C.length&&C.hide();B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hasClass("multiselect-filter-widget")&&B.multiselect("instance")?(B.multiselect("refresh"),
B.multiselect("instance").button.show()):B.removeClass("hide").show()}}}else B.hasClass("date-filter")&&(B=z.min,z=z.max,$("#"+D+"-ge").calendarWidget("instance").option("minDateTime",B).option("maxDateTime",z).refresh(),$("#"+D+"-le").calendarWidget("instance").option("minDateTime",B).option("maxDateTime",z).refresh())}}y.data("noAutoSubmit",0);u&&u.apply()}).fail(function(w,D,B){console.log("UNAUTHORIZED"==B?i18n.gis_requires_login:w.responseText)})};var q=function(t,u){$("#"+t[0].id).closest(".dt-wrapper").find(".dt-export").each(function(){var y=
$(this),w=y.data("url");w&&y.data("url",k(w,u))})},l=function(t){var u=$("#"+t).find('input.filter-submit-url[type="hidden"]').first().val(),y=d[t],w;d[t]={};for(w in y){var D=$("#"+w);var B=D.is(":visible")?!0:!1;var z=y[w];D=z.needs_reload;if(B){if(D){var C=f($("#"+t));u=k(u,C);window.location.href=u}}else d[t][w]=z}for(w in y)D=$("#"+w),D.is(":visible")&&(z=y[w],D=$("#"+w),D.hasClass("dataTable")?(t=D.dataTable(),z=z.ajaxurl,t.fnReloadAjax(z),q(t,C),$("#"+t[0].id+"_dataTable_filterURL").val(z)):
D.hasClass("dl")?D.datalist("ajaxReload",z.queries):D.hasClass("map_wrapper")?S3.gis.refreshLayer("search_results",z.queries):D.hasClass("gi-container")?D.groupedItems("reload",null,z.queries):D.hasClass("pt-container")?D.pivottable("reload",null,z.queries):D.hasClass("tp-container")?D.timeplot("reload",null,z.queries):D.hasClass("s3-organizer")&&D.organizer("reload"))};S3.search.filterFormAutoSubmit=function(t,u){t=$("#"+t);if(t.length&&u)t.on("optionChanged",function(){var y=$(this);if(!y.data("noAutoSubmit")){var w=
y.data("autoSubmitTimeout");w&&clearTimeout(w);w=setTimeout(function(){x(y)},u);y.data("autoSubmitTimeout",w)}})};var n=function(){var t=new jQuery.Deferred;setTimeout(function y(){void 0!=S3.gis.maps?t.resolve("loaded"):"pending"===t.state()&&(t.notify("waiting for JS to load..."),setTimeout(y,500))},1);return t.promise()},m=function(t,u,y){void 0===y&&(y=f($("#"+t)));d.hasOwnProperty(t)||(d[t]={});if(!d[t].hasOwnProperty(u)){var w=$("#"+u);if(w.hasClass("dl")||w.hasClass("gi-container")||w.hasClass("pt-container")||
w.hasClass("tp-container")||w.hasClass("map_wrapper")||w.hasClass("s3-organizer"))var D=null;else if(w.hasClass("dataTable")){if(w=$("input#"+u+"_configurations"),w.length)if(D=JSON.parse($(w).val()).ajaxUrl,"undefined"!=typeof D)D=k(D,y);else return}else return;d[t][u]={needs_reload:!1,ajaxurl:D,queries:y}}};S3.search.setup_hidden_widget=m;var p=function(t){t=$(t);if(t.hasClass("responsive"))(t=t.DataTable())&&t.responsive&&t.responsive.recalc();else if(t.hasClass("doublescroll"))try{t.dataTableS3("doubleScroll")}catch(u){}},
r=function(t,u){var y=u.find(".map_wrapper"),w=y.length;w?$.when(n()).then(function(){for(var D=S3.gis,B=0;B<w;B++){var z=y[B].attributes.id.value;void 0===D.maps[z]&&D.show_map(z,D.options[z])}l(t)},function(D){s3_debug(D)},function(D){s3_debug(D)}):l(t);u.find("table.dataTable.display").each(function(){p(this)})};S3.search.unhide_section=r;S3.search.summary_tabs=function(t,u,y){if(y)for(var w=f($("#"+t)),D=y.split(","),B=0,z=D.length;B<z;B++)y=D[B],m(t,y,w);void 0!=u?($("#summary-tabs").tabs({active:u,
activate:function(C,F){C=$(F.newPanel);C.removeClass("hide");if(F.newTab.length){var E=$(F.newTab).index();F=$("#"+t).find('input.filter-submit-url[type="hidden"]');if(F.length){F=F.first();var G=$(F).val(),H=G.split("?"),I=[];if(1<H.length){G=H[1].split("&");for(var K,M,S=0;S<G.length;S++)K=G[S].split("="),1<K.length&&(M=decodeURIComponent(K[0]),"t"!=M&&I.push(K[0]+"="+K[1]));I.push("t="+E);E=I.join("&");H=H[0];E&&(H=H+"?"+E)}else H=G+"?t="+E;$(F).val(H)}}r(t,C)}}).css({visibility:"visible"}),$('.ui-tabs-panel[aria-hidden="false"]').first().removeClass("hide").find("table.dataTable.display").each(function(){p(this)})):
$("#summary-tabs").css({visibility:"visible"}).find("table.dataTable.display").each(function(){p(this)})};S3.search.summary_maps=function(t){for(var u=$("#summary-common, #summary-sections").find(".map_wrapper"),y=0;y<u.length;y++){var w=u[y];if(!w.hidden){var D=S3.gis;w=w.attributes.id.value;if(void 0===D.maps[w]){var B=D.options[w];void 0!=B&&(D.show_map(w,B),w=f($("#"+t)),D.refreshLayer("search_results",w))}}}};S3.search.s3map=function(t){var u=S3.gis;void 0===t&&(t="default_map");u.show_map(t,
u.options[t]);t=f();u.refreshLayer("search_results",t)};var v=function(t){var u=t.name,y=u.slice(0,-1),w=parseInt(u.slice(-1)),D=$("#"+u);if(D.val()){var B=w+1,z=y+B,C=$("#"+z);C.length||(B=w+2,z=y+B,C=$("#"+z));if(C.length){var F=z.replace(/-/g,"_");S3[F]();C.next(".ui-multiselect").show();F=S3.location_filter_hierarchy;if(void 0!=S3.location_name_l10n){C=!0;var E=S3.location_name_l10n}else C=!1;t.options1=[];t.options2=[];t.options3=[];t.options4=[];t.options5=[];for(u=w;0<=u&&!F.hasOwnProperty("L"+
u);u--);var G=function(L){var P,R;for(P in L)if(L.hasOwnProperty(P)){P&&"null"!=P&&t["options"+B].push(P);var O=L[P];if("object"===typeof O&&(z=B+1,$("#"+y+z).length||(z=B+2),$("#"+y+z).length))for(R in O)O.hasOwnProperty(R)&&R&&"null"!=R&&t["options"+z].push(R)}},H=function(L,P){var R,O,U=$("#"+y+P).val();for(O in L)if(L.hasOwnProperty(O))if(null===U)if(P===w)G(L[O]);else{var N=P+1;$("#"+y+N).length||N++;H(L[O],N)}else for(R in U)U[R]===O&&(P===w?G(L[O]):(N=P+1,$("#"+y+N).length||N++,H(L[O],N)))};
H(F["L"+u],u);for(F=B;5>=F;F++){var I=$("#"+y+F);if(I.length){var K=t["options"+F];K.sort();var M="";for(var S in K)if(K.hasOwnProperty(S)){u=K[S];var Q=C?E[u]||u:u;M+='<option value="'+u+'">'+Q+"</option>"}I.html(M);if(I.hasClass("groupedopts-filter-widget")&&I.groupedopts("instance"))try{I.groupedopts("refresh")}catch(L){}else I.hasClass("multiselect-filter-widget")&&I.multiselect("instance")&&I.multiselect("refresh");F===B&&(I.next("button").removeClass("hidden").show(),u=D.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect"),
u.length&&(u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&u.hide())))))}}}}else{for(F=w+1;5>=F;F++)if(I=$("#"+y+F),I.length)if(I.html(""),I.hasClass("groupedopts-filter-widget")&&I.groupedopts("instance"))try{I.groupedopts("refresh")}catch(L){}else I.hasClass("multiselect-filter-widget")&&
I.multiselect("instance")&&I.multiselect("refresh");u=D.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect");u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&u.hide()))))}},x=function(t){S3.hideAlerts("warning");var u=t.attr("id"),
y=t.find('input.filter-submit-url[type="hidden"]').val(),w=f(t);if(t.hasClass("filter-ajax")){t=t.find('input.filter-submit-target[type="hidden"]').val();d[u]={};t=t.split(" ");var D={},B;for(B=0;B<t.length;B++){var z=t[B];var C=$("#"+z);var F=C.is(":visible")?!0:!1;var E=!1;var G=null;C.hasClass("dataTable")?(E=$("input#"+t[B]+"_configurations"),E.length&&(G=JSON.parse($(E).val()),G=G.ajaxUrl,G="undefined"!=typeof G?k(G,w):null),G?(D[t[B]]=G,E=!1):E=!0):C.hasClass("dl")||C.hasClass("map_wrapper")||
C.hasClass("cms_content")||C.hasClass("gi-container")||C.hasClass("pt-container")||C.hasClass("tp-container")||C.hasClass("s3-target")||C.hasClass("s3-organizer")?E=!1:F?(y=k(y,w),window.location.href=y):E=!0;F||(d[u][z]={needs_reload:E,ajaxurl:G,queries:w})}for(B=0;B<t.length;B++)z=t[B],C=$("#"+z),C.is(":visible")&&(C.hasClass("dataTable")?(u=C.dataTable(),z=D[z],u.fnReloadAjax(z),q(u,w),$("#"+u[0].id+"_dataTable_filterURL").val(z)):C.hasClass("dl")?C.datalist("ajaxReload",w):C.hasClass("map_wrapper")?
S3.gis.refreshLayer("search_results",w):C.hasClass("gi-container")?C.groupedItems("reload",null,w):C.hasClass("pt-container")?C.pivottable("reload",null,w):C.hasClass("tp-container")?C.timeplot("reload",null,w):C.hasClass("s3-target")?C.s3Target("reload",k(y,w)):C.hasClass("s3-organizer")&&C.organizer("reload"))}else y=k(y,w),window.location.href=y},A=function(t,u){t=$(t);var y;t.find(".advanced").each(function(){var w=$(this);w.hasClass("hide")?(w.removeClass("hide").show().find(".multiselect-filter-widget,.groupedopts-filter-widget").each(function(){var D=
$(this);D.addClass("active");D.hasClass("groupedopts-filter-widget")&&D.groupedopts("instance")?D.groupedopts("refresh"):D.hasClass("multiselect-filter-widget")&&D.multiselect("instance")&&D.multiselect("refresh")}),y=!0):(w.addClass("hide").hide().find(".multiselect-filter-widget,.groupedopts-filter-widget").removeClass("active"),y=!1)});t=$(t.find(".filter-advanced-label"));y?t.text(t.data("off")).siblings().toggle():t.text(t.data("on")).siblings().toggle()};$(function(){$(".groupedopts-filter-widget:visible,.multiselect-filter-widget:visible").addClass("active");
$(".filter-clear").on("click",function(){var t=$(this).closest(".filter-form");e(t)});$(".show-filter-manager").on("click",function(){$(".filter-manager-row").removeClass("hide").show();$(".show-filter-manager").hide()});$(".filter-submit").on("click",function(){x($(this).closest(".filter-form"))});$(".filter-form").on("dataChanged",function(t,u,y){u&&(t=$(this).find("input.filter-submit-target").val())&&(t=t.split(" "),t.length&&-1!=$.inArray(u+"",t)&&S3.search.ajaxUpdateOptions(this,y));return!1});
$(".filter-advanced").on("click",function(){A($(this).closest("form"))});$(".location-filter").on("change",function(){v(this)});$(".text-filter").on("keyup.autosubmit",function(t){27==t.keyCode&&$(this).val("").closest("form").trigger("optionChanged")});$(".text-filter, .range-filter-input").on("input.autosubmit",function(){$(this).closest("form").trigger("optionChanged")});$(".options-filter, .location-filter, .date-filter-input, .age-filter-input, .map-filter, .value-filter").on("change.autosubmit",
function(){$(this).closest("form").trigger("optionChanged")});$('.s3-options-filter-anyall input[type="radio"]').on("change.autosubmit",function(){$(this).closest("form").trigger("optionChanged")});$(".hierarchy-filter").on("select.s3hierarchy",function(){$(this).closest("form").trigger("optionChanged")});$(".map-filter").each(function(){var t=$(this);$.when(n()).then(function(){var u=t.attr("id"),y=$("#"+u),w,D=S3.gis,B=D.maps[u+"-map"],z=B.s3;z.pointPlaced=function(C){var F={internalProjection:B.getProjectionObject(),
externalProjection:D.proj4326};w=(new OpenLayers.Format.WKT(F)).write(C);y.val('"'+w+'"').trigger("change")};z.polygonButtonOff=function(){y.val("").trigger("change")};z.layerRefreshed=function(){var C=z.polygonButton;C&&"drawpolygonclear-off"==C.getIconClass()&&(z.lastDraftFeature?z.lastDraftFeature.destroy():1<z.draftLayer.features.length&&z.draftLayer.features[0].destroy(),C.control.deactivate(),C.items[0].pressed=!0)};z.polygonButtonLoaded=function(){if(w=y.val()){z.polygonButton.items[0].btnEl.dom.click();
var C=OpenLayers.Geometry.fromWKT(w);C.transform(D.proj4326,B.getProjectionObject());C=new OpenLayers.Feature.Vector(C,{},null);var F=z.draftLayer;F.addFeatures([C]);z.lastDraftFeature=C;B.zoomToExtent(F.getDataExtent())}};z.polygonButtonLoaded()},function(u){s3_debug(u)},function(u){s3_debug(u)})});$(".text-filter").on("keypress",function(t){return 13==t.which?(t.preventDefault(),!1):!0})})})();
...
this._showCRUDButtons()},_load:function(){var g=this.element,c=this.options.filters,e=a(g).val();e&&c.hasOwnProperty(e)&&S3.search.setCurrentFilters(a(g).closest("form"),c[e])},clear:function(){a(this.element).val("");this._cancel()},_showCRUDButtons:function(){var g=this.options;this._hideCRUDButtons();!g.readOnly&&g.allowCreate&&this.create_btn.show();a(this.element).val()&&(g.explicitLoad&&this.load_btn.show(),g.readOnly||(g.allowUpdate&&this.save_btn.show(),g.allowDelete&&this.delete_btn.show()))},
_hideCRUDButtons:function(){this.create_btn.hide();this.load_btn.hide();this.delete_btn.hide();this.save_btn.hide()},_getFilterURL:function(){var g=a(this.element).closest("form").find('input.filter-submit-url[type="hidden"]');return g.length?g.first().val():document.URL},_bindEvents:function(){var g=this;this.create_btn.on("click",function(){g._newFilter()});this.accept_btn.on("click",function(){g._accept()});this.cancel_btn.on("click",function(){g._cancel()});this.element.on("change",function(){g._showCRUDButtons();
...
(function(){S3.autocomplete={};S3.autocomplete.normal=function(d,g,c,e,h,f,k,q,l){var n="dummy_"+e,m=$("#"+n);if(m.length){g=S3.Ap.concat("/",g,"/",c,"/search_ac.json?field=",d);h&&(g+="&"+h);f&&(g+="&link="+f);var p=$("#"+e);p.hide();if(e=p.val())var r={value:e,label:m.val()};p.data("existing",r);p.data("url",g);var v=$("#"+n+"_throbber");void 0==q&&(q=800);void 0==l&&(l=2);m.val();m.autocomplete({delay:q,minLength:l,source:function(x,A){$.ajax({url:p.data("url"),data:{term:x.term}}).done(function(t){if(0==
t.length){p.val("").trigger("change");var u={id:0};u[d]=i18n.no_matching_records}else u={id:0},u[d]=i18n.none_of_the_above;t.push(u);A(t)})},search:function(x,A){v.removeClass("hide").show();return!0},response:function(x,A,t){v.hide();return t},focus:function(x,A){return!1},select:function(x,A){x=A.item;x.id?(m.val(x[d]),p.val(x.id).trigger("change"),r={value:x.id,label:x[d]}):(m.val(""),p.val("").trigger("change"));k&&eval(k);return!1}}).data("ui-autocomplete")._renderItem=function(x,A){var t=A.label?
A.label:A[d];return $("<li>").data("item.autocomplete",A).append("<a>"+t+"</a>").appendTo(x)};m.on("blur",function(){r&&r.label!=m.val()&&p.val("").trigger("change")})}};S3.autocomplete.generic=function(d,g,c,e,h){var f="dummy_"+g,k=$("#"+f);if(k.length){var q=$("#"+g);q.hide();if(g=q.val())var l={value:g,name:k.val()};q.data("existing",l);q.data("url",d);var n=$("#"+f+"_throbber");void 0==e&&(e=800);void 0==h&&(h=2);k.autocomplete({delay:e,minLength:h,source:function(m,p){$.ajax({url:q.data("url"),
...
r.L3):r.L3),r.L2&&(v=v?v+(", "+r.L2):r.L2),r.L1&&(v=v?v+(", "+r.L1):r.L1),r.L0&&(v=v?v+(", "+r.L0):r.L0);return $("<li>").data("item.autocomplete",r).append("<a>"+v+"</a>").appendTo(p)};k.on("blur",function(){n&&n.name!=k.val()&&l.val("").trigger("change")})}};var a=function(d){return void 0!=d.label?d.label:d.org||d.job?b(d):d.name};S3.autocomplete.person=function(d,g,c,e,h,f,k){var q="dummy_"+c,l=$("#"+q);if(l.length){d=S3.Ap.concat("/",d,"/",g,"/search_ac.json");e&&(d+="?"+e);var n=$("#"+c);n.hide();
if(c=n.val())var m={value:c,name:l.val()};n.data("existing",m);n.data("url",d);var p=$("#"+q+"_throbber");void 0==f&&(f=800);void 0==k&&(k=2);l.autocomplete({delay:f,minLength:k,source:function(r,v){$.ajax({url:n.data("url"),data:{term:r.term}}).done(function(x){0==x.length?(n.val("").trigger("change"),x.push({id:0,value:"",label:i18n.no_matching_records})):x.push({id:0,value:"",label:i18n.none_of_the_above});v(x)})},search:function(r,v){p.removeClass("hide").show();return!0},response:function(r,
v,x){p.hide();return x},focus:function(r,v){return!1},select:function(r,v){r=v.item;r.id?(v=a(r),l.val(v),n.val(r.id).trigger("change"),m={value:r.id,name:v}):(l.val(""),n.val("").trigger("change"));h&&eval(h);return!1}}).data("ui-autocomplete")._renderItem=function(r,v){var x=a(v);return $("<li>").data("item.autocomplete",v).append("<a>"+x+"</a>").appendTo(r)};l.on("blur",function(){m&&m.name!=l.val()&&n.val("").trigger("change")})}};S3.autocomplete.pentity=function(d,g,c,e,h,f,k){var q="dummy_"+
c,l=$("#"+q);if(l.length){var n=S3.Ap.concat("/",d,"/",g,"/search_ac.json"),m=$("#"+c);m.hide();if(d=m.val())var p={value:d,name:l.val()};m.data("existing",p);m.data("url",n);var r=$("#"+q+"_throbber");void 0==h&&(h=800);void 0==f&&(f=2);l.autocomplete({delay:h,minLength:f,source:function(v,x){n=m.data("url");k&&(n+="?types="+k);$.ajax({url:n,data:{term:v.term}}).done(function(A){0==A.length?(m.val("").trigger("change"),A.push({id:0,value:"",label:i18n.no_matching_records})):A.push({id:0,value:"",
label:i18n.none_of_the_above});x(A)})},search:function(v,x){r.removeClass("hide").show();return!0},response:function(v,x,A){r.hide();return A},focus:function(v,x){return!1},select:function(v,x){v=x.item;v.id?(l.val(v.name),m.val(v.id).trigger("change"),p={value:v.id,name:v.name}):(l.val(""),m.val("").trigger("change"));e&&eval(e);return!1}}).data("ui-autocomplete")._renderItem=function(v,x){var A=x.label?x.label:x.name;return $("<li>").data("item.autocomplete",x).append("<a>"+A+"</a>").appendTo(v)};
...
var q=$("#"+g);q.hide();if(g=q.val())var l={value:g,name:k.val()};q.data("existing",l);q.data("url",d);var n=$("#"+f+"_throbber");void 0==e&&(e=800);void 0==h&&(h=2);k.autocomplete({delay:e,minLength:h,source:function(m,p){$.ajax({url:q.data("url"),data:{term:m.term}}).done(function(r){0==r.length?(q.val("").trigger("change"),r.push({id:0,value:"",label:i18n.no_matching_records})):r.push({id:0,value:"",label:i18n.none_of_the_above});p(r)})},search:function(m,p){n.removeClass("hide").show();return!0},
...
"dummy_"+d,f=$("#"+h);if(f.length){var k=S3.Ap.concat("/org/organisation/search_ac.json"),q=$("#"+d);q.hide();if(d=q.val())var l={value:d,name:f.val()};q.data("existing",l);q.data("url",k);var n=$("#"+h+"_throbber");void 0==c&&(c=800);void 0==e&&(e=2);f.autocomplete({delay:c,minLength:e,source:function(m,p){$.ajax({url:q.data("url"),data:{term:m.term}}).done(function(r){0==r.length?(q.val("").trigger("change"),r.push({id:0,value:"",label:i18n.no_matching_records})):r.push({id:0,value:"",label:i18n.none_of_the_above});
...
p.nextString+"</b>"):(r=p.matchString+"<b>"+p.nextString+"</b>",p.parent?r=p.parent+" > "+r:p.acronym&&(r+=" - "+p.acronym)):(r=p.name,p.parent?r=p.parent+" > "+p.name:p.acronym&&(r+=" ("+p.acronym+")"));return $("<li>").data("item.autocomplete",p).append("<a>"+r+"</a>").appendTo(m)};f.on("blur",function(){l&&l.name!=f.val()&&q.val("").trigger("change")})}};S3.autocomplete.site=function(d,g,c,e){var h="dummy_"+d,f=$("#"+h);if(f.length){var k=S3.Ap.concat("/org/site/search_ac.json"),q=$("#"+d);q.hide();
if(d=q.val())var l={value:d,name:f.val()};q.data("existing",l);q.data("url",k);var n=$("#"+h+"_throbber");void 0==c&&(c=800);void 0==e&&(e=2);f.autocomplete({delay:c,minLength:e,source:function(m,p){$.ajax({url:q.data("url"),data:{term:m.term}}).done(function(r){0==r.length?(q.val("").trigger("change"),r.push({id:0,value:"",label:i18n.no_matching_records})):r.push({id:0,value:"",label:i18n.none_of_the_above});p(r)})},search:function(m,p){n.removeClass("hide").show();return!0},response:function(m,
...
" ("+v,x&&(r+=", "+x),r+=")"):r+=" ("+x+")";var A=p.org;v=p.instance_type;if(A||v)v?(r+=" ("+S3.org_site_types[v],A&&(r+=", "+A),r+=")"):r+=" ("+A+")"}else if("addr"==p.match_type){if(r=p.name+" ("+r,r=(x=p.L4||p.L3||p.L2||p.L1)?r+(", "+x+")"):r+")",A=p.org,v=p.instance_type,A||v)v?(r+=" ("+S3.org_site_types[v],A&&(r+=", "+A),r+=")"):r+=" ("+A+")"}else if("org"==p.match_type){A=p.name;v=p.addr;x=p.L4||p.L3||p.L2||p.L1;if(v||x)v?(A+=" ("+v,x&&(A+=", "+x),A+=")"):A+=" ("+x+")";r=(v=p.instance_type)?
A+" ("+S3.org_site_types[v]+", "+r+")":A+" ("+r+")"}else{if(A=p.name,r=(v=p.addr)?A+" ("+v+", "+r+")":A+" ("+r+")",A=p.org,v=p.instance_type,A||v)v?(r+=" ("+S3.org_site_types[v],A&&(r+=", "+A),r+=")"):r+=" ("+A+")"}else r=p.name;return $("<li>").data("item.autocomplete",p).append("<a>"+r+"</a>").appendTo(m)};f.on("blur",function(){l&&l.name!=f.val()&&q.val("").trigger("change")})}}})();
