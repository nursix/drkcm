...
$.searchDownloadS3=function(t,u){var y=$.extend({},b,{url:t});t=document.createElement("form");y.type="GET";a(y,"form");t.action=y.url;t.method="POST";t.target=u||"_self";t.enctype="multipart/form-data";if(u=y.data)for(var w in u)y=document.createElement("textarea"),y.name=w,y.value=JSON.stringify(u[w]),t.appendChild(y);t.style.display="none";document.body.appendChild(t);t.submit()};var d={},g=function(t){return t?(t=t.replace(/"/,'\\"'),-1!=t.search(/,/)&&(t='"'+t+'"'),t):t},c=function(t){if(!t)return t;
