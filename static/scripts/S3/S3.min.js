...
{},null);var F=z.draftLayer;F.addFeatures([D]);z.lastDraftFeature=D;B.zoomToExtent(F.getDataExtent())}};z.polygonButtonLoaded()},function(u){s3_debug(u)},function(u){s3_debug(u)})});$("form.filter-form").each(function(){f($(this))});$(".text-filter").on("keypress",function(t){return 13==t.which?(t.preventDefault(),!1):!0})})})();
