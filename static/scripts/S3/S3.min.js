...
var u,y,w=[],C,B,z,D,F,E;$(".text-filter",t).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();if(z=C.val().trim()){D=z.split(" ");var G=C.data("match"),H=[];for(u=0;u<D.length;u++)if(F=$.trim(D[u]),""!==F){var I=g("*"+F+"*");"any"==G?H.push(I):w.push([B,I])}"any"==G&&w.push([B,H.join(",")])}else w.push([B,null])});$(".s3-groupedopts-widget",t).prev(".options-filter.groupedopts-filter-widget").add($(".ui-multiselect",t).prev(".options-filter.multiselect-filter-widget")).add($(".options-filter,.options-filter.multiselect-filter-widget",
t)).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();E=$("input:radio[name='"+y+"_filter']:checked").val();switch(E){case "any":B=B.replace(/__contains$|__belongs$/,"__anyof");break;case "all":B=B.replace(/__anyof$|__belongs$/,"__contains")}if("select"==this.tagName.toLowerCase()){if(z="",D=C.val())for(D instanceof Array||(D=D.split(",")),u=0;u<D.length;u++){var G=g(D[u]);z=""===z?G:z+","+G}}else z="",$("input[name='"+y+"']:checked").each(function(){z=""===z?g($(this).val()):z+","+
g($(this).val())});""===z||"*"==z?w.push([B,null]):w.push([B,z])});$(".map-filter",t).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();(z=C.val())?w.push([B,z]):w.push([B,null])});$(".range-filter-input",t).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();(z=C.val())?w.push([B,z]):w.push([B,null])});$(".date-filter-input",t).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();z=C.val();E=y.split("-").pop();if(C.hasClass("datetimepicker"))var G=function(Q){return Q.getFullYear()+
...
""),w.push(["$filter","("+I+" "+E+' "'+O+'") or ('+I+" eq NONE)"])):w.push([B,O])):w.push([B,null])});$(".s3-groupedopts-widget",t).prev(".location-filter.groupedopts-filter-widget").add($(".ui-multiselect",t).prev(".location-filter.multiselect-filter-widget")).add($(".location-filter,.location-filter.multiselect-filter-widget",t)).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();z="";if("select"==this.tagName.toLowerCase()){if(D=$(this).val(),D)for(u=0;u<D.length;u++){var G=g(D[u]);
z=""===z?G:z+","+G}}else $("input[name='"+y+"']:checked").each(function(){z=""===z?g($(this).val()):z+","+g($(this).val())});""===z?w.push([B,null]):w.push([B,z])});$(".hierarchy-filter",t).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();z="";if(D=C.hasClass("s3-cascade-select")?C.cascadeSelect("get"):C.hierarchicalopts("get"))for(u=0;u<D.length;u++)z=""===z?z+D[u]:z+","+D[u];""===z?w.push([B,null]):w.push([B,z])});$(".age-filter-input",t).each(function(){C=$(this);y=C.attr("id");
B=$("#"+y+"-data").val();z=C.val();var G=z-0;if(z&&!isNaN(G)){var H=B.match(h);H&&"gt"==H[1]&&(G+=1);H=new Date;H.setYear(H.getFullYear()-G);H=H.getFullYear()+"-"+("0"+(H.getMonth()+1)).slice(-2)+"-"+("0"+H.getDate()).slice(-2);w.push([B,H])}else w.push([B,null])});$(".value-filter",t).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();C.prop("checked")?w.push([B,"None"]):w.push([B,null])});w.filter(function(G){return null!=G[1]}).length?t.addClass("has-active-filters"):t.removeClass("has-active-filters");
return w};S3.search.getCurrentFilters=f;S3.search.setCurrentFilters=function(t,u){void 0===t&&(t=$("body").find("form.filter-form").first());t.data("noAutoSubmit",1);var y,w={},C,B,z;var D=0;for(C=u.length;D<C;D++){var F=u[D];var E=F[0];var G="string"==typeof F[1]?c(F[1]):F[1];w.hasOwnProperty(E)?w[E]=w[E].concat(G):w[E]=G}t.find(".text-filter").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();if(w.hasOwnProperty(E)){B.is(":visible")||B.hasClass("active")||A(t);G=w[E];z="";if(G){var H;
D=0;for(C=G.length;D<C;D++)if(H=G[D])0<D&&(z+=" "),"*"==H[0]&&(H=H.slice(1)),"*"==H.slice(-1)&&(H=H.slice(0,-1)),z+=H}B.val(z)}});t.find(".options-filter").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();var H=$('input:radio[name="'+y+'_filter"]:checked').val();if(this.tagName&&"select"==this.tagName.toLowerCase()){var I=!1,J=E.replace(h,"");if(w.hasOwnProperty(J+"__eq"))G=w[J+"__eq"],I=!0;else if(w.hasOwnProperty(J))G=w[J],I=!0;else if(w.hasOwnProperty(E))G=w[E],I=!0;else if("any"==
H||"all"==H)w.hasOwnProperty(J+"__anyof")?(G=w[J+"__anyof"],I=!0,$('input:radio[name="'+y+'_filter"][value="any"]').prop("checked",!0)):w.hasOwnProperty(J+"__contains")&&(G=w[J+"__contains"],I=!0,$('input:radio[name="'+y+'_filter"][value="all"]').prop("checked",!0));I&&(B.is(":visible")||B.hasClass("active")||A(t),B.val(G),B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hasClass("multiselect-filter-widget")&&B.multiselect("instance")&&B.multiselect("refresh"))}});
t.find(".map-filter").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();if(w.hasOwnProperty(E))if(B.is(":visible")||B.hasClass("active")||A(t),G=w[E],G){B.val(G[0]);var H=y+"-map";S3.gis.maps[H].s3.polygonButtonLoaded()}else B.val(""),H=y+"-map",S3.gis.maps[H].s3.layerRefreshed()});t.find(".range-filter-input").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();w.hasOwnProperty(E)&&(B.is(":visible")||B.hasClass("active")||A(t),(G=w[E])?B.val(G[0]):B.val(""))});t.find(".date-filter-input").each(function(){var H=
