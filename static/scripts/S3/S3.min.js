...
t.width;var y=t.height;var w=t.offset;var C=a.extend({},w);a.each(["my","at"],function(){var z=(m[this]||"").split(" ");1===z.length&&(z=h.test(z[0])?z.concat(["center"]):f.test(z[0])?["center"].concat(z):["center","center"]);z[0]=h.test(z[0])?z[0]:"center";z[1]=f.test(z[1])?z[1]:"center";var D=k.exec(z[0]);var F=k.exec(z[1]);A[this]=[D?D[0]:0,F?F[0]:0];m[this]=[q.exec(z[0])[0],q.exec(z[1])[0]]});1===x.length&&(x[1]=x[0]);"right"===m.at[0]?C.left+=u:"center"===m.at[0]&&(C.left+=u/2);"bottom"===m.at[1]?
C.top+=y:"center"===m.at[1]&&(C.top+=y/2);var B=b(A.at,u,y);C.left+=B[0];C.top+=B[1];return this.each(function(){var z,D=a(this),F=D.outerWidth(),E=D.outerHeight(),G=parseInt(a.css(this,"marginLeft"),10)||0,H=parseInt(a.css(this,"marginTop"),10)||0,I=F+G+(parseInt(a.css(this,"marginRight"),10)||0)+v.width,J=E+H+(parseInt(a.css(this,"marginBottom"),10)||0)+v.height,M=a.extend({},C),R=b(A.my,D.outerWidth(),D.outerHeight());"right"===m.my[0]?M.left-=F:"center"===m.my[0]&&(M.left-=F/2);"bottom"===m.my[1]?
M.top-=E:"center"===m.my[1]&&(M.top-=E/2);M.left+=R[0];M.top+=R[1];var S={marginLeft:G,marginTop:H};a.each(["left","top"],function(L,O){if(a.ui.position[x[L]])a.ui.position[x[L]][O](M,{targetWidth:u,targetHeight:y,elemWidth:F,elemHeight:E,collisionPosition:S,collisionWidth:I,collisionHeight:J,offset:[B[0]+R[0],B[1]+R[1]],my:m.my,at:m.at,within:r,elem:D})});m.using&&(z=function(L){var O=w.left-M.left,P=O+u-F,Q=w.top-M.top,U=Q+y-E,N={target:{element:p,left:w.left,top:w.top,width:u,height:y},element:{element:D,
left:M.left,top:M.top,width:F,height:E},horizontal:0>P?"left":0<O?"right":"center",vertical:0>U?"top":0<Q?"bottom":"middle"};u<F&&e(O+P)<u&&(N.horizontal="center");y<E&&e(Q+U)<y&&(N.vertical="middle");c(e(O),e(P))>c(e(Q),e(U))?N.important="horizontal":N.important="vertical";m.using.call(this,L,N)});D.offset(a.extend(M,{using:z}))})};a.ui.position={fit:{left:function(m,p){var r=p.within,v=r.isWindow?r.scrollLeft:r.offset.left,x=r.width,A=m.left-p.collisionPosition.marginLeft;r=v-A;var t=A+p.collisionWidth-
...
q.monthNamesShort:null)||this._defaults.monthNamesShort,x=(q?q.monthNames:null)||this._defaults.monthNames,A=q=-1,t=-1,u=-1,y=!1,w=function(F){(F=l+1<f.length&&f.charAt(l+1)===F)&&l++;return F},C=function(F){var E=w(F);E="@"===F?14:"!"===F?20:"y"===F&&E?4:"o"===F?3:2;F=new RegExp("^\\d{"+("y"===F?E:1)+","+E+"}");F=k.substring(n).match(F);if(!F)throw"Missing number at position "+n;n+=F[0].length;return parseInt(F[0],10)},B=function(F,E,G){var H=-1;F=a.map(w(F)?G:E,function(I,J){return[[J,I]]}).sort(function(I,
J){return-(I[1].length-J[1].length)});a.each(F,function(I,J){I=J[1];if(k.substr(n,I.length).toLowerCase()===I.toLowerCase())return H=J[0],n+=I.length,!1});if(-1!==H)return H+1;throw"Unknown name at position "+n;},z=function(){if(k.charAt(n)!==f.charAt(l))throw"Unexpected literal at position "+n;n++};for(l=0;l<f.length;l++)if(y)"'"!==f.charAt(l)||w("'")?z():y=!1;else switch(f.charAt(l)){case "d":t=C("d");break;case "D":B("D",p,r);break;case "o":u=C("o");break;case "m":A=C("m");break;case "M":A=B("M",
v,x);break;case "y":q=C("y");break;case "@":var D=new Date(C("@"));q=D.getFullYear();A=D.getMonth()+1;t=D.getDate();break;case "!":D=new Date((C("!")-this._ticksTo1970)/1E4);q=D.getFullYear();A=D.getMonth()+1;t=D.getDate();break;case "'":w("'")?z():y=!0;break;default:z()}if(n<k.length&&(p=k.substr(n),!/^\s+/.test(p)))throw"Extra/unparsed characters found in date: "+p;-1===q?q=(new Date).getFullYear():100>q&&(q+=(new Date).getFullYear()-(new Date).getFullYear()%100+(q<=m?0:-100));if(-1<u){A=1;t=u;
do{m=this._getDaysInMonth(q,A-1);if(t<=m)break;A++;t-=m}while(1)}D=this._daylightSavingAdjust(new Date(q,A-1,t));if(D.getFullYear()!==q||D.getMonth()+1!==A||D.getDate()!==t)throw"Invalid date";return D},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:62135596800*1E7,formatDate:function(f,k,q){if(!k)return"";var l,n=(q?q.dayNamesShort:
null)||this._defaults.dayNamesShort,m=(q?q.dayNames:null)||this._defaults.dayNames,p=(q?q.monthNamesShort:null)||this._defaults.monthNamesShort;q=(q?q.monthNames:null)||this._defaults.monthNames;var r=function(u){(u=l+1<f.length&&f.charAt(l+1)===u)&&l++;return u},v=function(u,y,w){y=""+y;if(r(u))for(;y.length<w;)y="0"+y;return y},x=function(u,y,w,C){return r(u)?C[y]:w[y]},A="",t=!1;if(k)for(l=0;l<f.length;l++)if(t)"'"!==f.charAt(l)||r("'")?A+=f.charAt(l):t=!1;else switch(f.charAt(l)){case "d":A+=
...
"isRTL");var r=this._get(f,"showButtonPanel");var v=this._get(f,"hideIfNoPrevNext");var x=this._get(f,"navigationAsDateFormat");var A=this._getNumberOfMonths(f),t=this._get(f,"showCurrentAtPos");var u=this._get(f,"stepMonths");var y=1!==A[0]||1!==A[1],w=this._daylightSavingAdjust(f.currentDay?new Date(f.currentYear,f.currentMonth,f.currentDay):new Date(9999,9,9)),C=this._getMinMaxDate(f,"min"),B=this._getMinMaxDate(f,"max");t=f.drawMonth-t;var z=f.drawYear;0>t&&(t+=12,z--);if(B){var D=this._daylightSavingAdjust(new Date(B.getFullYear(),
B.getMonth()-A[0]*A[1]+1,B.getDate()));for(D=C&&D<C?C:D;this._daylightSavingAdjust(new Date(z,t,1))>D;)t--,0>t&&(t=11,z--)}f.drawMonth=t;f.drawYear=z;D=this._get(f,"prevText");D=x?this.formatDate(D,this._daylightSavingAdjust(new Date(z,t-u,1)),this._getFormatConfig(f)):D;D=this._canAdjustMonth(f,-1,z,t)?a("<a>").attr({"class":"ui-datepicker-prev ui-corner-all","data-handler":"prev","data-event":"click",title:D}).append(a("<span>").addClass("ui-icon ui-icon-circle-triangle-"+(p?"e":"w")).text(D))[0].outerHTML:
...
"dayNamesMin");var G=this._get(f,"monthNames");var H=this._get(f,"monthNamesShort");var I=this._get(f,"beforeShowDay");var J=this._get(f,"showOtherMonths");var M=this._get(f,"selectOtherMonths");var R=this._getDefaultDate(f);var S="";for(k=0;k<A[0];k++){var L="";this.maxRows=4;for(q=0;q<A[1];q++){var O=this._daylightSavingAdjust(new Date(z,t,f.selectedDay));var P=" ui-corner-all";var Q="";if(y){Q+="<div class='ui-datepicker-group";if(1<A[1])switch(q){case 0:Q+=" ui-datepicker-group-first";P=" ui-corner-"+
(p?"right":"left");break;case A[1]-1:Q+=" ui-datepicker-group-last";P=" ui-corner-"+(p?"left":"right");break;default:Q+=" ui-datepicker-group-middle",P=""}Q+="'>"}Q+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+P+"'>"+(/all|left/.test(P)&&0===k?p?v:D:"")+(/all|right/.test(P)&&0===k?p?D:v:"")+this._generateMonthYearHeader(f,t,z,C,B,0<k||0<q,G,H)+"</div><table class='ui-datepicker-calendar'><thead><tr>";var U=u?"<th class='ui-datepicker-week-col'>"+this._get(f,"weekHeader")+
"</th>":"";for(P=0;7>P;P++){var N=(P+r)%7;U+="<th scope='col'"+(5<=(P+r+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+F[N]+"'>"+E[N]+"</span></th>"}Q+=U+"</tr></thead><tbody>";U=this._getDaysInMonth(z,t);z===f.selectedYear&&t===f.selectedMonth&&(f.selectedDay=Math.min(f.selectedDay,U));P=(this._getFirstDayOfMonth(z,t)-r+7)%7;U=Math.ceil((P+U)/7);this.maxRows=U=y?this.maxRows>U?this.maxRows:U:U;N=this._daylightSavingAdjust(new Date(z,t,1-P));for(l=0;l<U;l++){Q+="<tr>";var ca=u?"<td class='ui-datepicker-week-col'>"+
this._get(f,"calculateWeek")(N)+"</td>":"";for(P=0;7>P;P++){var da=I?I.apply(f.input?f.input[0]:null,[N]):[!0,""];var ha=(n=N.getMonth()!==t)&&!M||!da[0]||C&&N<C||B&&N>B;ca+="<td class='"+(5<=(P+r+6)%7?" ui-datepicker-week-end":"")+(n?" ui-datepicker-other-month":"")+(N.getTime()===O.getTime()&&t===f.selectedMonth&&f._keyEvent||R.getTime()===N.getTime()&&R.getTime()===O.getTime()?" "+this._dayOverClass:"")+(ha?" "+this._unselectableClass+" ui-state-disabled":"")+(n&&!J?"":" "+da[1]+(N.getTime()===
...
"")+"' href='#' aria-current='"+(N.getTime()===w.getTime()?"true":"false")+"' data-date='"+N.getDate()+"'>"+N.getDate()+"</a>")+"</td>";N.setDate(N.getDate()+1);N=this._daylightSavingAdjust(N)}Q+=ca+"</tr>"}t++;11<t&&(t=0,z++);Q+="</tbody></table>"+(y?"</div>"+(0<A[0]&&q===A[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");L+=Q}S+=L}f._keyEvent=!1;return S+x},_generateMonthYearHeader:function(f,k,q,l,n,m,p,r){var v=this._get(f,"changeMonth"),x=this._get(f,"changeYear"),A=this._get(f,"showMonthAfterYear");
var t=this._get(f,"selectMonthLabel");var u=this._get(f,"selectYearLabel"),y="<div class='ui-datepicker-title'>",w="";if(m||!v)w+="<span class='ui-datepicker-month'>"+p[k]+"</span>";else{p=l&&l.getFullYear()===q;var C=n&&n.getFullYear()===q;w+="<select class='ui-datepicker-month' aria-label='"+t+"' data-handler='selectMonth' data-event='change'>";for(t=0;12>t;t++)(!p||t>=l.getMonth())&&(!C||t<=n.getMonth())&&(w+="<option value='"+t+"'"+(t===k?" selected='selected'":"")+">"+r[t]+"</option>");w+="</select>"}A||
...
a(this),F=D.html();z=parseInt(F.replace(/[^0-9]/g),10);F=F.replace(/[^apm]/ig);D=D.data("for");"hour"===D&&(-1!==F.indexOf("p")&&12>z?z+=12:-1!==F.indexOf("a")&&12===z&&(z=0));m.control.value(m,m[D+"_slider"],p,z);m._onTimeChange();m._onSelectHandler()}).css({cursor:"pointer",width:100/A[p]+"%",textAlign:"center",overflow:"hidden"}));this.timezone_select=w.find(".ui_tpicker_timezone").append("<select></select>").find("select");a.fn.append.apply(this.timezone_select,a.map(n.timezoneList,function(z,
...
this._defaults.sliderAccessArgs,B=this._defaults.isRTL;C.isRTL=B;setTimeout(function(){if(0===w.find(".ui-slider-access").length){w.find(".ui-slider:visible").sliderAccess(C);var z=w.find(".ui-slider-access:eq(0)").outerWidth(!0);z&&w.find("table:visible").each(function(){var D=a(this),F=D.outerWidth(),E=D.css(B?"marginRight":"marginLeft").toString().replace("%",""),G=F-z,H={width:G,marginRight:0,marginLeft:0};H[B?"marginRight":"marginLeft"]=E*G/F+"%";D.css(H)})}},10)}m._limitMinMaxDateTime(this.inst,
...
function(l,n,m){a.timepicker.handleRange("datepicker",l,n,m)};a.timepicker.handleRange=function(l,n,m,p){function r(A,t){var u=n[l]("getDate"),y=m[l]("getDate");A=A[l]("getDate");if(null!==u){var w=new Date(u.getTime()),C=new Date(u.getTime());w.setMilliseconds(w.getMilliseconds()+p.minInterval);C.setMilliseconds(C.getMilliseconds()+p.maxInterval);if(0<p.minInterval&&w>y)m[l]("setDate",w);else if(0<p.maxInterval&&C<y)m[l]("setDate",C);else if(u>y)t[l]("setDate",A)}}function v(A,t,u){A.val()&&(A=A[l].call(A,
...
x.groupedopts("visible"):x.data("visible")||x.is(":visible"))A=!0,x.data("visible",!0),x.hasClass("groupedopts-widget")?x.groupedopts("hide"):x.hide(),b(x,r);v=$.ajaxS3({url:p,dataType:"html",success:function(t){var u=x;if(""!==t){var y=!1,w=!1;u.hasClass("groupedopts-widget")?y=!0:u.hasClass("multiselect-widget")&&(w=!0);var C;(y||w)&&"select"==u.prop("tagName").toLowerCase()&&(C=u.val());u.html(t).trigger("change").prop("disabled",!1);if(y||w){if(C){t=[];w=0;for(var B=C.length,z;w<B;w++)z=C[w],
...
t.hide(),b(t,r)):t.data("visible",!1)}),v=$.ajaxS3({url:p,dataType:"json",success:function(t){var u=c(t,l),y=0===t.length?!0:!1;f.each(function(){var w=$(this);a:if(w.hasClass("checkboxes-widget-s3"))s3_debug("filterOptionsS3 error: checkboxes-widget-s3 not supported, updateOptions aborted"),w=void 0;else{var C=u.options,B=u.defaultValue,z=[];if(!y){var D;if(w.hasClass("checkboxes-widget-s3")){w=void 0;break a}else{(D=w.val())||(D=w.prop("value"));D||=w.data("initialValue");Array.isArray(D)||(D=D?
[D]:[]);for(var F=0,E=D.length,G;F<E;F++)(G=D[F])&&$(C).filter("option[value="+G+"]").length&&z.push(G)}z.length&&(B=z)}"INPUT"==w.prop("tagName")&&(z=$("<select>").addClass(w.attr("class")).attr("id",w.attr("id")).attr("name",w.attr("name")).data("visible",w.data("visible")).hide(),w.replaceWith(z),w=z);z=""===C;w.html(C).val(B).trigger("change").prop("disabled",z);w.hasClass("groupedopts-widget")?w.groupedopts("refresh"):w.hasClass("multiselect-widget")&&(w.multiselect("refresh"),z?w.multiselect("disable"):
...
y.append("<label>"+c.label+"</label>");c.formid&&y.attr("id",c.formid);var w=q.apply(y,[c,t]);c.inputcssclass&&("inherit"===c.inputcssclass?w.attr("class",a(t).attr("class")):w.attr("class",c.inputcssclass));var C=!1;if(c.loadurl){var B=t.setTimeout(function(){w.disabled=!0},100);a(t).html(c.loadtext);u={};u[c.id]=t.id;"function"===typeof c.loaddata?a.extend(u,c.loaddata.apply(t,[t.revert,c])):a.extend(u,c.loaddata);a.ajax({type:c.loadtype,url:c.loadurl,data:u,async:!1,cache:!1,success:function(D){t.clearTimeout(B);
z=D;w.disabled=!1}})}else if(c.data){var z=c.data;"function"===typeof c.data&&(z=c.data.apply(t,[t.revert,c]))}else z=t.revert;k.apply(y,[z,c,t]);w.attr("name",c.name);"none"!==c.width&&(u=c.width-(w.outerWidth(!0)-c.width),w.width(u));f.apply(y,[c,t]);c.showfn&&"function"===typeof c.showfn&&y.hide();a(t).html("");a(t).append(y);c.showfn&&"function"===typeof c.showfn&&c.showfn(y);e.apply(y,[c,t]);y.find(":input:visible:enabled:first").trigger("focus");c.select&&w.trigger("select");a(this).on("keydown",
function(D){27===D.which?(D.preventDefault(),l.apply(y,[c,t])):13==D.which&&D.shiftKey&&(D.preventDefault(),y.trigger("submit"))});if("cancel"===c.onblur)w.on("blur",function(D){B=t.setTimeout(function(){l.apply(y,[c,t])},500)});else if("submit"===c.onblur)w.on("blur",function(D){B=t.setTimeout(function(){y.trigger("submit")},200)});else if("function"===typeof c.onblur)w.on("blur",function(D){!1===c.onblur.apply(t,[w.val(),c,y])&&l.apply(y,[c,t])});y.on("submit",function(D){D.preventDefault();D.stopPropagation();
if(C)return!1;C=!0;B&&t.clearTimeout(B);if(C=!1!==v.apply(y,[c,t]))if(C=!1!==h.apply(y,[c,t]))if("function"===typeof c.target){D=function(H,I){C=!1;!1!==I&&(a(t).html(H),t.editing=!1,m.apply(t,[t.innerText,c]),a(t).html().trim()||a(t).html(c.placeholder))};var F=c.target.apply(t,[w.val(),c,D]);!1!==F&&void 0!==F&&D(F,F)}else{var E={};E[c.name]=w.val();E[c.id]=t.id;"function"===typeof c.submitdata?a.extend(E,c.submitdata.apply(t,[t.revert,c,E])):a.extend(E,c.submitdata);"PUT"===c.method&&(E._method=
"put");a(t).html(c.indicator);var G={type:"POST",complete:function(H,I){C=!1},data:E,dataType:"html",url:c.target,success:function(H,I){H=p.apply(t,[H,I]);"html"===G.dataType&&a(t).html(H);t.editing=!1;m.apply(t,[H,c,E]);a(t).html().trim()||a(t).html(c.placeholder)},error:function(H,I,J){A.apply(y,[c,t,H])}};a.extend(G,c.ajaxoptions);a.ajax(G)}a(t).attr("title",c.tooltip);return!1})}}),t.reset=function(u){t.editing&&!1!==x.apply(u,[c,t])&&(a(t).text(t.revert),t.editing=!1,a(t).html().trim()||a(t).html(c.placeholder),
...
h){},ajaxCache:!0,ajaxProcess:function(e){return e=e.replace(/<(script|style|title)[^<]+<\/(script|style|title)>/gm,"").replace(/<(link|meta)[^>]+>/g,"")},ajaxSettings:{dataType:"html"},debug:!1}};var b,d={},g=0,c=0;a.fn.attrProp=a.fn.prop||a.fn.attr;a.fn.cluetip=function(e,h){function f(C,B){var z=C||"";B=B||"";"object"==typeof B?a.each(B,function(D,F){z+="-"+D+"-"+F}):"string"==typeof B&&(z+=B);return z}function k(C,B,z){z="";B=B.dropShadow&&B.dropShadowSteps?+B.dropShadowSteps:0;if(a.support.boxShadow)return B&&
(z="1px 1px "+B+"px rgba(0,0,0,0.5)"),C.css(a.support.boxShadow,z),!1;z=C.find(".cluetip-drop-shadow");if(B==z.length)return z;z.remove();z=[];for(var D=0;D<B;)z[D++]='<div style="top:'+D+"px;left:"+D+'px;"></div>';return z=a(z.join("")).css({position:"absolute",backgroundColor:"#000",zIndex:A-1,opacity:.1}).addClass("cluetip-drop-shadow").prependTo(C)}var q,l;"object"==typeof e&&(h=e,e=null);if("destroy"==e){var n=this.data("cluetip");n&&(a(n.selector).remove(),a.removeData(this,"title"),a.removeData(this,
...
x.find(p+"cluetip-outer").css({position:"relative",zIndex:A});var u=x.find(p+"cluetip-inner");var y=x.find(p+"cluetip-title")}b=a("#cluetip-waitimage");b.length||(b=a("<div></div>").attr("id","cluetip-waitimage").css({position:"absolute"}));b.insertBefore(x).hide();var w=(parseInt(x.css("paddingLeft"),10)||0)+(parseInt(x.css("paddingRight"),10)||0);this.each(function(C){function B(){return!1}function z(K,T){var V=K.status;T.beforeSend(K.xhr,T);if("error"==V)T[V](K.xhr,K.textStatus);else if("success"==
V)T[V](K.data,K.textStatus,K.xhr);T.complete(K.xhr,T.textStatus)}var D=this,F=a(this),E=a.extend(!0,{},h,a.metadata?F.metadata():a.meta?F.data():F.data("cluetip")||{}),G=!1,H=!1,I=0,J=E[E.attribute]||("href"==E.attribute?F.attr(E.attribute):F.attrProp(E.attribute)||F.attr(E.attribute)),M=E.cluetipClass;A=+E.cluezIndex;F.data("cluetip",{title:D.title,zIndex:A,selector:m});if(!J&&!E.splitTitle&&!e)return!0;E.local&&E.localPrefix&&(J=E.localPrefix+J);E.local&&E.hideLocal&&J&&a(J+":first").hide();var R=
...
K))return!1;H=!0;x=a(m).css({position:"absolute"});t=x.find(p+"cluetip-outer");u=x.find(p+"cluetip-inner");y=x.find(p+"cluetip-title");q=x.find(p+"cluetip-arrows");x.removeClass().css({width:ha});J==F.attr("href")&&F.css("cursor",E.cursor);E.hoverClass&&F.addClass(E.hoverClass);U=F.offset().top;ea=F.offset().left;ia=F.innerWidth();K.type==focus?(aa=ea+ia/2+S,x.css({left:X}),ca=U+R):(aa=K.pageX,ca=K.pageY);"area"!=D.tagName.toLowerCase()&&(Q=a(document).scrollTop(),ka=a(window).width());if("fixed"==
E.positionBy)X=ia+ea+S,x.css({left:X});else{X=ia>ea&&ea>Z||ea+ia+Z+S>ka?ea-Z-S:ia+ea+S;if("area"==D.tagName.toLowerCase()||"mouse"==E.positionBy||ia+Z>ka)aa+20+Z>ka?(x.addClass("cluetip-"+M),X=0<=aa-Z-S?aa-Z-S-parseInt(x.css("marginLeft"),10)+parseInt(u.css("marginRight"),10):aa-Z/2):X=aa+S;var T=0>X?K.pageY+R:K.pageY;if(0>X||"bottomTop"==E.positionBy)X=aa+Z/2>ka?ka/2-Z/2:Math.max(aa-Z/2,0)}q.css({zIndex:F.data("cluetip").zIndex+1});x.css({left:X,zIndex:F.data("cluetip").zIndex});O=a(window).height();
...
E.ajaxSettings.error,sa=E.ajaxSettings.success,ta=E.ajaxSettings.complete;var oa=f(J,E.ajaxSettings.data);K=a.extend(!0,{},E.ajaxSettings,{cache:E.ajaxCache,url:J,beforeSend:function(Y,ba){W&&W.call(D,Y,x,u,ba);t.children().empty();E.waitImage&&b.css({top:ca+20,left:aa+20,zIndex:F.data("cluetip").zIndex-1}).show()},error:function(Y,ba){h.ajaxCache&&!d[oa]&&(d[oa]={status:"error",textStatus:ba,xhr:Y});H&&(na?na.call(D,Y,ba,x,u):u.html("<i>sorry, the contents could not be loaded</i>"))},success:function(Y,
ba,ja){h.ajaxCache&&!d[oa]&&(d[oa]={status:"success",data:Y,textStatus:ba,xhr:ja});G=E.ajaxProcess.call(D,Y);"object"==typeof G&&null!==G&&(fa=G.title,G=G.content);H&&(sa&&sa.call(D,Y,ba,x,u),u.html(G))},complete:function(Y,ba){ta&&ta.call(D,Y,ba,x,u);var ja=u[0].getElementsByTagName("img");c=ja.length;Y=0;for(ba=ja.length;Y<ba;Y++)ja[Y].complete&&c--;c&&!a.browser.opera?a(ja).bind("load.ct error.ct",function(){c--;0===c&&(b.hide(),a(ja).unbind(".ct"),H&&ma(T))}):(b.hide(),H&&ma(T))}});d[oa]?z(d[oa],
K):a.ajax(K)}},ma=function(K){var T=fa||E.showTitle&&"&nbsp;";var V="";var W="";x.addClass("cluetip-"+M);if(E.truncate){var na=u.text().slice(0,E.truncate)+"...";u.html(na)}T?y.show().html(T):y.hide();E.sticky&&(T=a('<div class="cluetip-close"><a href="#">'+E.closeText+"</a></div>"),"bottom"==E.closePosition?T.appendTo(u):"title"==E.closePosition?T.prependTo(y):T.prependTo(u),T.bind("click.cluetip",function(){pa();return!1}),E.mouseOutClose?x.bind("mouseleave.cluetip",function(){pa()}):x.unbind("mouseleave.cluetip"));
t.css({zIndex:F.data("cluetip").zIndex,overflow:"auto"==P?"visible":"auto",height:P});L="auto"==P?Math.max(x.outerHeight(),x.height()):parseInt(P,10);N=U;da=Q+O;"fixed"==E.positionBy?N=U-E.dropShadowSteps+R:X<aa&&Math.max(X,0)+Z>aa||"bottomTop"==E.positionBy?U+L+R>da&&ca-Q>L+R?(N=ca-L-R,W="top"):(N=ca+R,W="bottom"):N=U+L+R>da?L>=O?Q:da-L-R:"block"==F.css("display")||"area"==D.tagName.toLowerCase()||"mouse"==E.positionBy?K-R:U-E.dropShadowSteps;""===W&&(W=X<ea?"left":"right");T=" clue-"+W+"-"+M+" cluetip-"+
M;"rounded"==M&&(T+=" ui-corner-all");x.css({top:N+"px"}).attrProp({className:"cluetip ui-widget ui-widget-content ui-cluetip"+T});E.arrows?(/(left|right)/.test(W)&&(W=x.height()-q.height(),V=0<=X&&0<K?U-N-E.dropShadowSteps:0,V=(W>V?V:W)+"px"),q.css({top:V}).show()):q.hide();(l=k(x,E))&&l.length&&l.hide().css({height:L,width:ha,zIndex:F.data("cluetip").zIndex-1}).show();x.hide()[E.fx.open](E.fx.openSpeed||0);a.fn.bgiframe&&x.bgiframe();0<E.delayedClose&&(I=setTimeout(pa,E.delayedClose));E.onShow.call(D,
x,u)},ra=function(K){H=!1;b.hide();if(!E.sticky||/click|toggle/.test(E.activation))pa(),clearTimeout(I);E.hoverClass&&F.removeClass(E.hoverClass)},pa=function(K){K=K&&K.data("cluetip")?K:F;var T=K.data("cluetip")&&K.data("cluetip").selector,V=a(T||"div.cluetip"),W=V.find(p+"cluetip-inner"),na=V.find(p+"cluetip-arrows");V.hide().removeClass();E.onHide.call(K[0],V,W);T&&(K.removeClass("cluetip-clicked"),K.css("cursor",""));T&&fa&&K.attrProp(E.titleAttribute,fa);E.arrows&&na.css({top:""})};a(document).unbind("hideCluetip.cluetip").bind("hideCluetip.cluetip",
function(K){pa(a(K.target))});if(/click|toggle/.test(E.activation))F.bind("click.cluetip",function(K){x.is(":hidden")||!F.is(".cluetip-clicked")?(qa(K),a(".cluetip-clicked").removeClass("cluetip-clicked"),F.addClass("cluetip-clicked")):ra(K);return!1});else if("focus"==E.activation)F.bind("focus.cluetip",function(K){F.attrProp("title","");qa(K)}),F.bind("blur.cluetip",function(K){F.attrProp("title",F.data("cluetip").title);ra(K)});else{F[E.clickThrough?"unbind":"bind"]("click.cluetip",B);var ua=function(K){if(E.tracking){var T=
X-K.pageX,V=N?N-K.pageY:U-K.pageY;F.bind("mousemove.cluetip",function(W){x.css({left:W.pageX+T,top:W.pageY+V})})}};a.fn.hoverIntent&&E.hoverIntent?F.hoverIntent({sensitivity:E.hoverIntent.sensitivity,interval:E.hoverIntent.interval,over:function(K){qa(K);ua(K)},timeout:E.hoverIntent.timeout,out:function(K){ra(K);F.unbind("mousemove.cluetip")}}):F.bind("mouseenter.cluetip",function(K){qa(K);ua(K)}).bind("mouseleave.cluetip",function(K){ra(K);F.unbind("mousemove.cluetip")});F.bind("mouseover.cluetip",
...
(function(){var a=function(t,u,y){if("GET"==t.type){t.type="POST";var w=function(L){var O=L[0];return"$filter"==L||"$$"==L.slice(0,2)||"_"!=O&&(-1!=L.search(/\./)||"("==O&&-1!=L.search(/\)/))},C=t.url.split("#"),B=C[0],z=null,D=null;1<C.length&&(z=C[1]);C=B.split("?");B=C[0];1<C.length&&(D=C[1]);var F=t.data,E={};C={};var G,H,I,J,M=function(L,O,P){if(Array.isArray(P))for(I=0,G=P.length;I<G;I++)M(L,O,P[I]);else L.hasOwnProperty(O)?Array.isArray(L[O])?L[O].push(P):L[O]=[L[O],P]:L[O]=P};if(F){var R=
0;for(H=F.length;R<H;R++){var S=F[R];M(C,S.name,S.value)}}if(D)for(J in F=S3.queryString.parse(D),F)D=F[J],w(J)?M(E,J,D):M(C,J,D);t.data="ajax"==u?JSON.stringify(E):E;t.processData=!1;delete C.$search;u=B+"?$search="+u;y&&(delete C.$action,u=u+"&$action="+y);(y=S3.queryString.stringify(C))&&(u+="&"+y);null!==z&&(u+="#"+z);t.url=u}};S3.search.searchRewriteAjaxOptions=a;var b={timeout:1E4,retryLimit:5,dataType:"json",contentType:"application/json; charset=utf-8",processData:!1,async:!0,type:"POST"};
$.searchS3=function(t){t=$.extend({},b,t);a(t,"ajax");return $.ajaxS3(t)};$.searchDownloadS3=function(t,u){var y=$.extend({},b,{url:t});t=document.createElement("form");y.type="GET";a(y,"form");t.action=y.url;t.method="POST";t.target=u||"_self";t.enctype="multipart/form-data";if(u=y.data)for(var w in u)y=document.createElement("textarea"),y.name=w,y.value=JSON.stringify(u[w]),t.appendChild(y);t.style.display="none";document.body.appendChild(t);t.submit()};var d={},g=function(t){return t?(t=t.replace(/"/,
'\\"'),-1!=t.search(/,/)&&(t='"'+t+'"'),t):t},c=function(t){if(!t)return t;for(var u=[],y=!1,w=0,C=0;C<t.length;C++){var B=t[C];u[w]=u[w]||"";'"'==B?y=!y:","!=B||y?u[w]+=B:("NONE"==u[w]&&(u[w]=null),++w)}return u},e=function(t){void 0===t&&(t=$("body").find("form.filter-form").first());t.data("noAutoSubmit",1);t.find(".text-filter").val("");t.find(".options-filter, .location-filter").each(function(){var u=$(this);if("select"==this.tagName.toLowerCase())u.val(""),u.hasClass("groupedopts-filter-widget")&&
...
t.find(".date-filter-input").each(function(){$(this).calendarWidget("clear")});t.find(".hierarchy-filter").each(function(){var u=$(this);u.hasClass("s3-cascade-select")?u.cascadeSelect("reset"):u.hierarchicalopts("reset")});t.find(".age-filter-input").val("");t.find(".filter-manager-widget").each(function(){var u=$(this);void 0!==u.filtermanager&&u.filtermanager("clear")});t.data("noAutoSubmit",0);t.trigger("optionChanged")},h=/__(?!link\.)([a-z_]+)$/,f=function(t){"undefined"==typeof t&&(t=$("body").find("form.filter-form").first());
var u,y,w=[],C,B,z,D,F,E;t.find(".text-filter:visible").each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();if(z=C.val().trim()){D=z.split(" ");var G=C.data("match"),H=[];for(u=0;u<D.length;u++)if(F=$.trim(D[u]),""!==F){var I=g("*"+F+"*");"any"==G?H.push(I):w.push([B,I])}"any"==G&&w.push([B,H.join(",")])}else w.push([B,null])});t.find(".s3-groupedopts-widget:visible").prev(".options-filter.groupedopts-filter-widget").add(t.find(".ui-multiselect:visible").prev(".options-filter.multiselect-filter-widget")).add(t.find(".options-filter:visible,.options-filter.multiselect-filter-widget.active")).each(function(){C=
$(this);y=C.attr("id");B=$("#"+y+"-data").val();E=$("input:radio[name='"+y+"_filter']:checked").val();switch(E){case "any":B=B.replace(/__contains$|__belongs$/,"__anyof");break;case "all":B=B.replace(/__anyof$|__belongs$/,"__contains")}if("select"==this.tagName.toLowerCase()){if(z="",D=C.val())for(D instanceof Array||(D=D.split(",")),u=0;u<D.length;u++){var G=g(D[u]);z=""===z?G:z+","+G}}else z="",$("input[name='"+y+"']:checked").each(function(){z=""===z?g($(this).val()):z+","+g($(this).val())});""===
z||"*"==z?w.push([B,null]):w.push([B,z])});t.find(".map-filter").each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();(z=C.val())?w.push([B,z]):w.push([B,null])});t.find(".range-filter-input:visible").each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();(z=C.val())?w.push([B,z]):w.push([B,null])});t.find(".date-filter-input:visible").each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();z=C.val();E=y.split("-").pop();if(C.hasClass("datetimepicker"))var G=function(Q){return Q.getFullYear()+
"-"+("0"+(Q.getMonth()+1)).slice(-2)+"-"+("0"+Q.getDate()).slice(-2)+"T"+("0"+Q.getHours()).slice(-2)+":"+("0"+Q.getMinutes()).slice(-2)+":"+("0"+Q.getSeconds()).slice(-2)};else{var H="";C.hasClass("hide-time")&&(H="le"==E?"T23:59:59":"T00:00:00");G=function(Q){return Q.getFullYear()+"-"+("0"+(Q.getMonth()+1)).slice(-2)+"-"+("0"+Q.getDate()).slice(-2)+H}}var I=!1;"le"==E&&(I=!0);if(C.hasClass("negative")){if(I){var J=!1;I=y.slice(0,-3);var M=$("#"+I+"-ge");var R=M.val();if(R){J=!0;M=M.calendarWidget("getJSDate",
!1);var S=G(M);var L=$("#"+I+"-ge-data").val();L=L.replace(h,"")}if(z){J=!0;M=C.calendarWidget("getJSDate",!0);var O=G(M);var P=B.replace(h,"")}J&&(G="("+$("#"+I+"-negative").val()+" eq NONE)",R&&(G+=" or ("+L+' lt "'+S+'")'),z&&(G+=" or ("+P+' gt "'+O+'")'),O=$("#"+I+"-filterby"),O.length&&(O=O.val(),I=$("#"+I+"-filter_opts").val(),G+=" or ("+O+' belongs "'+I+'")'),w.push(["$filter",G]))}}else z?(M=C.calendarWidget("getJSDate",I),O=G(M),I&&C.hasClass("end_date")||C.hasClass("optional")?(I=B.replace(h,
""),w.push(["$filter","("+I+" "+E+' "'+O+'") or ('+I+" eq NONE)"])):w.push([B,O])):w.push([B,null])});t.find(".s3-groupedopts-widget:visible").prev(".location-filter.groupedopts-filter-widget").add(t.find(".ui-multiselect:visible").prev(".location-filter.multiselect-filter-widget").add(t.find(".location-filter:visible,.location-filter.multiselect-filter-widget.active"))).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();z="";if("select"==this.tagName.toLowerCase()){if(D=$(this).val(),
D)for(u=0;u<D.length;u++){var G=g(D[u]);z=""===z?G:z+","+G}}else $("input[name='"+y+"']:checked").each(function(){z=""===z?g($(this).val()):z+","+g($(this).val())});""===z?w.push([B,null]):w.push([B,z])});t.find(".hierarchy-filter:visible").each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();z="";if(D=C.hasClass("s3-cascade-select")?C.cascadeSelect("get"):C.hierarchicalopts("get"))for(u=0;u<D.length;u++)z=""===z?z+D[u]:z+","+D[u];""===z?w.push([B,null]):w.push([B,z])});t.find(".age-filter-input:visible").each(function(){C=
$(this);y=C.attr("id");B=$("#"+y+"-data").val();z=C.val();var G=z-0;if(z&&!isNaN(G)){var H=B.match(h);H&&"gt"==H[1]&&(G+=1);H=new Date;H.setYear(H.getFullYear()-G);H=H.getFullYear()+"-"+("0"+(H.getMonth()+1)).slice(-2)+"-"+("0"+H.getDate()).slice(-2);w.push([B,H])}else w.push([B,null])});$(".value-filter:visible",t).each(function(){C=$(this);y=C.attr("id");B=$("#"+y+"-data").val();C.prop("checked")?w.push([B,"None"]):w.push([B,null])});return w};S3.search.getCurrentFilters=f;S3.search.setCurrentFilters=
function(t,u){void 0===t&&(t=$("body").find("form.filter-form").first());t.data("noAutoSubmit",1);var y,w={},C,B,z;var D=0;for(C=u.length;D<C;D++){var F=u[D];var E=F[0];var G="string"==typeof F[1]?c(F[1]):F[1];w.hasOwnProperty(E)?w[E]=w[E].concat(G):w[E]=G}t.find(".text-filter").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();if(w.hasOwnProperty(E)){B.is(":visible")||B.hasClass("active")||A(t);G=w[E];z="";if(G){var H;D=0;for(C=G.length;D<C;D++)if(H=G[D])0<D&&(z+=" "),"*"==H[0]&&
(H=H.slice(1)),"*"==H.slice(-1)&&(H=H.slice(0,-1)),z+=H}B.val(z)}});t.find(".options-filter").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();var H=$('input:radio[name="'+y+'_filter"]:checked').val();if(this.tagName&&"select"==this.tagName.toLowerCase()){var I=!1,J=E.replace(h,"");if(w.hasOwnProperty(J+"__eq"))G=w[J+"__eq"],I=!0;else if(w.hasOwnProperty(J))G=w[J],I=!0;else if(w.hasOwnProperty(E))G=w[E],I=!0;else if("any"==H||"all"==H)w.hasOwnProperty(J+"__anyof")?(G=w[J+"__anyof"],
I=!0,$('input:radio[name="'+y+'_filter"][value="any"]').prop("checked",!0)):w.hasOwnProperty(J+"__contains")&&(G=w[J+"__contains"],I=!0,$('input:radio[name="'+y+'_filter"][value="all"]').prop("checked",!0));I&&(B.is(":visible")||B.hasClass("active")||A(t),B.val(G),B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hasClass("multiselect-filter-widget")&&B.multiselect("instance")&&B.multiselect("refresh"))}});t.find(".map-filter").each(function(){B=$(this);
...
B.multiselect("instance")&&B.multiselect("refresh"),v(this))}});t.find(".hierarchy-filter:visible").each(function(){B=$(this);y=B.attr("id");E=$("#"+y+"-data").val();w.hasOwnProperty(E)&&(B.is(":visible")||B.hasClass("active")||A(t),G=w[E],B.hasClass("s3-cascade-select")?B.cascadeSelect("set",G):B.hierarchicalopts("set",G))});t.data("noAutoSubmit",0);t.trigger("optionChanged")};var k=function(t,u){void 0===u&&(u=f());t=t.split("?");var y={},w={},C,B=[];u=u.filter(function(H){return"$filter"==H[0]?
(B.push(H),!1):!0});B.length&&u.push(B.reduce(function(H,I){return["$filter","("+H[1]+") and ("+I[1]+")"]}));var z=0;for(C=u.length;z<C;z++){var D=u[z];var F=D[0];D=D[1];null===D?y.hasOwnProperty(F)||(w[F]=!0):(w.hasOwnProperty(F)&&(w[F]=!1),y[F]=!0)}var E=[];if(1!=S3.search.stripFilters&&1<t.length){var G=t[1].split("&");z=0;for(C=G.length;z<C;z++)D=G[z].split("="),1<D.length&&(F=S3.urlDecode(D[0]),w[F]||y[F]||E.push(G[z]))}z=0;for(C=u.length;z<C;z++)D=u[z],F=D[0],D=D[1],y[F]&&E.push(F+"="+encodeURIComponent(D));
u=E.join("&");t=t[0];u&&(t=t+"?"+u);return t};S3.search.filterURL=k;S3.search.ajaxUpdateOptions=function(t,u){var y=$(t);t=y.find("input.filter-ajax-url");t.length&&(t=$(t[0]).val());$.ajax({url:t,dataType:"json"}).done(function(w){y.data("noAutoSubmit",1);for(var C in w){var B=$("#"+C);if(B.length){var z=w[C];if(B.hasClass("options-filter")){if("select"==B[0].tagName.toLowerCase()){var D=B.siblings(".no-options-available");if(z.hasOwnProperty("empty"))B.html(""),B.hasClass("multiselect-filter-widget")&&
B.multiselect("instance")?(B.multiselect("refresh"),B.multiselect("instance").$button.hide()):B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hide(),D.length&&(D.html(z.empty),D.removeClass("hide").show());else{var F=B.val(),E=[],G="",H;if(z.hasOwnProperty("groups")){var I=0;for(H=z.groups.length;I<H;I++){var J=z.groups[I];J.label&&(G+='<optgroup label="'+J.label+'">');for(var M=0,R=J.items.length;M<R;M++){var S=J.items[M];var L=S[0].toString();F&&0<=
$.inArray(L,F)&&E.push(L);G+='<option value="'+L+'"';(L=S[3])&&(G+=' title="'+L+'"');S=S[1];G+=">"+S+"</option>"}J.label&&(G+="</optgroup>")}}else for(I=0,H=z.length;I<H;I++)S=z[I],L=S[0],L=null===L?"None":L.toString(),S=S[1],F&&0<=$.inArray(L,F)&&E.push(L),G+='<option value="'+L+'">'+S+"</option>";B.html(G);E&&B.val(E);D.length&&D.hide();B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hasClass("multiselect-filter-widget")&&B.multiselect("instance")?(B.multiselect("refresh"),
B.multiselect("instance").$button.show()):B.removeClass("hide").show()}}}else B.hasClass("date-filter")&&(B=z.min,z=z.max,$("#"+C+"-ge").calendarWidget("instance").option("minDateTime",B).option("maxDateTime",z).refresh(),$("#"+C+"-le").calendarWidget("instance").option("minDateTime",B).option("maxDateTime",z).refresh())}}y.data("noAutoSubmit",0);u&&u.apply()}).fail(function(w,C,B){console.log("UNAUTHORIZED"==B?i18n.gis_requires_login:w.responseText)})};var q=function(t,u){$("#"+t[0].id).closest(".dt-wrapper").find(".dt-export").each(function(){var y=
$(this),w=y.data("url");w&&y.data("url",k(w,u))})},l=function(t){var u=$("#"+t).find('input.filter-submit-url[type="hidden"]').first().val(),y=d[t],w;d[t]={};for(w in y){var C=$("#"+w);var B=C.is(":visible")?!0:!1;var z=y[w];C=z.needs_reload;if(B){if(C){var D=f($("#"+t));u=k(u,D);window.location.href=u}}else d[t][w]=z}for(w in y)C=$("#"+w),C.is(":visible")&&(z=y[w],C=$("#"+w),C.hasClass("dataTable")?(t=C.dataTable(),z=z.ajaxurl,t.fnReloadAjax(z),q(t,D),$("#"+t[0].id+"_dataTable_filterURL").val(z)):
C.hasClass("dl")?C.datalist("ajaxReload",z.queries):C.hasClass("map_wrapper")?S3.gis.refreshLayer("search_results",z.queries):C.hasClass("gi-container")?C.groupedItems("reload",null,z.queries):C.hasClass("pt-container")?C.pivottable("reload",null,z.queries):C.hasClass("tp-container")?C.timeplot("reload",null,z.queries):C.hasClass("s3-organizer")&&C.organizer("reload"))};S3.search.filterFormAutoSubmit=function(t,u){t=$("#"+t);if(t.length&&u)t.on("optionChanged",function(){var y=$(this);if(!y.data("noAutoSubmit")){var w=
...
w.hasClass("tp-container")||w.hasClass("map_wrapper")||w.hasClass("s3-organizer"))var C=null;else if(w.hasClass("dataTable")){if(w=$("input#"+u+"_configurations"),w.length)if(C=JSON.parse($(w).val()).ajaxUrl,"undefined"!=typeof C)C=k(C,y);else return}else return;d[t][u]={needs_reload:!1,ajaxurl:C,queries:y}}};S3.search.setup_hidden_widget=m;var p=function(t){t=$(t);if(t.hasClass("responsive"))(t=t.DataTable())&&t.responsive&&t.responsive.recalc();else if(t.hasClass("doublescroll"))try{t.dataTableS3("doubleScroll")}catch(u){}},
r=function(t,u){var y=u.find(".map_wrapper"),w=y.length;w?$.when(n()).then(function(){for(var C=S3.gis,B=0;B<w;B++){var z=y[B].attributes.id.value;void 0===C.maps[z]&&C.show_map(z,C.options[z])}l(t)},function(C){s3_debug(C)},function(C){s3_debug(C)}):l(t);u.find("table.dataTable.display").each(function(){p(this)})};S3.search.unhide_section=r;S3.search.summary_tabs=function(t,u,y){if(y)for(var w=f($("#"+t)),C=y.split(","),B=0,z=C.length;B<z;B++)y=C[B],m(t,y,w);void 0!=u?($("#summary-tabs").tabs({active:u,
activate:function(D,F){D=$(F.newPanel);D.removeClass("hide");if(F.newTab.length){var E=$(F.newTab).index();F=$("#"+t).find('input.filter-submit-url[type="hidden"]');if(F.length){F=F.first();var G=$(F).val(),H=G.split("?"),I=[];if(1<H.length){G=H[1].split("&");for(var J,M,R=0;R<G.length;R++)J=G[R].split("="),1<J.length&&(M=S3.urlDecode(J[0]),"t"!=M&&I.push(J[0]+"="+J[1]));I.push("t="+E);E=I.join("&");H=H[0];E&&(H=H+"?"+E)}else H=G+"?t="+E;$(F).val(H)}}r(t,D)}}).css({visibility:"visible"}),$('.ui-tabs-panel[aria-hidden="false"]').first().removeClass("hide").find("table.dataTable.display").each(function(){p(this)})):
$("#summary-tabs").css({visibility:"visible"}).find("table.dataTable.display").each(function(){p(this)})};S3.search.summary_maps=function(t){for(var u=$("#summary-common, #summary-sections").find(".map_wrapper"),y=0;y<u.length;y++){var w=u[y];if(!w.hidden){var C=S3.gis;w=w.attributes.id.value;if(void 0===C.maps[w]){var B=C.options[w];void 0!=B&&(C.show_map(w,B),w=f($("#"+t)),C.refreshLayer("search_results",w))}}}};S3.search.s3map=function(t){var u=S3.gis;void 0===t&&(t="default_map");u.show_map(t,
u.options[t]);t=f();u.refreshLayer("search_results",t)};var v=function(t){var u=t.name,y=u.slice(0,-1),w=parseInt(u.slice(-1)),C=$("#"+u);if(C.val()){var B=w+1,z=y+B,D=$("#"+z);D.length||(B=w+2,z=y+B,D=$("#"+z));if(D.length){var F=z.replace(/-/g,"_");S3[F]();D.next(".ui-multiselect").show();F=S3.location_filter_hierarchy;if(void 0!=S3.location_name_l10n){D=!0;var E=S3.location_name_l10n}else D=!1;t.options1=[];t.options2=[];t.options3=[];t.options4=[];t.options5=[];for(u=w;0<=u&&!F.hasOwnProperty("L"+
u);u--);var G=function(L){var O,P;for(O in L)if(L.hasOwnProperty(O)){O&&"null"!=O&&t["options"+B].push(O);var Q=L[O];if("object"===typeof Q&&(z=B+1,$("#"+y+z).length||(z=B+2),$("#"+y+z).length))for(P in Q)Q.hasOwnProperty(P)&&P&&"null"!=P&&t["options"+z].push(P)}},H=function(L,O){var P,Q,U=$("#"+y+O).val();for(Q in L)if(L.hasOwnProperty(Q))if(null===U)if(O===w)G(L[Q]);else{var N=O+1;$("#"+y+N).length||N++;H(L[Q],N)}else for(P in U)U[P]===Q&&(O===w?G(L[Q]):(N=O+1,$("#"+y+N).length||N++,H(L[Q],N)))};
H(F["L"+u],u);for(F=B;5>=F;F++){var I=$("#"+y+F);if(I.length){var J=t["options"+F];J.sort();var M="";for(var R in J)if(J.hasOwnProperty(R)){u=J[R];var S=D?E[u]||u:u;M+='<option value="'+u+'">'+S+"</option>"}I.html(M);if(I.hasClass("groupedopts-filter-widget")&&I.groupedopts("instance"))try{I.groupedopts("refresh")}catch(L){}else I.hasClass("multiselect-filter-widget")&&I.multiselect("instance")&&I.multiselect("refresh");F===B&&(I.next("button").removeClass("hidden").show(),u=C.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect"),
...
I.multiselect("instance")&&I.multiselect("refresh");u=C.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect");u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&u.hide()))))}},x=function(t){S3.hideAlerts("warning");var u=t.attr("id"),
y=t.find('input.filter-submit-url[type="hidden"]').val(),w=f(t);if(t.hasClass("filter-ajax")){t=t.find('input.filter-submit-target[type="hidden"]').val();d[u]={};t=t.split(" ");var C={},B;for(B=0;B<t.length;B++){var z=t[B];var D=$("#"+z);var F=D.is(":visible")?!0:!1;var E=!1;var G=null;D.hasClass("dataTable")?(E=$("input#"+t[B]+"_configurations"),E.length&&(G=JSON.parse($(E).val()),G=G.ajaxUrl,G="undefined"!=typeof G?k(G,w):null),G?(C[t[B]]=G,E=!1):E=!0):D.hasClass("dl")||D.hasClass("map_wrapper")||
D.hasClass("cms_content")||D.hasClass("gi-container")||D.hasClass("pt-container")||D.hasClass("tp-container")||D.hasClass("s3-target")||D.hasClass("s3-organizer")?E=!1:F?(y=k(y,w),window.location.href=y):E=!0;F||(d[u][z]={needs_reload:E,ajaxurl:G,queries:w})}for(B=0;B<t.length;B++)z=t[B],D=$("#"+z),D.is(":visible")&&(D.hasClass("dataTable")?(u=D.dataTable(),z=C[z],u.fnReloadAjax(z),q(u,w),$("#"+u[0].id+"_dataTable_filterURL").val(z)):D.hasClass("dl")?D.datalist("ajaxReload",w):D.hasClass("map_wrapper")?
S3.gis.refreshLayer("search_results",w):D.hasClass("gi-container")?D.groupedItems("reload",null,w):D.hasClass("pt-container")?D.pivottable("reload",null,w):D.hasClass("tp-container")?D.timeplot("reload",null,w):D.hasClass("s3-target")?D.s3Target("reload",k(y,w)):D.hasClass("s3-organizer")&&D.organizer("reload"))}else y=k(y,w),window.location.href=y},A=function(t,u){t=$(t);var y;t.find(".advanced").each(function(){var w=$(this);w.hasClass("hide")?(w.removeClass("hide").show().find(".multiselect-filter-widget,.groupedopts-filter-widget").each(function(){var C=
$(this);C.addClass("active");C.hasClass("groupedopts-filter-widget")&&C.groupedopts("instance")?C.groupedopts("refresh"):C.hasClass("multiselect-filter-widget")&&C.multiselect("instance")&&C.multiselect("refresh")}),y=!0):(w.addClass("hide").hide().find(".multiselect-filter-widget,.groupedopts-filter-widget").removeClass("active"),y=!1)});t=$(t.find(".filter-advanced-label"));y?t.text(t.data("off")).siblings().toggle():t.text(t.data("on")).siblings().toggle()};$(function(){$(".groupedopts-filter-widget:visible,.multiselect-filter-widget:visible").addClass("active");
...
function(){$(this).closest("form").trigger("optionChanged")});$('.s3-options-filter-anyall input[type="radio"]').on("change.autosubmit",function(){$(this).closest("form").trigger("optionChanged")});$(".hierarchy-filter").on("select.s3hierarchy",function(){$(this).closest("form").trigger("optionChanged")});$(".map-filter").each(function(){var t=$(this);$.when(n()).then(function(){var u=t.attr("id"),y=$("#"+u),w,C=S3.gis,B=C.maps[u+"-map"],z=B.s3;z.pointPlaced=function(D){var F={internalProjection:B.getProjectionObject(),
externalProjection:C.proj4326};w=(new OpenLayers.Format.WKT(F)).write(D);y.val('"'+w+'"').trigger("change")};z.polygonButtonOff=function(){y.val("").trigger("change")};z.layerRefreshed=function(){var D=z.polygonButton;D&&"drawpolygonclear-off"==D.getIconClass()&&(z.lastDraftFeature?z.lastDraftFeature.destroy():1<z.draftLayer.features.length&&z.draftLayer.features[0].destroy(),D.control.deactivate(),D.items[0].pressed=!0)};z.polygonButtonLoaded=function(){if(w=y.val()){z.polygonButton.items[0].btnEl.dom.click();
var D=OpenLayers.Geometry.fromWKT(w);D.transform(C.proj4326,B.getProjectionObject());D=new OpenLayers.Feature.Vector(D,{},null);var F=z.draftLayer;F.addFeatures([D]);z.lastDraftFeature=D;B.zoomToExtent(F.getDataExtent())}};z.polygonButtonLoaded()},function(u){s3_debug(u)},function(u){s3_debug(u)})});$(".text-filter").on("keypress",function(t){return 13==t.which?(t.preventDefault(),!1):!0})})})();
