...
$(function(){$(".inline-component").inlinecomponent(S3.inlineComponentsOpts||{})});
...
var y={},w={},C,B=[];u=u.filter(function(H){return"$filter"==H[0]?(B.push(H),!1):!0});B.length&&u.push(B.reduce(function(H,I){return["$filter","("+H[1]+") and ("+I[1]+")"]}));var z=0;for(C=u.length;z<C;z++){var D=u[z];var F=D[0];D=D[1];null===D?y.hasOwnProperty(F)||(w[F]=!0):(w.hasOwnProperty(F)&&(w[F]=!1),y[F]=!0)}var E=[];if(1!=S3.search.stripFilters&&1<t.length){var G=t[1].split("&");z=0;for(C=G.length;z<C;z++)D=G[z].split("="),1<D.length&&(F=S3.urlDecode(D[0]),w[F]||y[F]||E.push(G[z]))}z=0;for(C=
u.length;z<C;z++)D=u[z],F=D[0],D=D[1],y[F]&&E.push(F+"="+encodeURIComponent(D));u=E.join("&");t=t[0];u&&(t=t+"?"+u);return t};S3.search.filterURL=k;S3.search.ajaxUpdateOptions=function(t,u){var y=$(t);t=y.find("input.filter-ajax-url");t.length&&(t=$(t[0]).val());$.ajax({url:t,dataType:"json"}).done(function(w){y.data("noAutoSubmit",1);for(var C in w){var B=$("#"+C);if(B.length){var z=w[C];if(B.hasClass("options-filter")){if("select"==B[0].tagName.toLowerCase()){var D=B.siblings(".no-options-available");
if(z.hasOwnProperty("empty"))B.html(""),B.hasClass("multiselect-filter-widget")&&B.multiselect("instance")?(B.multiselect("refresh"),B.multiselect("instance").$button.hide()):B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):B.hide(),D.length&&(D.html(z.empty),D.removeClass("hide").show());else{var F=B.val(),E=[],G="",H;if(z.hasOwnProperty("groups")){var I=0;for(H=z.groups.length;I<H;I++){var J=z.groups[I];J.label&&(G+='<optgroup label="'+J.label+'">');for(var M=
0,R=J.items.length;M<R;M++){var S=J.items[M];var L=S[0].toString();F&&0<=$.inArray(L,F)&&E.push(L);G+='<option value="'+L+'"';(L=S[3])&&(G+=' title="'+L+'"');S=S[1];G+=">"+S+"</option>"}J.label&&(G+="</optgroup>")}}else for(I=0,H=z.length;I<H;I++)S=z[I],L=S[0],L=null===L?"None":L.toString(),S=S[1],F&&0<=$.inArray(L,F)&&E.push(L),G+='<option value="'+L+'">'+S+"</option>";B.html(G);E&&B.val(E);D.length&&D.hide();B.hasClass("groupedopts-filter-widget")&&B.groupedopts("instance")?B.groupedopts("refresh"):
B.hasClass("multiselect-filter-widget")&&B.multiselect("instance")?(B.multiselect("refresh"),B.multiselect("instance").$button.show()):B.removeClass("hide").show()}}}else B.hasClass("date-filter")&&(B=z.min,z=z.max,$("#"+C+"-ge").calendarWidget("instance").option("minDateTime",B).option("maxDateTime",z).refresh(),$("#"+C+"-le").calendarWidget("instance").option("minDateTime",B).option("maxDateTime",z).refresh())}}y.data("noAutoSubmit",0);u&&u.apply()}).fail(function(w,C,B){console.log("UNAUTHORIZED"==
B?i18n.gis_requires_login:w.responseText)})};var q=function(t,u){$("#"+t[0].id).closest(".dt-wrapper").find(".dt-export").each(function(){var y=$(this),w=y.data("url");w&&y.data("url",k(w,u))})},l=function(t){var u=$("#"+t).find('input.filter-submit-url[type="hidden"]').first().val(),y=d[t],w;d[t]={};for(w in y){var C=$("#"+w);var B=C.is(":visible")?!0:!1;var z=y[w];C=z.needs_reload;if(B){if(C){var D=f($("#"+t));u=k(u,D);window.location.href=u}}else d[t][w]=z}for(w in y)C=$("#"+w),C.is(":visible")&&
(z=y[w],C=$("#"+w),C.hasClass("dataTable")?(t=C.dataTable(),z=z.ajaxurl,t.fnReloadAjax(z),q(t,D),$("#"+t[0].id+"_dataTable_filterURL").val(z)):C.hasClass("dl")?C.datalist("ajaxReload",z.queries):C.hasClass("map_wrapper")?S3.gis.refreshLayer("search_results",z.queries):C.hasClass("gi-container")?C.groupedItems("reload",null,z.queries):C.hasClass("pt-container")?C.pivottable("reload",null,z.queries):C.hasClass("tp-container")?C.timeplot("reload",null,z.queries):C.hasClass("s3-organizer")&&C.organizer("reload"))};
S3.search.filterFormAutoSubmit=function(t,u){t=$("#"+t);if(t.length&&u)t.on("optionChanged",function(){var y=$(this);if(!y.data("noAutoSubmit")){var w=y.data("autoSubmitTimeout");w&&clearTimeout(w);w=setTimeout(function(){x(y)},u);y.data("autoSubmitTimeout",w)}})};var n=function(){var t=new jQuery.Deferred;setTimeout(function y(){void 0!=S3.gis.maps?t.resolve("loaded"):"pending"===t.state()&&(t.notify("waiting for JS to load..."),setTimeout(y,500))},1);return t.promise()},m=function(t,u,y){void 0===
y&&(y=f($("#"+t)));d.hasOwnProperty(t)||(d[t]={});if(!d[t].hasOwnProperty(u)){var w=$("#"+u);if(w.hasClass("dl")||w.hasClass("gi-container")||w.hasClass("pt-container")||w.hasClass("tp-container")||w.hasClass("map_wrapper")||w.hasClass("s3-organizer"))var C=null;else if(w.hasClass("dataTable")){if(w=$("input#"+u+"_configurations"),w.length)if(C=JSON.parse($(w).val()).ajaxUrl,"undefined"!=typeof C)C=k(C,y);else return}else return;d[t][u]={needs_reload:!1,ajaxurl:C,queries:y}}};S3.search.setup_hidden_widget=
m;var p=function(t){t=$(t);if(t.hasClass("responsive"))(t=t.DataTable())&&t.responsive&&t.responsive.recalc();else if(t.hasClass("doublescroll"))try{t.dataTableS3("doubleScroll")}catch(u){}},r=function(t,u){var y=u.find(".map_wrapper"),w=y.length;w?$.when(n()).then(function(){for(var C=S3.gis,B=0;B<w;B++){var z=y[B].attributes.id.value;void 0===C.maps[z]&&C.show_map(z,C.options[z])}l(t)},function(C){s3_debug(C)},function(C){s3_debug(C)}):l(t);u.find("table.dataTable.display").each(function(){p(this)})};
S3.search.unhide_section=r;S3.search.summary_tabs=function(t,u,y){if(y)for(var w=f($("#"+t)),C=y.split(","),B=0,z=C.length;B<z;B++)y=C[B],m(t,y,w);void 0!=u?($("#summary-tabs").tabs({active:u,activate:function(D,F){D=$(F.newPanel);D.removeClass("hide");if(F.newTab.length){var E=$(F.newTab).index();F=$("#"+t).find('input.filter-submit-url[type="hidden"]');if(F.length){F=F.first();var G=$(F).val(),H=G.split("?"),I=[];if(1<H.length){G=H[1].split("&");for(var J,M,R=0;R<G.length;R++)J=G[R].split("="),
...
y=0;y<u.length;y++){var w=u[y];if(!w.hidden){var C=S3.gis;w=w.attributes.id.value;if(void 0===C.maps[w]){var B=C.options[w];void 0!=B&&(C.show_map(w,B),w=f($("#"+t)),C.refreshLayer("search_results",w))}}}};S3.search.s3map=function(t){var u=S3.gis;void 0===t&&(t="default_map");u.show_map(t,u.options[t]);t=f();u.refreshLayer("search_results",t)};var v=function(t){var u=t.name,y=u.slice(0,-1),w=parseInt(u.slice(-1)),C=$("#"+u);if(C.val()){var B=w+1,z=y+B,D=$("#"+z);D.length||(B=w+2,z=y+B,D=$("#"+z));
if(D.length){var F=z.replace(/-/g,"_");S3[F]();D.next(".ui-multiselect").show();F=S3.location_filter_hierarchy;if(void 0!=S3.location_name_l10n){D=!0;var E=S3.location_name_l10n}else D=!1;t.options1=[];t.options2=[];t.options3=[];t.options4=[];t.options5=[];for(u=w;0<=u&&!F.hasOwnProperty("L"+u);u--);var G=function(L){var O,P;for(O in L)if(L.hasOwnProperty(O)){O&&"null"!=O&&t["options"+B].push(O);var Q=L[O];if("object"===typeof Q&&(z=B+1,$("#"+y+z).length||(z=B+2),$("#"+y+z).length))for(P in Q)Q.hasOwnProperty(P)&&
P&&"null"!=P&&t["options"+z].push(P)}},H=function(L,O){var P,Q,U=$("#"+y+O).val();for(Q in L)if(L.hasOwnProperty(Q))if(null===U)if(O===w)G(L[Q]);else{var N=O+1;$("#"+y+N).length||N++;H(L[Q],N)}else for(P in U)U[P]===Q&&(O===w?G(L[Q]):(N=O+1,$("#"+y+N).length||N++,H(L[Q],N)))};H(F["L"+u],u);for(F=B;5>=F;F++){var I=$("#"+y+F);if(I.length){var J=t["options"+F];J.sort();var M="";for(var R in J)if(J.hasOwnProperty(R)){u=J[R];var S=D?E[u]||u:u;M+='<option value="'+u+'">'+S+"</option>"}I.html(M);if(I.hasClass("groupedopts-filter-widget")&&
I.groupedopts("instance"))try{I.groupedopts("refresh")}catch(L){}else I.hasClass("multiselect-filter-widget")&&I.multiselect("instance")&&I.multiselect("refresh");F===B&&(I.next("button").removeClass("hidden").show(),u=C.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect"),u.length&&(u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),
u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&u.hide())))))}}}}else{for(F=w+1;5>=F;F++)if(I=$("#"+y+F),I.length)if(I.html(""),I.hasClass("groupedopts-filter-widget")&&I.groupedopts("instance"))try{I.groupedopts("refresh")}catch(L){}else I.hasClass("multiselect-filter-widget")&&I.multiselect("instance")&&I.multiselect("refresh");u=C.next(".ui-multiselect").next(".location-filter").next(".ui-multiselect");u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),
u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&(u.hide(),u=u.next(".location-filter").next(".ui-multiselect"),u.length&&u.hide()))))}},x=function(t){S3.hideAlerts("warning");var u=t.attr("id"),y=t.find('input.filter-submit-url[type="hidden"]').val(),w=f(t);if(t.hasClass("filter-ajax")){t=t.find('input.filter-submit-target[type="hidden"]').val();d[u]={};t=t.split(" ");var C={},B;for(B=0;B<t.length;B++){var z=
t[B];var D=$("#"+z);var F=D.is(":visible")?!0:!1;var E=!1;var G=null;D.hasClass("dataTable")?(E=$("input#"+t[B]+"_configurations"),E.length&&(G=JSON.parse($(E).val()),G=G.ajaxUrl,G="undefined"!=typeof G?k(G,w):null),G?(C[t[B]]=G,E=!1):E=!0):D.hasClass("dl")||D.hasClass("map_wrapper")||D.hasClass("cms_content")||D.hasClass("gi-container")||D.hasClass("pt-container")||D.hasClass("tp-container")||D.hasClass("s3-target")||D.hasClass("s3-organizer")?E=!1:F?(y=k(y,w),window.location.href=y):E=!0;F||(d[u][z]=
{needs_reload:E,ajaxurl:G,queries:w})}for(B=0;B<t.length;B++)z=t[B],D=$("#"+z),D.is(":visible")&&(D.hasClass("dataTable")?(u=D.dataTable(),z=C[z],u.fnReloadAjax(z),q(u,w),$("#"+u[0].id+"_dataTable_filterURL").val(z)):D.hasClass("dl")?D.datalist("ajaxReload",w):D.hasClass("map_wrapper")?S3.gis.refreshLayer("search_results",w):D.hasClass("gi-container")?D.groupedItems("reload",null,w):D.hasClass("pt-container")?D.pivottable("reload",null,w):D.hasClass("tp-container")?D.timeplot("reload",null,w):D.hasClass("s3-target")?
D.s3Target("reload",k(y,w)):D.hasClass("s3-organizer")&&D.organizer("reload"))}else y=k(y,w),window.location.href=y},A=function(t,u){t=$(t);var y;t.find(".advanced").each(function(){var w=$(this);w.hasClass("hide")?(w.removeClass("hide").show().find(".multiselect-filter-widget,.groupedopts-filter-widget").each(function(){var C=$(this);C.addClass("active");C.hasClass("groupedopts-filter-widget")&&C.groupedopts("instance")?C.groupedopts("refresh"):C.hasClass("multiselect-filter-widget")&&C.multiselect("instance")&&
C.multiselect("refresh")}),y=!0):(w.addClass("hide").hide().find(".multiselect-filter-widget,.groupedopts-filter-widget").removeClass("active"),y=!1)});t=$(t.find(".filter-advanced-label"));y?t.text(t.data("off")).siblings().toggle():t.text(t.data("on")).siblings().toggle()};$(function(){$(".groupedopts-filter-widget:visible,.multiselect-filter-widget:visible").addClass("active");$(".filter-clear").on("click",function(){var t=$(this).closest(".filter-form");e(t)});$(".show-filter-manager").on("click",
function(){$(".filter-manager-row").removeClass("hide").show();$(".show-filter-manager").hide()});$(".filter-submit").on("click",function(){x($(this).closest(".filter-form"))});$(".filter-form").on("dataChanged",function(t,u,y){u&&(t=$(this).find("input.filter-submit-target").val())&&(t=t.split(" "),t.length&&-1!=$.inArray(u+"",t)&&S3.search.ajaxUpdateOptions(this,y));return!1});$(".filter-advanced").on("click",function(){A($(this).closest("form"))});$(".location-filter").on("change",function(){v(this)});
...
function(){$(this).closest("form").trigger("optionChanged")});$(".hierarchy-filter").on("select.s3hierarchy",function(){$(this).closest("form").trigger("optionChanged")});$(".map-filter").each(function(){var t=$(this);$.when(n()).then(function(){var u=t.attr("id"),y=$("#"+u),w,C=S3.gis,B=C.maps[u+"-map"],z=B.s3;z.pointPlaced=function(D){var F={internalProjection:B.getProjectionObject(),externalProjection:C.proj4326};w=(new OpenLayers.Format.WKT(F)).write(D);y.val('"'+w+'"').trigger("change")};z.polygonButtonOff=
function(){y.val("").trigger("change")};z.layerRefreshed=function(){var D=z.polygonButton;D&&"drawpolygonclear-off"==D.getIconClass()&&(z.lastDraftFeature?z.lastDraftFeature.destroy():1<z.draftLayer.features.length&&z.draftLayer.features[0].destroy(),D.control.deactivate(),D.items[0].pressed=!0)};z.polygonButtonLoaded=function(){if(w=y.val()){z.polygonButton.items[0].btnEl.dom.click();var D=OpenLayers.Geometry.fromWKT(w);D.transform(C.proj4326,B.getProjectionObject());D=new OpenLayers.Feature.Vector(D,
{},null);var F=z.draftLayer;F.addFeatures([D]);z.lastDraftFeature=D;B.zoomToExtent(F.getDataExtent())}};z.polygonButtonLoaded()},function(u){s3_debug(u)},function(u){s3_debug(u)})});$(".filter-form").each(function(){f($(this))});$(".text-filter").on("keypress",function(t){return 13==t.which?(t.preventDefault(),!1):!0})})})();
