...
x=e.htmlAllowedFor("options")?"html":"text";x=f.parent().find("span")[x]();v=v.maxSelected;if(this.disabled||!1===e._trigger("click",h,{value:k,text:x,checked:q}))h.preventDefault();else{if(v&&q&&r>v)return!1!==e._trigger("maxselected",h,{labels:e.$labels,inputs:p})&&e.buttonMessage("<center><b>LIMIT OF "+(r-1)+" REACHED!</b></center>"),this.checked=!1,h.preventDefault(),!1;this.focus();f.prop("aria-selected",q);n.each(function(){this.selected=this.value===k?q:m&&this.selected});m||(e.$labels.removeClass("ui-state-active"),
