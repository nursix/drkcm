...
if(a||b)var l=this._updateAjaxURL(a,b);l||c?(a=this.options.ajaxURL,b=this.options.timeout,c=e.ajaxS3,e.searchS3!==K&&(c=e.searchS3),f.find(".pt-empty").hide(),d.openRequest&&(d.openRequest.onreadystatechange=null,d.openRequest.abort()),d.openRequest=c({timeout:b,url:a,dataType:"json",type:"GET",success:function(h){d.openRequest=null;g.first().val(JSON.stringify(h));d.refresh()},error:function(h,k,m){console.log("UNAUTHORIZED"==m?i18n.gis_requires_login:h.responseText)}})):d.refresh()}},_downloadXLS:function(){if(this.element.find('input[type="hidden"][name="pivotdata"]').length){var a=
this._getOptions(),b=this._getFilters();a=this._updateAjaxURL(a,b,!0);a=this._setExtension(a,"xls");e.searchDownloadS3!==K?e.searchDownloadS3(a,"_blank"):window.open(a)}},_bindEvents:function(){var a=this,b=e(this.element),c=this.eventNamespace,d="#"+b.attr("id");e(d+"-options legend").on("click"+c,function(){e(this).siblings().toggle();e(this).children().toggle()});e(d+"-filters legend").on("click"+c,function(){e(this).siblings().toggle();e(this).children().toggle()});e(".pt-hide-table",b).on("click"+
c,function(){a.table_options.hidden=!0;e(".pt-table",b).hide();e(".pt-export-opt",b).hide();e(this).hide().siblings(".pt-show-table").show()});e(".pt-show-table",b).on("click"+c,function(){a.table_options.hidden=!1;e(".pt-table",b).show();e(".pt-export-opt",b).show();e(this).hide().siblings(".pt-hide-table").show()});e(".pt-export-xls",b).on("click"+c,function(){a._downloadXLS()});e(d+"-totals").on("click"+c,function(){var g=e(this).is(":checked");a.options.showTotals!=g&&a.reload({totals:g},null,
