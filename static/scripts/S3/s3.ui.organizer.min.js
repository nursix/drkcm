...
h(".fc-header-toolbar .fc-left",this.element).append(a);this.throbber=a;this.resources=[];b&&b.forEach(function(k,n){this._addResource(k,n)},this);this._bindEvents()},_addResource:function(a,b){let c=h.extend({},a,{_cache:new t});this.resources.push(c);a=c.timeout;a===r&&(a=this.options.timeout);let g=this;this.calendar.addEventSource({id:""+b,allDayDefault:!c.useTime,editable:!!c.editable,startEditable:!!c.startEditable,durationEditable:!!c.end&&!!c.durationEditable,events:function(d,e){g._fetchItems(c,
d,e)}})},_eventRender:function(a){let b=a.el;if(b!==r){var c=this;h(b).qtip({content:{title:function(g,d){return c._itemTitle(a,d)},text:function(g,d){return c._itemDisplay(a,d)},button:!0},position:{at:"center right",my:"left center",effect:!1,viewport:h(window),adjust:{method:"flip shift"}},show:{event:"click",solo:!0},hide:{event:"click mouseleave",delay:800,fixed:!0},events:{visible:function(){S3.addModals()}}})}},_eventDestroy:function(a){(a=a.el)&&h(a).qtip("destroy",!0)},_itemTitle:function(a,
b){b=this.options.locale||"en";a=a.event;var c=a.allDay?"L":"L LT";c=[moment(a.start).locale(b).format(c)];a.end&&(b=moment(a.end).locale(b).endOf("minute"),c.push(b.format("LT")));return c.join(" - ")},_itemDisplay:function(a,b){let c=a.event,g=h('<div class="s3-organizer-popup">'),d=this.options,e=d.resources[c.source.id];h("<h6>").html(c.popupTitle).appendTo(g);var f=e.columns;let l=c.extendedProps.description;f&&l&&f.forEach(function(p){let v=p[0];p=p[1];l[v]!==r&&(p&&h("<label>").text(p).appendTo(g),
