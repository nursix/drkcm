...
this._bindEvents()},_deserialize:function(){try{this.rules=JSON.parse(this.input.val())}catch(a){this.rules=[],this._serialize()}},_serialize:function(){var a=this.rules.filter(function(b){return null!==b[0]&&(0!==b[0]||!b[7])});this.input.val(JSON.stringify(a)).trigger("change")},_ruleSets:function(){var a={_other:[]},b={_other:[]},c=this.options;this.rules.forEach(function(e){var f;if(f=e[3]){var k=b;var h=c.models;f=f.split("_")[0]}else{k=a;h=c.modules;f=e[1];var g=e[2];f="default"!=f||"table"!=
g&&"tables"!=g?f:"default/dt"}h.hasOwnProperty(f)?k[f]===u&&(k[f]=[]):f="_other";k[f].push(e)});return{pages:a,tables:b}},_renderExpandCollapseAll:function(){var a=d('<span class="action-lnk rm-expand-all">'),b=d('<span class="action-lnk rm-collapse-all">');a.text(l.rm_ExpandAll);b.text(l.rm_CollapseAll);return d('<div class="rm-toggle-all">').append(a).append(b)},_ruleTable:function(a,b,c){c||=[];var e=d('<table class="rm-module-rules">').data({module:b});e.append(this._ruleTableHeader(b)).append(this._ruleTableBody(a,
