...
close:function(){e&&(e.stop(),e.destroy(),e=null)}});g.on("click",function(){f.show();k.hide();l.dialog("open");e=new QrScanner(f.get(0),function(m){navigator.vibrate(100);f.hide();k.show();c.val(m).trigger("change"+b.eventNamespace);setTimeout(function(){l.dialog("close")},1E3)},function(){});e.start()})}else g.prop("disabled",!0)});this._bindEvents()},_clearInput:function(){a(this.element).val("").trigger("change"+this.eventNamespace)},_bindEvents:function(){var c=a(this.element),b=this.eventNamespace,
d=this;a(".clear-btn",c.closest(".qrinput")).on("click"+b,function(){d._clearInput()});return!0},_unbindEvents:function(){var c=a(this.element),b=this.eventNamespace;a(".clear-btn",c.closest(".qrinput")).off(b);return!0}})})(jQuery);
