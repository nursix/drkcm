/*
 ...
 @license MIT
*/
(function(b,n){var p=0;b.widget("supply.registerDistribution",{options:{ajaxURL:"",tablename:"supply_distribution",showPicture:!0,showPictureLabel:"Show Picture",hidePictureLabel:"Hide Picture",selectDistributionSetLabel:"Select Distribution Set",noDistributionSetsLabel:"No Distribution Sets Available",distributeLabel:"Distribute",returnLabel:"Return",itemLabel:"Item",quantityLabel:"Quantity",packLabel:"Pack",lossLabel:"Loss",loanLabel:"Loan"},_create:function(){this.id=p;p+=1;this.eventNamespace=
".registerDistribution"},_init:function(){const a=b(this.element),c=a.attr("id"),d="#"+this.options.tablename;this.idPrefix=d;this.orgHeader=b("#"+c+"-org-header");this.orgSelect=b("#"+c+"-org-select");this.distributionSetHeader=b("#"+c+"-distribution-set-header");this.distributionSetSelect=b("#"+c+"-distribution-set-select");this.pictureContainer=b("#"+c+"-picture");this.personRow=b(d+"_person__row",a);this.flagInfoRow=b(d+"_flaginfo__row",a);this.detailsRow=b(d+"_details__row",a);this.personContainer=
b(".controls",this.personRow);this.flagInfoContainer=b(".controls",this.flagInfoRow);this.detailsContainer=b(".controls",this.detailsRow);this.distributionSet=b('input[type="hidden"][name="distset"]',a);this.flagInfo=b("input[type=hidden][name=flags]",a);this.imageURL=b('input[type="hidden"][name="image"]',a);this.actionDetails=b('input[type="hidden"][name="actions"]',a);this.permissionInfo=b("input[type=hidden][name=permitted]",a);this.actionableInfo=b("input[type=hidden][name=actionable]",a);this.submitLabel=
b(".submit-btn",a).first().val();this.profilePicture=null;this.refresh()},_destroy:function(){b.Widget.prototype.destroy.call(this)},refresh:function(){const a=this.options;this._unbindEvents();if(!a.ajaxURL)throw Error("registerDistribution: no ajaxURL provided");this._clearForm();this._updateDistributionSet();this._bindEvents()},_checkID:function(){var a=this.orgHeader,c=b(this.element);const d=this.idPrefix;this._clearForm(!1,!0);var e=b(d+"_label"),g=e.val().trim();a=a.data("selected");e.val(g);
if(g){c=b('input[type=hidden][name="_formkey"]',c).val();e=this._getDistributionSet();g={a:"check",k:c,l:g,o:a,t:e?e.id:null};a=this.options.ajaxURL;var h=b('<div class="inline-throbber">').insertAfter(this.personContainer),l=this;b.ajaxS3({url:a,type:"POST",dataType:"json",contentType:"application/json; charset=utf-8",data:JSON.stringify(g),success:function(k){h.remove();k.a&&b('<div class="error_wrapper"><div id="label__error" class="error" style="display: block;">'+k.a+"</div></div>").hide().insertAfter(b(d+
...
e),d=b('<div class="image-row">').append(d),c.prepend(d),g.text(a.hidePictureLabel))}},_showItemSelection:function(){this.detailsContainer.removeClass("hide").show();this.detailsRow.removeClass("hide").show()},_hideItemSelection:function(){this.detailsRow.hide()},_removeItemSelection:function(){this.detailsRow.hide();this.detailsContainer.empty()},_renderItemSelection:function(){const a=this.options;this._removeItemSelection();var c=this.actionableInfo.val();if(c){var d=JSON.parse(c);c=d.distribute;
d=d.return;var e=b('<div class="distribution-details">');c.items&&c.items.length?this._renderItemTable(a.distributeLabel,"distribute",c.items).appendTo(e):c.msg&&this._renderItemTable(a.distributeLabel,"distribute",null,c.msg).appendTo(e);d&&d.length&&this._renderItemTable(a.returnLabel,"return",d).appendTo(e);e.appendTo(this.detailsContainer);this._showItemSelection();this._toggleSubmit(!0)}},_renderItemTable:function(a,c,d,e){let g=b('<table class="item-table">'),h=b("<thead>").appendTo(g),l=b("<tbody>").appendTo(g),
k=b('<tr class="item-title">').appendTo(h);b('<th colspan="5">').text(a).appendTo(k);let f=this;d?(f._renderItemHeader(c).appendTo(h),d.forEach(function(m){f._renderItemRow(m,c).appendTo(l)})):e&&f._renderMessageRow(e).appendTo(l);return g},_renderItemHeader:function(a){const c=this.options;let d=b("<th>"),e=b('<tr class="item-header">').append(b("<th>")).append(b("<th>").text(c.itemLabel)).append(b("<th>").text(c.QuantityLabel)).append(d).append(b("<th>").text(c.packLabel));"return"==a&&d.text(c.lossLabel);
return e},_renderItemRow:function(a,c){var d=this.options;let e=a.quantity-0;isNaN(e)&&(e=a.max-0||0);let g=b('<tr class="dist-item">').data({mode:a.mode||("return"==c?"RET":null),itemID:a.id,packID:a.pack_id,quantity:e,max:a.max,itemQ:e,lossQ:0});var h=b('<input type="checkbox" class="select-item">');b("<td>").append(h).appendTo(g);h=b("<div>").text(a.name);h=b("<td>").append(h).appendTo(g);"LOA"==a.mode&&b('<div class="dist-mode">').text(d.loanLabel).appendTo(h);d=b('<input type="number" min="0" class="item-q">').val(e).prop("disabled",
!0);b("<td>").append(d).appendTo(g);"return"==c?(c=b('<input type="number" min="0" class="loss-q" value="0">').prop("disabled",!0),b("<td>").append(c).appendTo(g)):b("<td>").appendTo(g);a=b("<div>").text(a.pack);b("<td>").append(a).appendTo(g);return g},_renderMessageRow:function(a){return b("<tr>").append(b('<td class="blocked-msg" colspan="5">').text(a))},_updateActionDetails:function(){var a=!1,c=[],d=[],e={d:c,r:d};b(".dist-item.selected",this.detailsContainer).each(function(){let g=b(this),h=
g.data();if(b(".invalidinput",g).length)a=!0;else if(h.itemQ||h.lossQ)"RET"==h.mode?d.push([h.itemID,h.packID,"RET",h.itemQ,h.lossQ]):c.push([h.itemID,h.packID,h.mode,h.itemQ])});a||!c.length&&!d.length?this.actionDetails.val(""):this.actionDetails.val(JSON.stringify(e))},_checkActionable:function(){return!!this.actionDetails.val()},_selectItem:function(a){a=b(a);const c=a.closest("tr.dist-item"),d=c.data("quantity");b(".error",c).remove();a.prop("checked")?(b(".item-q, .loss-q",c).removeClass("invalidinput"),
b(".item-q",c).val(d).prop("disabled",!1),b(".loss-q",c).val(0).prop("disabled",!1),c.addClass("selected").data({itemQ:d,lossQ:0})):(b(".item-q, .loss-q",c).removeClass("invalidinput").prop("disabled",!0),c.removeClass("selected").data({itemQ:0,lossQ:0}));this._updateActionDetails();this._toggleSubmit(!0)},_changeQuantity:function(a){var c=b(a);a=c.closest("tr.dist-item");c.removeClass("invalidinput");b(".error",a).remove();var d=c.val();if(d){d=Math.abs(parseInt(d-0));c.val(d);var e=d,g=a.data("max"),
h=!1;if(g){let l;l=c.hasClass("loss-q")?b(".item-q",a):b(".loss-q",a);l.length&&l.val()&&(e+=l.val()-0||0);e>g&&(e=0,d>g?(c.addClass("invalidinput"),c.after(b('<div class="error">').text("max "+g)),h=!0):l.length&&(e=g-d),l.length&&l.removeClass("invalidinput").val(e))}h?a.data({itemQ:0,lossQ:0}):(c=b(".item-q",a).val()-0||0,d=b(".loss-q",a).val()-0||0,a.data({itemQ:c,lossQ:d}));this._updateActionDetails();this._toggleSubmit(!0)}else c.removeClass("invalidinput").val("")},_toggleSubmit:function(a){var c=
...
this._clearAlert();c||b(this.idPrefix+"_label").val("");this._removePerson();this._removeFlagInfo();this._removeItemSelection();this._removeProfilePicture();this.actionableInfo.val("");this.actionDetails.val("");b(".submit-btn").val(this.submitLabel);this._toggleSubmit(!1);a=b(this.idPrefix+"_label");a.trigger("focus").val(a.val())},_getDistributionSet:function(){const a=this.distributionSet.val();if(!a)return null;let c=b("a.distribution-set-select",this.distributionSetSelect).filter(function(){return b(this).data("id")==
a});return c.length?{id:c.data("id")||null,name:c.data("name")||null}:null},_setDistributionSet:function(a,c){this.distributionSet.val(a);b(".distribution-set-name",this.distributionSetHeader).text(c);this._updateDistributionSet();this._clearForm(!1,!0);this._checkID();b(this.idPrefix+"_person__row .controls").text()&&this._toggleSubmit(!0)},_clearDistributionSet:function(){this.distributionSet.val("");this._updateDistributionSet();this._toggleSubmit(!1)},_updateDistributionSet:function(){let a=this.distributionSetHeader,
c=b("a.distribution-set-select",this.distributionSetSelect).length,d=this.distributionSet.val();var e=this.options;d?a.removeClass("challenge"):(e=0<c?e.selectDistributionSetLabel:e.noDistributionSetsLabel,b(".distribution-set-name",a).text(e));0==c?a.addClass("empty").addClass("disabled"):1==c&&d?a.removeClass("empty").addClass("disabled"):(a.removeClass("empty").removeClass("disabled"),d||a.addClass("challenge"))},_populateDistributionSets:function(a){let c=this.distributionSetSelect.empty(),d=
a.sets;(a=a.default)||1!=d.length||(a=d[0]);d.forEach(function(e){let g=e[0];e=e[1];b('<a class="secondary button distribution-set-select">').text(e).appendTo(c).data({id:g,name:e})});a?this._setDistributionSet(a[0],a[1]):this._clearDistributionSet()},_selectOrg:function(a){let c=a.data("id");a=a.data("name");let d=this.orgHeader,e=this.orgSelect;this._clearForm();d.data("selected",c).addClass("selected");b("h4.org-name",d).text(a);let g=b('<div class="inline-throbber">'),h=this.distributionSetHeader.addClass("disabled"),
l=b(".distribution-set-name",h).hide().after(g),k=this;b.ajaxS3({url:this.options.ajaxURL+"?org="+c,type:"GET",dataType:"json",contentType:"application/json; charset=utf-8",success:function(f){k._populateDistributionSets(f);g.remove();l.show();1<f.sets.length&&h.removeClass("disabled")},error:function(){g.remove()}});e.slideUp("fast")},_selectDistributionSet:function(a){let c=a.data("id");a=a.data("name");this._setDistributionSet(c,a);this.distributionSetSelect.slideUp("fast")},_bindEvents:function(){const a=
