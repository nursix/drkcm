...
e.t&&c('<span class="rm-item-title">').text(e.t).appendTo(g);d.useRealms&&(a=!e.u&&this._getRealm(a[1]).l||"",c("<td>").text(a).appendTo(b));a=c("<td>");!1!==e.r&&d.ajaxURL&&(d=c('<span class="rm-delete-assignment delete-btn-ajax">'),a.append(d.text(m.rm_Delete)));return b.append(a)},_assignmentTableFooter:function(){var a=c("<tfoot>"),b=c("<tr>").appendTo(a);c("<td>").append(this._itemSelector()).appendTo(b);this.options.useRealms&&c("<td>").append(this._realmSelector()).appendTo(b);var d=c('<a class="rm-submit-add action-btn">').text(m.rm_Add),
...
k.assignments.filter(function(l){return l[0]!==e[0]||l[1]!==e[1]});k._serialize();c(".rm-assignment",c(k.element)).each(function(){var l=c(this).data("assignment");l[0]===e[0]&&l[1]===e[1]&&c(this).fadeOut(function(){f.remove();c(this).remove();k._checkNewAssignment()&&k._toggleAdd(!0)})})},error:function(){var l=c('<span class="rm-error">').insertBefore(f.hide());l.text(m.rm_DeletionFailed);f.remove();window.setTimeout(function(){l.fadeOut(function(){h.show()})},1E3)}})}}},_getRealm:function(a){return this.options.realms[a]||
{l:"---",t:"---"}},_compareAssignments:function(a,b){var d=this.options.items,e=d[a[0]].l;d=d[b[0]].l;return e==d?this._compareRealms(a[1],b[1]):e>d&&1||-1},_compareRealms:function(a,b){if(a===b)return 0;var d=this._getRealm(a).t,e=this._getRealm(b).t;return(d=this._compareRealmTypes(d,e))?d:a?b?(a=this._getRealm(a).l,b=this._getRealm(b).l,a>b&&1||-1):-1:null===a&&1||null===b&&-1||1},_compareRealmTypes:function(a,b){if(a===b)return 0;var d=this.options.realmTypes.map(function(e){return e[0]});a=d.indexOf(a);
b=d.indexOf(b);return a-b},_bindEvents:function(){var a=this.eventNamespace,b=this;if(this.addRow!==n)this.addRow.on("change"+a,".rm-item-select",function(){b._optionSelected()}).on("change"+a,".rm-realm-select",function(){b._realmSelected()}).on("click"+a,".rm-cancel-add",function(){b._resetAddRow()}).on("click"+a,".rm-submit-add",function(){b._addAssignment()});c(this.element).on("click"+a,".rm-delete-assignment",function(){b._deleteAssignment(c(this).closest(".rm-assignment"))});return!0},_unbindEvents:function(){var a=
c(this.element),b=this.eventNamespace;this.addRow!==n&&this.addRow.off(b);a.off(b);return!0}})})(jQuery);
