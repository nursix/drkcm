...
e)):(c=c.getBounds().getCenterLonLat(),c.transform(e,f),a=S3.Ap.concat("/"+a.c+"/"+a.f+"/create.popup?refresh_layer="+a.i+"&lat="+c.lat+"&lon="+c.lon),c.transform(f,e));d.maps.default_map.s3.westPanelContainer.collapse();d.addPopup(b,a,void 0,!0)};$(function(){$.when(g("default_map")).then(function(b){S3.gis.maps.default_map.s3.pointPlaced=h},function(b){s3_debug(b)},function(b){s3_debug(b)})})})(jQuery);
