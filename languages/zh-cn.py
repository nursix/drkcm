...
"Describe the procedure which this record relates to (e.g. 'medical examination')": '描述这条记录有关的过程(例如"医疗检查")',
...
'0-15 minutes': '0至15分钟',
'1 Assessment': '一次评估',
'1 location, shorter time, can contain multiple Tasks': '一个位置,时间短,可以包含多个任务',
'1-3 days': '1-3 天',
...
'ACCESS DATA': '访问数据',
'ANY': '任意',
'API is documented here': 'API在此处记录',
...
'Activities of boys 13-17yrs before disaster': '13至17岁男孩灾难前的状态',
'Activities of boys 13-17yrs now': '13至17岁男孩现在的状态',
'Activities of boys <12yrs before disaster': '12岁以下男孩灾难前的状态',
'Activities of boys <12yrs now': '12岁以下男孩现在的状态',
'Activities of children': '儿童的状态',
'Activities of girls 13-17yrs before disaster': '13至17岁女孩灾难前的状态',
'Activities of girls 13-17yrs now': '13至17岁女孩现在的状态',
'Activities of girls <12yrs before disaster': '12岁以下女孩灾难前的状态',
'Activities of girls <12yrs now': '12岁以下女孩现在的状态',
'Activities': '活动',
'Activities:': '活动：',
'Activity Added': '新增活动',
...
'Add Camp': '添加阵营',
'Add Certificate for Course': '添加课程的认证',
...
'Add a Reference Document such as a file, URL or contact person to verify this data. If you do not enter a Reference Document, your email will be displayed instead.': '添加一份参考文件(如文件, URL或联系人,以验证此数据。 如果您不输入一个参考文件,将显示您的电子邮件地址。',
...
'Added to Group': '已添加到组',
'Added to Team': '已添加成员',
'Additional Beds / 24hrs': '额外病床每24小时',
...
'Admin Tel': '管理员电话',
'Administration': '管理部门',
'Admissions/24hrs': '入院每24小时',
'Adolescent (12-20)': '青少年(12至20岁)',
'Adolescent participating in coping activities': '青少年应参与活动',
'Adult (21-50)': '成人(21-50岁)',
'Adult ICU': '成人ICU',
...
'Advanced:': '高级：',
'Advisory': '建议',
'After clicking on the button, a set of paired items will be shown one by one. Please select the one solution from each pair that you prefer over the other.': '按下按钮后,一组成对的项目将逐个显示，请在每一对中选择您更倾向的一个解决方案。',
'Age Group': '年龄组',
...
'Antibiotics needed per 24h': '每24小时需要抗生素',
'Apparent Age': '明显年龄',
...
'Assessment Reported': '已报告评估',
'Assessment Summaries': '评估摘要',
'Assessment Summary Details': '评估摘要详细信息',
'Assessment Summary added': '已添加评估摘要',
'Assessment Summary deleted': '已删除评估摘要',
'Assessment Summary updated': '已更新评估摘要',
'Assessment added': '已添加评估',
'Assessment admin level': '评估管理级别',
'Assessment deleted': '已删除评估',
'Assessment timeline': '评估的时间线',
'Assessment updated': '已更新评估',
'Assessment': '评估',
...
'Asset Log Entry Added - Change Label': '已添加资产日志条目,更改标签',
'Asset Log Entry deleted': '已删除资产日志条目',
'Asset Log Entry updated': '已更新资产日志条目',
'Asset Log': '资产日志',
...
'Asset updated': '已更新资产',
'Asset': '资产',
'Assets are resources which are not consumable but are expected back, so they need tracking.': '不可,但是预期返回的资产资源,因此他们需要跟踪。',
'Assets': '资产',
'Assign Group': '指定组',
'Assign Staff': '指定人员',
...
'Baseline Type added': '已添加基线类型',
'Baseline Type deleted': '已删除基线类型',
'Baseline Type updated': '已更新基线类型',
'Baseline Type': '基线类型',
'Baseline Types': '基线类型',
'Baseline added': '已添加基线',
'Baseline deleted': '已删除基线',
'Baseline number of beds of that type in this unit.': '基线中该类型的病床数此单元。',
'Baseline updated': '已更新基线',
...
'Baud rate to use for your modem - The default is safe for most cases': '波特率用于您的调制解调器-默认值是安全的大多数情况下默认值是安全的',
'Baud': '波特',
'Beam': '播送',
...
'Biscuits': '饼干',
'Blizzard': '风雪',
'Blood Type (AB0)': '血型(AB0)',
'Blowing Snow': '吹雪',
'Boat': '船舶',
'Bodies found': '已找到主体',
'Bodies recovered': ' 已恢复主体',
...
'Budget Updated': '已更新预算',
'Budget added': '已添加预算',
'Budget deleted': '已删除预算',
'Budget updated': '已更新预算',
'Budget': '预算',
...
'Building Short Name/Business Name': '建筑短名称/商业名称',
'Building or storey leaning': '倾斜的建筑物或高层',
...
'Bundle Updated': '已更新捆绑软件',
'Bundle added': '已添加捆绑软件',
'Bundle deleted': '已删除捆绑软件',
'Bundle updated': '已更新捆绑软件',
'Bundle': '捆绑软件',
'Bundles': '捆绑销售商品',
'Burn ICU': '烧伤ICU',
...
'Camp Service added': '已添加营地服务',
'Camp Service deleted': '已删除阵营服务',
'Camp Service updated': '已更新阵营服务',
'Camp Service': '服务营',
'Camp Services': '营地服务',
'Camp Type Details': '阵营类型详细信息',
'Camp Type added': '已添加阵营类型',
'Camp Type deleted': '已删除阵营类型',
'Camp Type updated': '已更新阵营类型',
'Camp Type': '类型阵营',
...
'Camp': '营地',
'Camps': '营地',
'Can only disable 1 record at a time!': '一次只能禁用一个记录!',
...
'Catalog Item added': '已添加目录',
'Catalog Item deleted': '已删除目录',
'Catalog Item updated': '已更新目录项',
'Catalog Items': '目录项',
'Catalog added': '已添加目录',
'Catalog deleted': '已删除目录',
'Catalog updated': '已更新目录',
'Catalog': '目录',
'Catalogs': '目录',
'Categories': '类别',
'Category': '类别',
...
'Certificate added': '已添加证书',
'Certificate deleted': '已删除证书',
'Certificate updated': '已更新证书',
'Certificate': '证书',
'Certificates': '证书',
'Certification Details': '认证详细信息',
'Certification added': '已添加认证',
'Certification deleted': '已删除认证',
'Certification updated': '已更新认证',
'Certification': '认证',
'Certifications': '认证',
'Certifying Organization': '认证中组织',
...
'Child headed households (<18 yrs)': '儿童家庭(18岁以内)',
'Child': '孩子',
'Children (2-5 years)': '儿童(2-5岁)',
'Children (5-15 years)': '儿童(5-15岁)',
'Children (< 2 years)': '儿童(2岁以内)',
'Children in adult prisons': '成人监狱的儿童',
'Children in boarding schools': '寄宿学校的儿童',
'Children in homes for disabled children': '修养在家的残疾儿童',
'Children in juvenile detention': '少年被拘留的儿童',
'Children in orphanages': '孤儿院中的儿童',
'Children living on their own (without adults)': '自己生活的儿童(不与成人生活)',
...
'Children that have been sent to safe places': '已发送至安全地点的儿童',
...
'Click on the link %(url)s to reset your password': '单击该链接 %(url)s 重设密码',
'Click on the link %(url)s to verify your email': '单击该链接 %(url)s 验证您的电子邮件',
...
'Cluster Subsector added': '已添加集群部门',
'Cluster Subsector deleted': '已删除集群界别',
'Cluster Subsector updated': '已更新集群部门',
'Cluster Subsector': '集群分组',
'Cluster Subsectors': '集群分组',
'Cluster Threshold': '集群阈值',
'Cluster added': '已添加集群',
'Cluster deleted': '已删除集群',
'Cluster updated': '已更新集群',
'Cluster': '集群 (cluster)',
'Cluster(s)': '集群',
'Clusters': '集群',
'Code': '代码',
...
'Color of bottom of Buttons when not pressed': '不按按钮时按钮部的颜色',
...
'Commitment Added': '已添加承诺',
'Commitment Canceled': '已取消承诺',
'Commitment Details': '落实详细信息',
'Commitment Item Details': '承诺项目详细信息',
'Commitment Item added': '已添加承诺项目',
'Commitment Item deleted': '已删除承诺项目',
'Commitment Item updated': '已更新承诺项目',
'Commitment Items': '承诺项目',
'Commitment Status': '承诺状态',
'Commitment Updated': '已更新承诺',
'Commitments': '承诺',
'Committed By': '提交由',
'Committed': '已落实',
'Committing Inventory': '提交中库存',
...
'Competency Rating added': '已添加职务评级',
'Competency Rating deleted': '已删除职务分级',
'Competency Rating updated': '已更新职务评级',
'Competency Ratings': '职务分级',
'Competency added': '已添加能力',
'Competency deleted': '已删除能力',
'Competency updated': '已更新能力',
'Competency': '能力',
'Complete': '完成',
'Completed': '已完成',
'Complexion': '气色',
...
'Contact Information Updated': '已更新联系信息',
...
'Course Certificate added': '已添加课程证书',
'Course Certificate deleted': '已删除课程证书',
'Course Certificate updated': '已更新课程证书',
'Course Certificates': '课程证书',
'Course Details': '课程详细信息',
'Course added': '已添加课程',
'Course deleted': '已删除课程',
'Course updated': '已更新课程',
'Course': '课程',
'Courses': '课程',
...
'Create Item Category': '创建项类别',
'Create Item Pack': '创建项目包',
'Create Item': '创建项目',
'Create Kit': '创建新套件',
'Create Layer': '创建层',
...
'Creation of Surveys': '调查的创建',
'Credential Details': '凭证详细信息',
'Credential added': '已添加凭证',
'Credential deleted': '已删除凭证',
'Credential updated': '已更新凭证',
'Credentialling Organization': '认证中组织',
'Credentials': '凭证',
'Credit Card': '信用卡',
'Crime': '犯罪',
'Criteria': '条件',
...
'Current general needs': '当前一般需要',
'Current greatest needs of vulnerable groups': '目前脆弱群体的最大需求',
...
'Currently no Course Certificates registered': '目前没有已注册课程证书',
'Currently no Credentials registered': '目前没有注册凭证',
'Currently no Missions registered': '目前没有注册任务',
'Currently no Skill Equivalences registered': '当前无已注册等价技能',
...
'Dead Body': '尸体',
'Dead body report added': '已添加报尸体告',
'Dead body report deleted': '已删除尸体报告',
'Dead body report updated': '已更新尸体报告',
'Deaths in the past 24h': '过去24小时的死亡数',
'Deaths/24hrs': '死亡数每24小时',
'Decimal Degrees': '小数度',
'Decision': '决策',
'Decomposed': '分解',
'Default Height of the map window.': '默认地图窗口的高度',
'Default Map': '默认地图',
'Default Marker': '默认标记',
'Default Width of the map window.': '默认地图窗口的宽度',
...
'Degrees must be a number between -180 and 180': '度必须是-180和180之间的数字',
'Dehydration': '脱水',
...
'Delete Received Item': '删除已收到项目',
'Delete Received Shipment': '删除已收到装运',
'Delete Record': '删除记录',
'Delete Report': '删除报告',
...
'Delete from Server?': '从服务器删除吗?',
'Delete': '删除',
'Delphi Decision Maker': 'Delphi决策者',
'Demographic': '人口统计',
'Dental Examination': '牙齿检查',
'Dental Profile': '牙齿档案',
'Describe the condition of the roads to your hospital.': '描述去往你的医院的道路状况',
...
'Direction': '方向',
'Disable': '停用',
'Disabled participating in coping activities': '已禁用参与处理活动',
'Disabled': '已禁用',
'Disabled?': '已禁用?',
...
'Do you want to cancel this received shipment? The items will be removed from the Inventory. This action CANNOT be undone!': '您要取消这个已收到装运? 该项目将从库存被移除。 此操作无法撤销!',
'Do you want to cancel this sent shipment? The items will be returned to the Inventory. This action CANNOT be undone!': '您要取消这个已发送装运? 项目将返回到库存。 此操作无法撤销!',
'Do you want to receive this shipment?': '您要接收这批装运?',
'Do you want to send these Committed items?': '您要发送的这些已提交项吗?',
'Do you want to send this shipment?': '您要发送这批装运?',
'Document Details': '文档详细信息',
'Document Scan': '文档扫描',
'Document added': '已添加文档',
'Document deleted': '已删除文档',
'Document updated': '已更新文档',
'Documents and Photos': '文件和照片',
'Documents': '文档',
'Does this facility provide a cholera treatment center?': '此设施是否提供一个霍乱治疗中心?',
'Doing nothing (no structured activity)': '不做什么(没有结构化活动)',
'Dollars': '美元',
'Domain': '域 (Domain)',
'Domestic chores': '国内,',
'Donated': '已捐赠',
...
'Edit Personal Effects Details': '编辑个人影响的详细信息',
'Edit Photo': '编辑照片',
...
'Edit Received Item': '编辑已接收产品',
'Edit Received Shipment': '编辑已收到装运',
'Edit Record': '编辑记录',
...
'Edit User': '编辑用户',
'Edit Volunteer Availability': '编辑志愿者可用性',
'Edit Volunteer Details': '编辑志愿者详情',
'Edit Warehouse': '编辑仓库',
'Edit current record': '编辑当前记录',
'Edit message': '编辑消息',
'Edit': '编辑',
'Editable?': '可编辑?',
'Education materials received': '已接收教育材料',
'Education materials, source': '教育材料,来源',
'Education': '教育',
'Effects Inventory': '影响库存',
'Eggs': '蛋',
'Either a shelter or a location must be specified': '住房或必须指定位置',
'Either file upload or document URL required.': '必需上传文件或文件URL',
'Either file upload or image URL required.': '必需上传文件或图片URL',
'Elderly person headed households (>60 yrs)': '以老人当家的家庭(大于60岁)',
'Electrical': '电气',
'Electrical, gas, sewerage, water, hazmats': '电力,煤气,排水,水, 危险品',
'Elevated': '提升',
'Elevators': '电梯',
...
'Enter a name for the spreadsheet you are uploading (mandatory).': '为您正在上传的电子表格输入一个名称(必需)。',
...
'Estimated Overall Building Damage': '预计建筑总损坏',
...
'Eye Color': '眼睛颜色',
'Facial hair, color': '面部头发，颜色',
'Facial hair, type': '面部头发，类型',
'Facial hear, length': '面部耳朵，长度',
'Facilities': '设施',
'Facility Details': '设施详细',
'Facility Operations': '设施操作',
'Facility Status': '设施状态',
'Facility Type': '设施类型',
'Facility added': '已添加设施',
'Facility or Location': '设施或位置',
'Facility removed': '已除去设施',
'Facility updated': '已更新设施',
'Facility': '设施',
'Fail': '失败',
'Failed!': '失败！',
'Fair': '尚可',
...
'Families/HH': '家庭/hh',
'Family tarpaulins received': '已接收系列帆布',
...
'Flood Report added': '已添加洪水报告',
'Flood Report deleted': '已删除洪水报告',
'Flood Report updated': '已更新洪水报告',
'Flood Report': '洪水报告',
'Flood Reports': '洪水报告',
'Flood': '洪水',
'Flow Status': '流程状态',
...
'Footer': '页脚',
'For a country this would be the ISO2 code, for a Town, it would be the Airport Locode.': '对于一个国家这将是ISO2代码,对于一个城镇,将是机场Lo代码。',
...
'For live help from the Sahana community on using this application, go to': '更多来自Sahana Eden关于如何使用这个应用的实时帮助,请转至',
'For messages that support alert network internal functions': '支持警报网路内部函数的信息',
...
'Hair Length': '头发长度',
'Hair Style': '头发样式',
'Has data from this Reference Document been entered into Sahana?': '有数据从这个参考文件中输入Sahana吗?',
...
'Hierarchy Level 0 Name (i.e. Country)': '0层次名(即国家或地区)',
'Hierarchy Level 1 Name (e.g. State or Province)': '1层次名(例如,省或直辖市)',
'Hierarchy Level 2 Name (e.g. District or County)': '2层次名(例如,地区或县)',
'Hierarchy Level 3 Name (e.g. City / Town / Village)': '3层次名(例如市/镇/村)',
'Hierarchy Level 4 Name (e.g. Neighbourhood)': '4层次名(例如邻里)',
'Hierarchy Level 5 Name': '5层次名称',
'High Water': '高水位',
'High': '高',
'Hindu': '印度',
'History': '历史记录',
'Hit the back button on your browser to try again.': '点击浏览器上的"后退"按钮然后再试一次。',
...
'Hospital information added': '已添加医院信息',
'Hospital information deleted': '已删除医院信息',
'Hospital information updated': '已更新医院信息',
...
'How many Boys (0-17 yrs) are Dead due to the crisis': '有多少男孩(0-17岁)由于危机而死亡',
'How many Boys (0-17 yrs) are Injured due to the crisis': '有多少男孩(0-17岁)由于危机而受伤',
'How many Boys (0-17 yrs) are Missing due to the crisis': '有多少男孩(0-17岁)由于危机而失踪',
'How many Girls (0-17 yrs) are Dead due to the crisis': '有多少女孩(0-17岁)由于危机而死亡',
'How many Girls (0-17 yrs) are Injured due to the crisis': '有多少女孩(0-17岁)由于危机而受伤.',
'How many Girls (0-17 yrs) are Missing due to the crisis': '有多少女孩(0-17岁)由于危机而失踪',
'How many Men (18 yrs+) are Dead due to the crisis': '有多少男性(18岁以上)由于危机而死亡',
'How many Men (18 yrs+) are Injured due to the crisis': '有多少男性(18岁以上)由于危机而受伤',
'How many Men (18 yrs+) are Missing due to the crisis': '有多少男性(18岁以上)由于危机而失踪',
'How many Women (18 yrs+) are Dead due to the crisis': '有多少女性(18岁以上)由于危机而死亡',
'How many Women (18 yrs+) are Injured due to the crisis': '有多少女性(18岁以上)由于危机而受伤',
'How many Women (18 yrs+) are Missing due to the crisis': '有多少女性(18 yrs+)由于危机而失踪',
'How many days will the supplies last?': '供应将持续多久?',
'How many new cases have been admitted to this facility in the past 24h?': '在过去24小时，此设施接纳了多少新个案?',
'How many of the patients with the disease died in the past 24h at this facility?': '在过去24小时，有多少患有疾病的病人在此施设死亡',
'How many patients with the disease are currently hospitalized at this facility?': '有多少患有疾病的病人目前在这个设施住院?',
'How much detail is seen. A high Zoom level means lot of detail, but not a wide area. A low Zoom level means seeing a wide area, but not a high level of detail.': '详细程度是。高的缩放级别意味着很多的细节,但不是一个全区域。 较低的缩放级别意味着出现的区域,但不是一个高水平的详细信息。',
'Human Resource Details': '人力资源详细信息',
'Human Resource Management': '人力资源管理',
'Human Resource added': '已添加人力资源',
'Human Resource removed': '已除去人力资源',
'Human Resource updated': '已更新人力资源',
'Human Resource': '人力资源',
...
'Identity added': '已添加标识',
'Identity deleted': '已删除身份',
'Identity updated': '已更新身份',
'Identity': '身份',
...
'If no marker defined then the system default marker is used': '如果没有标记定义,那么将使用默认系统标记',
...
'Impact Type added': '已添加影响类型',
'Impact Type deleted': '已删除影响类型',
'Impact Type updated': '已更新影响类型',
'Impact Type': '影响类型',
'Impact Types': '影响类型',
'Impact added': '已添加影响',
'Impact deleted': '已删除影响',
'Impact updated': '已更新影响',
'Impacts': '影响',
...
'Improper handling of dead bodies': '处理不当的尸体',
'In Catalogs': '目录中',
'In Inventories': '在库存中',
'In Process': '正在进行',
'In Progress': '进行中',
'In Window layout the map maximises to fill the window, so no need to set a large value here.': '在窗口布局的地图最大程度填充窗口,因此不需要设置较大的值。',
'Inbound Mail Settings': '入站邮件设置',
'Incident Categories': '事故类别',
'Incident Report Details': '事故报告详细信息',
'Incident Report added': '已添加事故报告',
'Incident Report deleted': '已删除事故报告',
'Incident Report updated': '已更新事故报告',
...
'Incoming Shipment updated': '已更新收货',
'Incoming': '即将来的',
'Incomplete': '未完成',
'Individuals': '个人',
...
'Infusion catheters need per 24h': '每24小时需要注入导管',
'Infusion catheters needed per 24h': '每24小时注入导管需要',
'Infusions available': '可用注资',
'Infusions needed per 24h': '每24小时注资需要',
'Inspected': '已检验的',
'Inspection Date': '检查日期',
'Inspection date and time': '检查日期和时间',
'Inspection time': '检查时间',
'Inspector ID': '检查员标识',
'Instant Porridge': '即食稀饭',
'Institution': '机构',
...
'Inventory Item updated': '已更新库存项目',
'Inventory Item': '库存项',
...
'Is it safe to collect water?': '收集水是否安全?',
...
'Item Added to Shipment': '已添加到发货的项目',
...
'Item Packs': '项目包',
'Item added to Inventory': '已添加到库存的项目',
'Item added to shipment': '已添加到发货的项目',
'Item added': '已添加项',
...
'Job Role added': '已添加工作角色',
'Job Role deleted': '已删除工作角色',
'Job Role updated': '已更新工作角色',
'Job Role': '职位',
'Job Roles': '工作角色',
'Job Title': '职务',
'Jobs': '作业',
'Journal Entry Details': '日志条目详细信息',
'Journal entry added': '已添加日志条目',
...
'Lack of transport to school': '缺乏去学校的交通',
...
'Latitude of Map Center': '地图中心的纬度',
...
'Latitude should be between': '纬度应该在',
'Latitude': '纬度',
'Latrines': '厕所',
...
'Level 1 Assessment added': '已添加一级评估',
'Level 1 Assessment deleted': '已删除一级评估',
...
'Level 2 Assessment updated': '已更新二级评估',
...
'List All Assets': '列举所有资产',
'List All Catalog Items': '列举所有目录项',
'List All Commitments': '列举所有承诺',
'List All Entries': '所有条目列举',
'List All Item Categories': '列举所有项目类别',
'List All Memberships': '列举所有成员',
'List All Received Shipments': '列举所有收到货物',
'List All Records': '列举所有记录',
'List All Requested Items': '列举所有要求项目',
'List All Requests': '列举所有请求',
'List All Sent Shipments': '列举所有发送货物',
'List All': '列举全部',
'List Alternative Items': '列举替代项目',
'List Assessment Summaries': '列举评估摘要',
'List Assessments': '列举评估',
'List Assets': '列举资产',
'List Availability': '列举可用性',
...
'List Conflicts': '列举冲突',
'List Contact Information': '列举联系人信息',
'List Contacts': '列举联系人',
...
'List Kits': '列举工具包',
'List Layers': '列举层次',
'List Level 1 Assessments': '列举一级评估',
'List Level 1 assessments': '列举一级评估',
...
'List Received Shipments': '列举已接收货物',
'List Records': '列举记录',
...
'List Sent Shipments': '列举发送货物',
'List Service Profiles': '列举服务概要文件',
'List Settings': '列举设置',
'List Shelter Services': '列举住房服务',
'List Shelter Types': '列举住所类型',
'List Shelters': '列举住房',
'List Skill Equivalences': '列举技能等价',
'List Skill Provisions': '列举技能清单',
'List Skill Types': '列举类型技能',
'List Skills': '列举技能',
...
'List all': '列举全部',
'List available Scenarios': '列举可用的场景',
'List of Items': '项的列表',
'List of Missing Persons': '失踪人员列表',
'List of Peers': '同行列表',
'List of Reports': '报告列表',
'List of Requests': '请求列表',
'List of Spreadsheets uploaded': '已上传电子表格列表',
'List of Spreadsheets': '电子表格列表',
'List of Volunteers for this skill set': '此技能集的志愿者列表',
'List of Volunteers': '志愿者的列表',
'List of addresses': '地址列表',
'List unidentified': '列举不明身份的',
'List': '列表',
'List/Add': '列举/添加',
'Lists "who is doing what & where". Allows relief agencies to coordinate their activities': '列举"谁是做什么& 在哪里".允许救济机构协调它们的活动',
'Live Help': '实时帮助',
'Livelihood': '民生',
'Load Cleaned Data into Database': '装入已清理数据到数据库',
...
'Log entry added': '已添加日志条目',
'Log entry deleted': '已删除日志条目',
'Log entry updated': '已更新日志条目',
'Log': '日志',
'Login': '登录',
...
'Longitude is West-East (sideways).': '经度是西方-东方(横向)。',
'Longitude is zero on the prime meridian (Greenwich Mean Time) and is positive to the east, across Europe and Asia.  Longitude is negative to the west, across the Atlantic and the Americas.': '本初子午线(格林威治标准时间)经度为0,东部经度为正,横跨欧洲和亚洲各地。 西边经度为负数,横跨大西洋和美洲。',
'Longitude is zero on the prime meridian (through Greenwich, United Kingdom) and is positive to the east, across Europe and Asia.  Longitude is negative to the west, across the Atlantic and the Americas.': '本初子午线(通过格林威治,英国)经度为0，东部经度为正，横跨中东,欧洲和亚洲。 西边经度为负,横跨大西洋和美洲。',
'Longitude of Map Center': '地图中心的经度',
'Longitude of far eastern end of the region of interest.': '地图显示的最东边的经度',
'Longitude of far western end of the region of interest.': '地图显示的最西边的经度',
...
'Map Profile added': '已添加地图档案',
'Map Profile deleted': '已删除地图档案',
'Map Profile removed': '已除去地图档案',
'Map Profile updated': '已更新地图档案',
'Map Profile': '地图档案',
'Map Profiles': '地图档案',
...
'Marker Details': '标记详情',
'Marker added': '已添加标记',
'Marker deleted': '已删除标记',
'Marker updated': '已更新标记',
'Marker': '标记',
'Markers': '标记',
...
'Membership updated': '已更新成员资格',
'Membership': '成员资格',
'Memberships': '成员资格',
'Message Details': '消息详细信息',
'Message Variable': '消息变量',
'Message added': '已添加消息',
'Message deleted': '已删除消息',
'Message updated': '已更新消息',
'Message variable': '消息变量',
'Message': '消息',
'Messages': '消息',
'Messaging settings updated': '已更新设置消息传递',
'Messaging': '消息传递',
'Meteorite': '陨石',
...
'Minutes must be a number between 0 and 60': '分钟必须在0到60的数字之间',
'Minutes per Month': '分钟每月',
'Minutes should be a number greater than 0 and less than 60': '分钟应该是一个大于0且小于60的数字',
'Miscellaneous': '杂项',
...
'Mission Record': '任务记录',
'Mission added': '已添加任务',
'Mission deleted': '已删除任务',
'Mission updated': '已更新任务',
'Missions': '任务',
...
'Need Type added': '已添加需要类型',
'Need Type deleted': '已删除需要类型',
'Need Type updated': '已更新需要类型',
'Need Type': '需要类型',
'Need Types': '需要类型',
'Need added': '已添加需要',
'Need deleted': '已删除需要',
...
'New Synchronization Peer': '新同步对等',
'New Team': '新团队',
'New Training Course': '新培训课程',
'New Volunteer': '新志愿者',
'New cases in the past 24h': '在过去24内小时新情况',
'New': '新建',
'News': '新闻',
...
'No Map Profiles currently defined': '当前没有已定义地图档案',
'No Map Profiles currently registered in this event': '当前没有已注册地图档案在此事件',
...
'No Memberships currently defined': '当前没有已定义成员资格',
'No Messages currently in Outbox': '当前没有消息在发件箱',
'No Need Types currently registered': '当前没有已注册需要类型',
'No Needs currently registered': '当前没有已注册需要',
'No Offices currently registered': '当前没有注册办事处',
'No Offices found!': '没有办公室找到!',
'No Organizations currently registered': '当前没有任何已注册组织',
'No People currently registered in this camp': '当前没有已注册人在此营地',
'No People currently registered in this shelter': '当前已注册没有人在此住房',
'No Persons currently registered': '当前没有人注册',
'No Persons currently reported missing': '当前没有人报告失踪',
...
'No Rooms currently registered': '当前没有注册的房间',
'No Scenarios currently registered': '当前没有已注册方案',
'No Sections currently registered': '当前无注册部分',
...
'No Shelter Services currently registered': '当前没有已注册住房服务',
'No Shelter Types currently registered': '当前没有已注册住房类型',
'No Shelters currently registered': '当前没有已注册住房',
'No Solutions currently defined': '当前没有已定义解决方案',
'No Staff Types currently registered': '当前没有已注册人员类型',
'No Subscription available': '没有可用的预订',
'No Subsectors currently registered': '当前没有注册部门',
'No Support Requests currently registered': '当前不支持请求注册',
...
'No Themes currently defined': '当前没有已定义主题',
'No Tickets currently registered': '当前没有已注册票据',
'No Tracks currently available': '当前没有可用磁道',
'No Users currently registered': '当前没有已注册用户',
'No Volunteers currently registered': '当前没有已注册志愿者',
'No Warehouses currently registered': '当前没有已注册仓库',
...
'No data in this table - cannot create PDF!': '此表中没有数据-无法创建PDF!',
'No databases in this application': '此应用程序中没有数据库',
...
'No peers currently registered': '当前没有已注册同业',
'No pending registrations found': '没有发现待批准注册',
...
'No service profile available': '没有可用的服务档案',
'No skills currently set': '当前没有设置任何技能',
...
'Number of deaths during the past 24 hours.': '在过去24小时内的死亡数目。',
'Number of discharged patients during the past 24 hours.': '在过去24小时出院病人数目',
'Number of doctors': '医生的数目',
'Number of in-patients at the time of reporting.': '报告时的病人数目',
'Number of newly admitted patients during the past 24 hours.': '在过去24小时新的入院病人数',
...
'Number': '编号',
'Number/Percentage of affected population that is Female & Aged 0-5': '受影响的人为0-5岁女性的数目/百分比',
'Number/Percentage of affected population that is Female & Aged 13-17': '受影响的人为13-17岁女性的数目/百分比',
'Number/Percentage of affected population that is Female & Aged 18-25': '受影响的人为18-25岁女性的数目/百分比',
'Number/Percentage of affected population that is Female & Aged 26-60': '受影响的人为26-60岁女性的数目/百分比',
'Number/Percentage of affected population that is Female & Aged 6-12': '受影响的人为6-12岁女性的数目/百分比',
'Number/Percentage of affected population that is Female & Aged 61+': '受影响的人为61岁以上女性的数目/百分比',
'Number/Percentage of affected population that is Male & Aged 0-5': '受影响的人为0-5岁男性的数目/百分比',
'Number/Percentage of affected population that is Male & Aged 13-17': '受影响的人为13-17岁男性的数目/百分比',
'Number/Percentage of affected population that is Male & Aged 18-25': '受影响的人为18-25岁男性的数目/百分比',
'Number/Percentage of affected population that is Male & Aged 26-60': '受影响的人为26-60岁男性的数目/百分比',
'Number/Percentage of affected population that is Male & Aged 6-12': '受影响的人为6-12岁男性的数目/百分比',
'Number/Percentage of affected population that is Male & Aged 61+': '受影响的人为61岁以上男性的数目/百分比',
'Nursery Beds': '苗圃病床',
...
'On by default? (only applicable to Overlays)': '默认情况下? (仅适用于覆盖)',
'On by default?': '默认情况下?',
'One Time Cost': '单次成本',
'One time cost': '单次成本',
...
'Opacity (1 for opaque, 0 for fully-transparent)': '透明度(1为不透明,0表示完全透明)',
'Open area': '打开区域',
...
'Organization added': '已添加组织',
'Organization deleted': '已删除组织',
'Organization updated': '已更新组织',
'Organization': '组织',
'Organizations': '组织',
'Origin of the separated children': '被分隔儿童来自',
'Origin': '起源',
...
'Other Name': '其它名称',
'Other activities of boys 13-17yrs before disaster': '13-17岁男孩灾难前的其他活动',
'Other activities of boys 13-17yrs': '13-17岁男孩的其他活动',
'Other activities of boys <12yrs before disaster': '12岁一下男孩灾难前的其他活动',
'Other activities of boys <12yrs': '12岁一下男孩的其他活动',
'Other activities of girls 13-17yrs before disaster': '13-17岁女孩灾难前的其他活动',
'Other activities of girls 13-17yrs': '13-17岁女孩的其他活动',
'Other activities of girls<12yrs before disaster': '12岁一下男孩灾难前的其他活动',
'Other activities of girls<12yrs': '12岁一下女孩的其他活动',
'Other alternative infant nutrition in use': '其他使用中的代替婴儿营养',
'Other alternative places for study': '其他可供研究的地方',
'Other assistance needed': '需要其他援助',
...
'Peer registration request added': '已添加同业注册请求',
'Peer registration request deleted': '已删除同业注册请求',
'Peer registration request updated': '已更新同业注册请求',
'Peer updated': '已更新同行',
'Peer': '同行',
'Peers': '同级设备',
...
'Person 2': '第二个人员',
'Person De-duplicator': '重读人员删除器',
'Person Details': '人员详细信息',
'Person Registry': '人注册表',
'Person added to Group': '已添加人员至组',
'Person added to Team': '已添加人员到团队',
'Person added': '已添加人员',
'Person deleted': '已删除人员',
'Person details updated': '已更新人员详细信息',
...
'Picture upload and finger print upload facility': '图片上传和指纹上传工具',
'Picture': '图片',
'Place of Recovery': '位置的恢复',
'Place': '场所',
'Places for defecation': '大便的场所',
'Places the children have been sent to': '儿已被童送往的地方',
'Playing': '播放',
...
'Population Statistic added': '已添加人口统计信息',
'Population Statistic deleted': '已删除人口统计信息',
'Population Statistic updated': '已更新人口统计信息',
...
'Position added': '已添加位置',
'Position deleted': '已删除位置',
'Position updated': '已更新位置',
'Position': '位置',
'Positions': '位置',
...
'Problem Title': '问题标题',
'Problem added': '已添加问题',
'Problem connecting to twitter.com - please refresh': '问题正在连接到twitter.com-请刷新',
'Problem deleted': '已删除问题',
'Problem updated': '已更新问题',
'Problem': '问题',
'Problems': '问题',
'Procedure': '过程',
...
'Project updated': '已更新项目',
'Project': '项目',
'Projection Details': '预测详细',
'Projection added': '已添加预测',
'Projection deleted': '已删除预测',
'Projection updated': '已更新投影',
'Projection': '预测',
'Projections': '预测',
'Projects': '项目',
...
'Rapid Assessment added': '已添加快速评估',
'Rapid Assessment deleted': '已删除快速评估',
'Rapid Assessment updated': '已更新快速评估',
...
'Received Item deleted': '已删除接收库存项目',
'Received Item updated': '已更新接收库存项目',
'Received Shipment Details': '接收装运详细信息',
'Received Shipment canceled and items removed from Inventory': '装运收到取消和删除项目从库存',
'Received Shipment canceled': '已取消收到发货',
'Received Shipment updated': '已更新装运接收',
...
'Record not found': '未找到记录',
'Record updated': '已更新记录',
'Record': '记录',
'Recording and Assigning Assets': '记录和资产分配',
'Records': '记录',
'Recovery Request added': '已添加恢复请求',
'Recovery Request deleted': '已删除恢复请求',
'Recovery Request updated': '已更新恢复请求',
...
'Remove Asset from this event': '从这个事件除去资产',
...
'Remove Human Resource from this scenario': '从这种情况除去人力资源',
'Remove Item from Inventory': '从库存中移除产品',
'Remove Map Profile from this event': '从该事件除去地图档案',
'Remove Map Profile from this scenario': '从这种情况除去地图档案',
'Remove Person from Group': '从组内删除成员',
'Remove Person from Team': '从团队中删除成员',
'Remove this asset from this event': '从该事件除去此资产',
'Remove this asset from this scenario': '这种情况除去此资产',
'Remove': '除去',
'Removed from Group': '从组内删除成员',
...
'Request added': '已添加请求',
'Request deleted': '已删除请求',
'Request for Role Upgrade': '角色升级的请求',
'Request updated': '已更新请求',
'Request': '请求',
...
'Resource added': '已添加资源',
'Resource deleted': '已删除的资源',
'Resource updated': '已更新资源',
'Resource': '资源',
'Resources': '资源',
...
'Sahana Administrator': 'Sahana管理员',
'Sahana Agasti': 'Sahana Agasti',
'Sahana Blue': 'Sahana・蓝色',
...
'Scenario added': '已添加方案',
'Scenario deleted': '已删除方案',
'Scenario updated': '已更新方案',
'Scenario': '方案',
'Scenarios': '方案',
'Schedule': '调度',
'Schema': '模式',
...
'Seconds must be a number between 0 and 60': '秒必须是在0和60之间的数字',
'Section Details': '本节详情',
'Section deleted': '已删除部分',
'Section updated': '已更新章节',
'Sections': '部分',
'Sector Details': '部门详细信息',
'Sector added': '已添加部门',
'Sector deleted': '已删除部门',
'Sector updated': '已更新部门',
'Sector': '部门',
'Sector(s)': '部门',
'Sectors': '扇区',
...
'Sent Shipment canceled': '已取消装运发送',
'Sent Shipment updated': '已更新装运发送',
...
'Service profile added': '已添加服务概要文件',
'Service profile deleted': '已删除服务概要文件',
'Service profile updated': '已更新服务概要文件',
'Service': '服务',
...
'Setting added': '已添加设置',
'Setting deleted': '已删除设置',
'Setting updated': '已更新设置',
...
'Shelter Service added': '已添加收容服务',
'Shelter Service deleted': '已删除收容服务',
'Shelter Service updated': '已更新住房服务',
...
'Shelter Types': '住所类型',
'Shelter added': '已添加住房',
'Shelter deleted': '已删除住房',
'Shelter updated': '已更新住房',
'Shelter': '庇护住房',
...
'Skill Provision added': '已添加提供技能',
'Skill Provision deleted': '已删除提供技能',
'Skill Provision updated': '已更新提供技能',
...
'Skill Type deleted': '已删除技能类型',
'Skill Type updated': '已更新技能类型',
'Skill Types': '技能类型',
'Skill added': '已添加技能',
'Skill deleted': '已删除技能',
'Skill updated': '已更新技能',
...
'Solution added': '已添加解决方案',
'Solution deleted': '已删除解决方案',
'Solution updated': '已更新解决方案',
'Solution': '解决方案',
'Solutions': '解决方案',
'Some': '一些',
...
'Staff Type added': '已添加工作人员类型',
'Staff Type deleted': '已删除工作人员类型',
'Staff Type updated': '已更新工作人员类型',
'Staff Types': '工作人员类型',
'Staff and Volunteers': '工作人员和志愿者',
'Staff member added': '已工作人员成员',
...
'Stationery': '信纸',
'Status Report': '状态报告',
'Status Updated': '已更新状态',
'Status added': '已添加状态',
'Status deleted': '已删除状态',
...
'Subscription added': '已添加订阅',
'Subscription deleted': '已删除订阅',
'Subscription updated': '已更新订阅',
'Subscriptions': '订阅',
'Subsector Details': '部门详细信息',
'Subsector added': '添加分组',
'Subsector deleted': '已删除界别',
'Subsector updated': '已更新界别',
'Subsector': '分组',
'Subsectors': '部门',
'Subsistence Cost': '生活费成本',
'Suburb': '郊区',
'Suggest not changing this field unless you know what you are doing.': '建议不要更改此字段,除非您确定您所做的。',
...
'Survey Answer added': '已添加调查回答',
'Survey Answer deleted': '已删除调查回答',
'Survey Answer updated': '已更新调查回答',
'Survey Answer': '调查回答',
'Survey Module': '调查模块',
'Survey Name': '调查名称',
'Survey Question Details': '调查问题详细信息',
'Survey Question Display Name': '调查问题显示名称',
'Survey Question added': '已添加调查问题',
'Survey Question deleted': '已删除调查问题',
'Survey Question updated': '已更新调查问题',
'Survey Question': '调查问题',
'Survey Series Details': '调查系列详细信息',
'Survey Series Name': '调查系列名称',
'Survey Series added': '已添加调查系列',
'Survey Series deleted': '已删除调查系列',
'Survey Series updated': '已更新调查系列',
'Survey Series': '调查系列',
'Survey Template Details': '调查模板详细信息',
'Survey Template added': '已添加调查模板',
'Survey Template deleted': '已删除调查模板',
'Survey Template updated': '已更新调查模板',
...
'Synchronization settings updated': '已更新同步设置',
'Synchronization': '同步',
'Syncronisation History': '同步历史',
'Tags': '标记',
'Take shelter in place or per <instruction>': '采取住房,或每条指令',
'Task Details': '任务详细信息',
'Task List': '任务列表',
'Task Status': '任务状态',
'Task added': '已添加任务',
...
'The Author of this Document (optional)': '这份文件的作者(可选)',
...
'The URL for the GetCapabilities page of a Web Map Service (WMS) whose layers you want available via the Browser panel on the Map.': '的URL GetCapabilities的Web页面地图服务(WMS)层您希望可以通过浏览器"面板上的地图。',
...
'The list of Brands are maintained by the Administrators.': '管理员所维护品牌的列表',
'The list of Catalogs are maintained by the Administrators.': '管理员所维护目录的列表',
...
'The name to be used when calling for or directly addressing the person (optional).': '当调用或直接处理的人要使用的名称(可选)。',
...
'The number of tiles around the visible map to download. Zero means that the 1st page loads faster, higher numbers mean subsequent panning is faster.': '数目的平铺在可见地图到下载。 〇,表示装入页面第1更快,更高数字表示的移动快。',
...
'Ticket ID': '凭单标识',
'Ticket added': '已添加票据',
'Ticket deleted': '已删除票据',
'Ticket updated': '已更新票据',
'Ticket': '凭单',
...
'Training added': '已添加培训',
'Training deleted': '已删除培训',
'Training updated': '已更新培训',
'Training': '培训',
'Trainings': '训练',
'Transit Status': '中转状态',
'Transit': '中转',
...
'Upload an image file (bmp, gif, jpeg or png), max. 300x300 pixels!': '上传图像文件(BMP, GIF, JPEG, PNG),最大 300x300像素!',
'Upload an image file here.': '在这里上传图像文件。',
'Upload an image, such as a photo': '上传图像,例如一张照片',
'Urban Fire': '城市消防',
'Urban area': '都市区域',
'Urdu': '乌尔都语',
'Urgent': '紧急',
...
'Volunteer added': '已添加志愿者',
'Volunteer availability added': '已添加可用志愿者',
'Volunteer availability deleted': '已删除可用志愿者',
'Volunteer availability updated': '已更新可用志愿者',
'Volunteer deleted': '已删除志愿者',
'Volunteer details updated': '志愿者详细更新',
'Volunteers were notified!': '志愿者已经被通知了!',
'Volunteers': '志愿者',
'Vote': '票数',
'Votes': '票数',
'WASH': '洗涤',
...
'Warehouse added': '已添加仓库',
'Warehouse deleted': '已删除仓库',
'Warehouse updated': '已更新仓库',
'Warehouse': '仓库',
'Warehouses': '仓库',
...
'Whiskers': '晶须',
'Who is doing what and where': '他在何处做什么',
'Who usually collects water for the family?': '谁通常为家收集水?',
'Width (m)': '宽度(米)',
'Wild Fire': '野火',
'Wind Chill': '寒风',
'Window frame': '窗框',
...
'You can click on the map below to select the Lat/Lon fields': '您可以单击以下地图选择经纬度字段',
...
'You have a personal map configuration. To change your personal configuration, click': '您有一个个人地图配置。 要更改您的个人配置,请单击',
'You have found a dead body?': '您找到了一具尸体?',
...
'an individual/team to do in 1-2 days': '一个个人/小组在1到2天',
'assigned': '指派',
'average': '平均值',
'black': '黑色',
'blond': '金发',
