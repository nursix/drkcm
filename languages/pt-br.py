...
'Commit Date': 'Data de Compromisso',
...
'Edit Camp Type': 'Editar Tipo de Acampamento',
...
'Edit Office': 'Editar Escritório',
'Edit Options': 'Editar Opções',
'Edit Organization': 'Editar Organizar',
'Edit Parameters': 'Editar Parametros',
'Edit Peer Details': 'Editar Detalhes do Par',
...
'Group description': 'Descrição do Grupo',
'Group updated': 'Grupo atualizadoO',
'Group': 'Grupo',
...
'If you would like to help, then please %(sign_up_now)s': 'Se você gostaria de ajudar, então por favor %(sign_up_now)s',
...
'Latitude %(lat)s is invalid, should be between %(lat_min)s & %(lat_max)s': 'Latitude %(lat)s é inválido, deve estar entre %(lat_min)s & %(lat_max)s',
...
'Latitude of Map Center': 'Latitude do Centro do Mapa',
...
'Longitude %(lon)s is invalid, should be between %(lon_min)s & %(lon_max)s': 'Longitude %(lon)s é inválido, deve estar entre %(lon_min)s & %(lon_max)s',
...
'Nutrition': 'Nutrição',
'OR Reason': 'Razão OE',
'OR Status Reason': 'Razão do status OR',
'OR Status': 'Status OR',
...
'Offices': 'Escritórios',
'Official Volunteer List': 'Lista Oficial de Voluntários',
...
'Powered by Sahana': 'Desenvolvido pela Sahana',
...
'Red Cross / Red Crescent': 'Cruz Vermelha / Crescente Vermelho',
'Red': 'Vermelho',
...
'Register for Account': 'Registrar-se',
'Register them as a volunteer': 'Registrá-los como voluntários',
'Register': 'Registro',
'Registered People': 'Pessoas Registradas',
'Registered users can %(login)s to access the system': 'Os usuários registrados podem fazer %(login)s para acessar o sistema',
...
'Satellite Office': 'Escritório Satélite',
'Satellite': 'Satélite',
'Saturday': 'Sábado',
'Save': 'Armazenar',
'Saved.': 'Armazenado.',
...
'Sector added': 'Setor incluído',
'Sector deleted': 'Setor apagado',
...
'Shelter Type Details': 'Detalhes do Tipo de Abrigo',
'Shelter Type added': 'Tipo de Abrigo incluído',
'Shelter Type deleted': 'Tipo de Abrigo excluído',
'Shelter Type updated': 'Tipo de Abrigo atualização',
...
'Situation Awareness': 'Reconhecimento da situação',
'Situation': 'Situação',
'Sketch': 'Esboço',
...
'Warehouse added': 'Armazém incluído',
'Warehouse deleted': 'Armazém apagado',
'Warehouse updated': 'Armazém atualazido',
'Warehouse': 'Armazém',
'Warehouses': 'Armazéns',
...
'You must enter a minimum of %d characters': 'Deve conter no mínimo %d caracteres',
