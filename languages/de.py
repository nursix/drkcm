...
'%(disease)s Test Stations': '%(disease)s Teststellen',
...
'%(number)s already closed': '%(number)s bereits abgeschlossen',
'%(number)s already done': '%(number)s bereits erledigt',
'%(number)s appointments closed': '%(number)s Termine abgeschlossen',
'%(number)s cases closed': '%(number)s Fälle abgeschlossen',
'%(number)s failed': '%(number)s fehlgeschlagen',
...
'%(number)s recipients removed': '%(number)s Empfänger gelöscht',
'%(number)s records updated': '%(number)s Datensätze aktualisiert',
'%(number)s residents checked-out': '%(number)s Bewohner ausgecheckt',
...
'A unique code for this demographic': 'Ein eindeutiger Code für diese Bevölkerungsruppe',
'A unique code for this event type': 'Ein eindeutiger Code für diesen Ereignistyp',
'A unique code for this type': 'Ein eindeutiger Code für diesen Typ',
...
'About Us': 'Über uns',
'About': 'Über',
'Absence registered':'Abwesenheit registriert',
'Absent##presence': 'Abwesend',
...
'Activity Type added': 'Aktivitätstyp hinzugefügt',
'Activity Type deleted': 'Aktivitätstyp gelöscht',
'Activity Type updated': 'Activitätstyp aktualisiert',
'Activity Type': 'Aktivitätstyp',
'Activity Types': 'Aktivitätstypen',
'Activity Updated': 'Aktivität aktualisiert',
'Activity added': 'Aktivität hinzugefügt',
'Activity deleted': 'Aktivität gelöscht',
'Activity ended before that date': 'Aktivität endet vor diesem Datum',
'Activity started only after that date': 'Aktivität startet erst nach diesem Datum',
'Activity updated': 'Aktivität aktualisiert',
'Activity': 'Aktivität',
...
'Add Beneficiary': 'Leistungsempfänger hinzufügen',
...
'Add Counseling Reason': 'Beratungsgrund hinzufügen',
'Add Credential': 'Qualifikation hinzufügen',
'Add Credentials': 'Qualifikationen hinzufügen',
'Add Demographic': 'Demographische Gruppe hinzufügen',
'Add Disaster Victims': 'Katastrophenopfer hinzufügen',
'Add Distribution.': 'Austeilung hinzufügen.',
...
'Add Identity Document': 'Ausweisdokument hinzufügen',
...
'Add Population Type': 'Bewohnertyp hinzufügen',
...
'Add Service Contact': 'Leistungsträger hinzufügen',
...
'Add Testing Device': 'Testgerät hinzufügen',
...
'Add Vulnerability': 'Vulnerabilität hinzufügen',
...
'Add a new skill type to the catalog.': 'Neuen Fähigkeitstyp zum Katalog hinzufügen.',
'Add document': 'Dokument hinzufügen',
...
'Admin': 'Administrator',
'Administration##authority': 'Verwaltung',
...
'All Task Lists': 'Alle Aufgabenlisten',
...
'All': 'Alle',
'Allocable Capacity': 'Belegbare Kapazität',
'Allocable##shelter': 'Belegbar',
'Allocate Group': 'Gruppe zuweisen',
'Allow registration for family members': 'Registrierung für Familienmitglieder zulässig',
'Allow registration of the same event for multiple family members with a single ID': 'Ereignis darf für mehrere Familienmitglieder über eine einzige ID registriert werden',
...
'Approval History': 'Freigabehistorie',
...
'Are you sure you want to check-out the selected residents?': 'Sind Sie sicher dass Sie die ausgewählten Bewohner auschecken wollen?',
...
'Are you sure you want to mark these appointments as completed?': 'Sind Sie sicher dass Sie diese Termine als erledigt markieren wollen?',
'Areas inspected': 'Untersuchte Gebiete',
'Argentina': 'Argentinien',
'Armenia': 'Armenien',
'Armenian': 'Armenisch',
'Aromanian; Arumanian; Macedo-Romanian': 'Aromunisch, Makedoromanisch',
'Arrival': 'Ankunft',
'Arrivals and Departures##shelter': 'Zugänge und Abgänge',
'Arrivals##shelter': 'Zugänge',
'Arrived': 'Angekommen',
...
'Assign recipients from distribution list': 'Empfänger nach Verteilerliste zuweisen',
'Assign recipients from distribution list?': 'Empfänger nach Verteilerliste zuweisen?',
'Assign recipients': 'Empfänger zuweisen',
...
'Asturian; Bable; Leonese; Asturleonese': 'Asturisch',
...
'Available##disposable': 'Frei verfügbar',
'Available': 'Verfügbar',
'Avalanche': 'Lawine',
'Avaric': 'Awarisch',
...
'Beja; Bedawiyet': 'Bedscha',
'Belarus': 'Weißrussland',
'Belarusian': 'Belarussisch',
'Belgium': 'Belgien',
'Below ground level': 'Unter dem Erdgeschoss',
'Beneficiaries': 'Leistungsempfänger',
'Beneficiary Date of Birth': 'Geburtsdatum des Leistungsempfängers',
'Beneficiary Details': 'Details zum Leistungsempfänger',
'Beneficiary Type': 'Typ des Leistungsempfängers',
'Beneficiary added': 'Leistungsempfänger hinzugefügt',
'Beneficiary deleted': 'Leistungsempfänger gelöscht',
'Beneficiary updated': 'Leistungsempfänger aktualisiert',
'Beneficiary': 'Leistungsempfänger',
'Beneficiary/Representative Date of Birth': 'Geburtsdatum des Leistungsempfängers/Vertreters',
...
'Body': 'Body',
'Bokmål, Norwegian; Norwegian Bokmål': 'Bokmål',
'Bolivia': 'Bolivien',
...
'Calculated Allocable Capacity': 'Berechnete belegbare Kapazität',
'Calculated total number of allocable places (by quota)': 'Berechnete Gesamtzahl belegbarer Plätze (nach Quote)',
'Calendar': 'Kalender',
'Cambodia': 'Kambodscha',
'Cameroon': 'Kamerun',
...
'Cancelled by requesting organization or volunteer': 'Abgesagt durch anfragende Organisation oder Freiwilligen',
...
'Capacity evaluated adding all defined housing unit capacities': 'Die Kapazität der Unterkunft wurde ermittelt aus der Summe der Kapazität der einzelnen Wohneinheiten',
'Capacity of the housing unit for people who need to stay both day and night': 'Kapazität der Wohneinheit für Personen die tags und nachts dort untergebracht sind',
'Capacity of the shelter as a number of people': 'Kapazität der Unterkunft als Anzahl von Personen',
'Capacity': 'Kapazität',
'Cape Verde': 'Kap Verde',
'Capture Image from Video': 'Bild vom Video aufnehmen',
...
'Case Flags Debarring': 'Ausschließende Flaggen',
'Case Flags Required': 'Erforderliche Flaggen',
...
'Catalog Item restored': 'Katalogeintrag wiederhergestellt',
'Catalog Item updated': 'Katalogeintrag aktualisiert',
'Catalog Items': 'Katalogeinträge',
...
'Chad': 'Tschad',
'Change (%(days)s Days)': 'Veränderung (%(days)s Tage)',
...
'Closure Status': 'Abschluss-Status',
'Clothing': 'Kleidung',
...
'Compose and Send': 'Erstellen und Verschicken',
'Compose': 'Erstellen',
...
'Contact Email': 'Emailadresse des Ansprechpartners',
...
'Contact information added': 'Kontaktinformationen hinzugefügt',
'Contact information deleted': 'Kontaktinformationen gelöscht',
'Contact information incomplete: email address and/or phone number required': 'Kontaktinformationen unvollstandig: Emailadresse und/oder Telefonnummer erforderlich',
...
'Create Commission': 'Beauftragung anlegen',
...
'Create Dead Body Report': 'Leichenfund-Meldung erstellen',
...
'Create Distribution Item Set': 'Artikelsatz anlegen',
...
'Create Housing Unit': 'Wohneinheit anlegen',
...
'Create Skill Type': 'Fähigkeitstyp anlegen',
...
'Create Task List': 'Aufgabenliste anlegen',
...
'Create Vulnerability Type': 'Vulnerabilitätstyp anlegen',
...
'Create automatically': 'Automatisch anlegen',
'Create new Offer': 'Neues Angebot erstellen',
'Create saved filters for possible recipients to be able to select them here': 'Erstellen Sie gespeicherte Filter für mögliche Empfänger um diese hier auswählen zu können',
'Create': 'Anlegen',
...
'Credit##fin': 'Guthaben',
'Creek': 'Muskogee-Sprachen',
'Crime': 'Kriminalität',
'Crimean Tatar; Crimean Turkish': 'Krimtatarisch',
'Criminal Record Certificate': 'Polizeiliches Führungszeugnis',
...
'Current Capacities and Occupancy': 'Aktuelle Kapazitäten und Belegung',
...
'Current residents only': 'Nur aktuelle Bewohner',
'Current response': 'Aktuelle Antwort',
'Current session': 'Aktuelle Sitzung',
'Current shelter population as number of people': 'Aktuelle Unterkunftsbelegung als Anzahl Personen',
'Current': 'Aktuell',
...
'Dargwa': 'Darginisch',
'Dashboard': 'Dashboard',
'Data Inquiry on Testing in Daycare Centers': 'Datenerhebung zur Testung in Kindertagesstätten',
'Data Source': 'Datenquelle',
'Data incomplete (%(details)s)': 'Daten unvollständig (%(details)s)',
'Data uploaded': 'Daten hochgeladen',
'Data': 'Daten',
'Data/documentation complete': 'Angaben / Dokumentation vollständig',
'Database': 'Datenbank',
...
'Date interval overlaps existing commission': 'Zeitraum überlappt bestehende Beauftragung',
...
'Date not registered': 'Datum nicht registriert',
...
'Day': 'Tag',
'Daycare Testing': 'Testen in Kitas',
...
'Dead Body Reports': 'Leichenfund-Meldungen',
'Dead Body': 'Leiche',
'Dead body report added': 'Leichenfund-Meldung hinzugefügt',
'Dead body report deleted': 'Leichenfund-Meldung gelöscht',
'Dead body report updated': 'Leichenfund-Meldung aktualisiert',
...
'Defect created': 'Mangel angelegt',
'Defect deleted': 'Mangel gelöscht',
'Defect found': 'Festgesteller Mangel',
'Defect updated': 'Mangel aktualisiert',
'Defect': 'Mangel',
'Defects': 'Mängel',
...
'Delete Beneficiary': 'Leistungsempfänger löschen',
...
'Delete Commission': 'Beauftragung löschen',
...
'Delete Demographic': 'Demographische Gruppe löschen',
...
'Delete Distribution Item Set': 'Artikelsatz löschen',
'Delete Distribution': 'Austeilung löschen',
...
'Delete Newsletter': 'Rundschreiben löschen',
...
'Delete Participant': 'Teilnehmer löschen',
...
'Delete Population Type': 'Bewohnertyp löschen',
...
'Delete Skill Type': 'Fähigkeitstyp löschen',
...
'Delete Testing Device': 'Testgerät löschen',
...
'Delete Vulnerability Type': 'Vulnerabilitätstyp löschen',
'Delete Vulnerability': 'Vulnerabilität löschen',
'Delete Warehouse Type': 'Warenlagertyp löschen',
'Delete Warehouse': 'Warenlager löschen',
'Delete from Server?': 'Vom Server löschen?',
'Delete saved filter': 'Filter löschen',
...
'Demographic Details': 'Details zur demographischen Gruppe',
'Demographic added': 'Demographische Gruppe hinzugefügt',
'Demographic deleted': 'Demographische Gruppe gelöscht',
'Demographic updated': 'Demographische Gruppe aktualisiert',
'Demographic': 'Demografische Gruppe',
'Demographics': 'Demographische Gruppen',
...
'Departure': 'Abreise',
'Departures##shelter': 'Abgänge',
'Departures': 'Abgänge',
'Dependency': 'Abhängigkeit',
'Dependent Person': 'Abhängige Person',
'Deployed until': 'Eingesetzt bis',
'Deploying Organization': 'Einsetzende Organisation',
...
'Distribution Item Set deleted': 'Ausgabeartikelsatz gelöscht',
'Distribution Item Set updated': 'Ausgabeartikelsatz aktualisiert',
'Distribution Item Set': 'Ausgabeartikelsatz',
'Distribution Item Sets': 'Ausgabeartikelsätze',
'Distribution center no longer active': 'Verteilungszentrum nicht mehr aktiv',
'Distribution deleted': 'Austeilung gelöscht',
'Distribution groups': 'Verteilergruppen',
'Distribution item set "%(name)s" already exists': 'Artikelsatz "%(name)s" existiert bereits',
'Distribution of "%(set)s" already registered %(number)s times today': 'Austeilung von "%(set)s" heute bereits %(number)s mal registriert',
'Distribution of "%(set)s" already registered on %(timestamp)s': 'Austeilung von "%(set)s" bereits registriert am %(timestamp)s',
'Distribution of "%(set)s" already registered today': 'Austeilung von "%(set)s" heute bereits registriert',
'Distribution of "%(set)s" currently not permitted for this beneficiary': 'Austeilung von "%(set)s" nicht gestattet für diesen Empfänger',
'Distribution of Clients': 'Verteilung der Klienten',
'Distribution registered': 'Austeilung registriert',
'Distribution requires that the person is checked-in at a shelter': 'Austeilung erfordert dass der Empfänger in einer Unterkunft eingecheckt ist',
'Distribution updated': 'Austeilung aktualisiert',
'Distribution##list': 'Verteiler',
'Distribution': 'Austeilung',
'Distributions': 'Austeilungen',
...
'Do you test in daycare centers on a regular basis?': 'Testen Sie regelmässig in Kindertagesstätten?',
...
'Do you want to check-out these residents?': 'Wollen Sie diese Bewohner auschecken?',
...
'Documentation / Verification': 'Dokumentation / Prüfung',
'Documentation Status': 'Dokumentationstatus',
'Documentation incomplete': 'Dokumentation unvollständig',
'Documentation': 'Dokumentation',
'Documentation/Verification incomplete': 'Dokumentation/Verifizierung unvollständig',
...
'Does your organization conduct tests in daycare centers?': 'Führt Ihre Organisation Tests in Kindertagesstätten durch?',
...
'Dutch; Flemish': 'Niederländisch, Belgisches Niederländisch',
'Dwelling': 'Wohnstätte',
'Dyula': 'Dioula',
'EA Arrival': 'EA Ankunft',
...
'Earthquake': 'Erdbeben',
'Eastern Frisian': 'Ostfriesisches Platt',
...
'Edit Activity Type': 'Aktivitätstyp bearbeiten',
...
'Edit Beneficiary': 'Leistungsempfänger bearbeiten',
...
'Edit Commission': 'Beauftragung bearbeiten',
...
'Edit Defect': 'Mangel bearbeiten',
'Edit Demographic': 'Demographische Gruppe bearbeiten',
...
'Edit Distribution Item Set': 'Artikelsatz bearbeiten',
'Edit Distribution': 'Austeilung bearbeiten',
...
'Edit Newsletter': 'Rundschreiben bearbeiten',
...
'Edit Population Type': 'Bewohnertyp bearbeiten',
...
'Edit Shelter Status': 'Unterkunftstatus bearbeiten',
'Edit Shelter Type': 'Unterkunftstyp bearbeiten',
...
'Edit Testing Device': 'Testgerät bearbeiten',
...
'Edit Verification Details': 'Verifizierungsdetails bearbeiten',
...
'Edit Vulnerability Type': 'Vulnerabilitätstyp bearbeiten',
'Edit Vulnerability': 'Vulnerabilität bearbeiten',
...
'Enabled?': 'Aktiviert?',
'End Date': 'Enddatum',
'End date must be after start date': 'Enddatum muss nach dem Anfangsdatum liegen',
...
'Enter a number between %(min)g and %(max)g': 'Geben Sie eine Zahl zwischen %(min)g und %(max)g ein',
'Enter a number greater than or equal to %(min)g': 'Geben Sie eine Zahl ein (Minimum %(min)g)',
'Enter a number less than or equal to %(max)g': 'Geben Sie eine Zahl ein (Maximum %(max)g)',
'Enter a title...': 'Name eingeben...',
...
'Enter an integer between %(min)g and %(max)g': 'Geben Sie eine ganze Zahl zwischen %(min)g und %(max)g ein',
'Enter an integer greater than or equal to %(min)g': 'Geben Sie eine ganze Zahl ein (Minimum %(min)g)',
'Enter an integer less than or equal to %(max)g': 'Geben Sie eine ganze Zahl ein (Maximum %(max)g)',
'Enter from %(min)g to %(max)g characters': 'Geben Sie zwischen %(min)g und %(max)g Zeichen ein',
'Enter or scan ID': 'ID eingeben/scannen',
'Enter or scan an ID': 'ID eingeben oder scannen',
...
'Enter the number of beneficiaries (max %(max)s)': 'Geben Sie die Anzahl der Leistungsempfänger ein (max. %(max)s)',
...
'Error registering shelter inspection': 'Fehler bei der Registrierung der Unterkunftsinspektion',
'Error': 'Fehler',
'Errors': 'Fehler',
'Erzya': 'Ersjanisch, Ersja-Mordwinisch',
'Escort': 'Begleitung',
...
'Event registration failed': 'Ereignisregistrierung fehlgeschlagen',
'Event updated': 'Ereignis aktualisiert',
'Event': 'Ereignis',
'Events that exclude registration of this event type on the same day': 'Ereignisse die die Registrierung dieses Ereignistyps am selben Tag ausschließen',
'Events': 'Ereignisse',
...
'Facility removed from public registry (%(reason)s)': 'Einrichtung aus dem öffentlichen Verzeichnis entfernt (%(reason)s)',
...
'France': 'Frankreich',
'Free Allocable Capacity': 'Freie belegbare Kapazität',
...
'GU Done': 'GU erledigt',
'Gabon': 'Gabon',
'Gaelic; Scottish Gaelic': 'Schottisch-gälisch',
'Galibi Carib': 'Karib',
'Galician': 'Galicisch, Galegisch',
'Ganda': 'Luganda',
...
'Generate registration card': 'Registrierungskarte erstellen',
...
'Gilbertese': 'Kiribatisch, Gilbertesisch',
...
'Haitian; Haitian Creole': 'Haitianisch-Kreolisch',
...
'Housing Unit Capacity': 'Maximale Belegungzahl für Wohneinheit',
'Housing Unit Day and Night Capacity': 'Maximale Tag und Nacht Belegungszahl für Wohneinheit',
'Housing Unit Details': 'Details zur Wohneinheit',
'Housing Unit Name': 'Name der Wohneinheit',
'Housing Unit added': 'Wohneinheit hinzugefügt',
'Housing Unit deleted': 'Wohneinheit gelöscht',
'Housing Unit updated': 'Wohneinheit aktualisiert',
'Housing Unit': 'Wohneinheit',
'Housing Units': 'Wohneinheiten',
'How does it work?': 'Wie funktioniert das?',
'How frequently do you test in daycare centers?': 'Wie oft testen Sie in Kindertagesstätten?',
...
'How many daycare centers are regularly serviced by your organization?': 'In wievielen Kitas testen Sie regelmässig?',
...
'Identity Document added': 'Ausweisdokument hinzugefügt',
'Identity Document deleted': 'Ausweisdokument gelöscht',
'Identity Document updated': 'Ausweisdokument aktualisiert',
...
'Import Catalog Items': 'Importiere Katalogeinträge',
...
'In hours, or formatted like 1h10min, 15min, 0:45...': 'Angabe in Stunden, oder formatiert wie 1h10min, 15min, 0:45...',
...
'Integrated bath within housing unit': 'Bad in der Wohneinheit vorhanden',
'Integrated shower within housing unit': 'Dusche in der Wohneinheit vorhanden',
...
'Invalid Beneficiary ID': 'Ungültige Empfänger ID',
'Invalid Case': 'Ungültiger Fall',
'Invalid Cases': 'Ungültige Fälle',
'Invalid Distribution Item Set': 'Ungültiger Artikelsatz',
...
'Invalid event type': 'Ungültiger Ereignistyp',
'Invalid event type: %s': 'Ungültiger Ereignistyp: %s',
'Invalid request!': 'Ungültige Anfrage!',
'Invalid status past end date': 'Ungültiger Status nach dem Enddatum',
...
'Invite Organization': 'Organisation einladen',
'Invite': 'Einladen',
...
'Item already registered for this set': 'Artikel ist in diesem Artikelsatz bereits vorhanden',
...
'Kabardian': 'Kabardinisch, Ost-Tscherkessisch',
'Kabyle': 'Kabylisch',
'Kachin; Jingpho': 'Jingpo',
'Kalaallisut; Greenlandic': 'Grönländisch, Kalaallisut',
'Kalmyk; Oirat': 'Kalmückisch',
'Kamba': 'Kikamba',
'Kara-Kalpak': 'Karakalpakisch',
'Karachay-Balkar': 'Karatschai-balkarisch',
'Karelian': 'Karelisch',
...
'Limburgan; Limburger; Limburgish': 'Limburgisch, Südniederfränkisch',
...
'List Activity Types': 'Liste Aktivitätstypen',
...
'List Beneficiaries': 'Liste Leistungsempfänger',
...
'List Commissions': 'Liste Beauftragungen',
...
'List Consent': 'Liste Einwilligungen',
...
'List Demographics': 'Liste Demographische Gruppen',
...
'List Housing Units': 'Liste Wohneinheiten',
'List Human Resources': 'Liste der personellen Ressourcen',
'List Identity Documents': 'Liste Ausweisdokumente',
...
'List Newsletters': 'Liste Rundschreiben',
...
'List Participants': 'Liste Teilnehmer',
...
'List Population Types': 'Liste Bewohnertypen',
...
'List Recipients': 'Liste Empfänger',
...
'List Representatives': 'Liste Vertreter',
...
'List Responses': 'Liste Antworten',
...
'List Shelter Statuses': 'Liste Unterkunftsstatus',
'List Shelter Types': 'Liste Unterkunftstypen',
...
'List Skill Types': 'Liste Fähigkeitstypen',
'List Skills': 'Liste Fähigkeiten',
'List Solutions': 'Liste Lösungen',
'List Staff Members': 'Liste Mitarbeiter',
...
'List Testing Devices': 'Liste Testgeräte',
...
'List Vulnerabilities': 'Liste Vulnerabilitäten',
'List Vulnerability Types': 'Liste Vulnerabilitätstypen',
...
'Login disabled by administrator': 'Benutzerkonto gesperrt',
'Login': 'Anmeldung',
...
'Looting': 'Plünderung',
'Loss##distribution': 'Verlust',
'Lost Password': 'Passwort vergessen',
'Lost': 'Verloren',
'Low German; Low Saxon; German, Low; Saxon, Low': 'Niederdeutsch, Plattdeutsch',
...
'Luxembourgish; Letzeburgesch': 'Luxemburgisch',
'MPAV Qualification verification required': 'Nachweis MPAV-Berechtigung erforderlich',
'MPAV Qualification verification': 'Nachweis MPAV-Berechtigung',
'MPAV Qualification': 'MPAV-Berechtigung',
'Macedonian': 'Mazedonisch',
'Madagascar': 'Madagaskar',
'Madurese': 'Maduresisch',
'Magahi': 'Magadhi',
...
'Mark Completed##appointment': 'Als erledigt markieren',
...
'Maximum number of distributions per client and day': 'Maximale Anzahl von Austeilung pro Empfänger und Tag',
...
'Member Organizations': 'Mitgliederorganisationen',
...
'Minimum time interval between two consecutive distributions to the same client': 'Mindestwartezeit zwischen zwei aufeinanderfolgenden Austeilungen an denselben Empfänger',
...
'More details required': 'Genauere Angaben erforderlich',
'More than': 'Mehr als',
'More': 'Mehr',
...
'Natural Persons': 'Natürliche Personen',
...
'Neither currently a resident nor active staff member': 'Weder aktueller Bewohner noch Mitarbeiter',
...
'New Documents Available': 'Neue Dokumente verfügbar',
...
'New registration card registered': 'Neue Registrierungskarte registriert',
'New registration': 'Neuregistrierung',
'New': 'Neu',
'Newsletter Details': 'Details zum Rundschreiben',
'Newsletter Inbox': 'Eingegangene Rundschreiben',
'Newsletter created': 'Rundschreiben erstellt',
'Newsletter deleted': 'Rundschreiben gelöscht',
'Newsletter sent': 'Rundschreiben verschickt',
'Newsletter updated': 'Rundschreiben aktualisiert',
'Newsletter': 'Rundschreiben',
'Newsletters': 'Rundschreiben',
...
'No Activity Types currently defined': 'Zurzeit keine Aktivitätstypen definiert',
'No Alternative Items currently registered': 'Zurzeit sind keine alternativen Artikel registriert',
'No Approval Statuses currently registered': 'Zurzeit keine Freigaben registriert',
...
'No Beneficiaries currently registered': 'Zurzeit keine Leistungsempfänger registriert',
...
'No Commissions currently registered': 'Zurzeit keine Beauftragungen registriert',
...
'No Consent currently registered': 'Zurzeit keine Einwilligungen registriert',
...
'No Defects currently registered': 'Zurzeit keine Mängel registriert',
'No Demographics currently defined': 'Zurzeit keine demographischen Gruppen definiert',
...
'No Distribution Item Sets currently registered': 'Zurzeit keine Ausgabeartikelsätze registriert',
'No Distributions currently registered': 'Zurzeit keine Austeilungen registriert',
...
'No Housing Units currently registered': 'Zurzeit keine Wohneinheiten registriert',
...
'No Identity Documents currently registered': 'Zurzeit sind keine Ausweisdokumente registriert',
'No Image': 'Kein Bild',
...
'No Issues currently registered': 'Zurzeit keine Vorgänge registriert',
...
'No Newsletters currently registered': 'Zurzeit keine Rundschreiben registriert',
...
'No Participants currently registered': 'Zurzeit keine Teilnehmer registriert',
...
'No Population Types currently defined': 'Zurzeit keine Bewohnertypen definiert',
...
'No Recipients assigned': 'Keine Empfänger zugewiesen',
'No Recipients currently registered': 'Zurzeit keine Empfänger registriert',
...
'No Responses currently registered': 'Zurzeit keine Antworten registriert',
...
'No Shelter Flags currently defined': 'Zurzeit keine Unterkunftsflaggen definiert',
'No Shelter Inspections currently registered': 'Zurzeit keine Unterkunftsinspektionen registriert',
'No Shelter Services currently registered': 'Zurzeit sind keine Unterkunftsleistungen registriert',
'No Shelter Statuses currently registered': 'Zurzeit keine Unterkunftsstatus registriert',
...
'No Task Lists found': 'Keine Aufgabenlisten gefunden',
...
'No Testing Devices currently registered': 'Zurzeit keine Testgeräte registriert',
...
'No Vulnerabilities currently registered': 'Zurzeit keine Vulnerabilitäten registriert',
'No Vulnerability Types currently defined': 'Zurzeit keine Vulnerabilitätstypen definiert',
...
'No dead body reports available': 'Keine Leichenfund-Meldungen verfügbar',
'No distribution item sets available': 'Keine Artikelsätze verfügbar',
...
'No image was specified!': 'Es wurde kein Bild angegeben',
...
'No longer relevant': 'Trifft nicht mehr zu',
...
'No new recipients found': 'Keine weiteren Empfänger gefunden',
...
'No profile picture available for this person': 'Kein Profilbild für diese Person verfügbar',
'No recipients assigned': 'Keine Empfänger zugewiesen',
...
'No shelter unit selected': 'Keine Wohneinheit ausgewählt',
...
'Non-allocable##shelter': 'Nicht belegbar',
...
'Not Present##presence': 'Nicht Anwesend',
...
'Number of Beneficiaries': 'Anzahl Leistungsempfänger',
...
'Number of Daycare Centers': 'Anzahl Kitas',
...
'Number of Reports': 'Anzahl Berichte',
...
'Number of places that are not currently allocable, e.g. due to technical issues, maintenance or closed groups': 'Anzahl von Plätzen die zur Zeit nicht belegt werden können, z.B. wegen technischer Mängel, Wartungsarbeiten oder geschlossener Gruppen',
...
'Occasion': 'Anlass',
'Occitan (post 1500); Provençal': 'Okzitanisch',
'Occupancy % (Average)': 'Belegung % (Durchschnitt)',
'Occupancy %': 'Belegung %',
'Occupancy Data': 'Belegungszahlen',
'Occupancy Development': 'Entwicklung der Belegungszahlen',
...
'Organization Groups': 'Organisationsgruppen',
...
'Organization Type verification required': 'Nachweis Organisationstyp erforderlich',
'Organization Type verification': 'Nachweis Organisationstyp',
...
'Organization not verified': 'Organisation nicht verifiziert',
...
'Other Details': 'Sonstige Angaben',
...
'Parsers': 'Parser',
'Partial': 'Teil',
'Participant Details': 'Details zum Teilnehmer',
'Participant added': 'Teilnehmer hinzugefügt',
'Participant deleted': 'Teilnehmer gelöscht',
'Participant updated': 'Teilnehmer aktualisiert',
...
'Pedi; Sepedi; Northern Sotho': 'Nord-Sotho',
...
'Person currently reported as absent': 'Person ist nicht anwesend gemeldet',
'Person deleted': 'Person gelöscht',
'Person details incomplete: date of birth required': 'Personendaten unvollständig: Geburtsdatum erforderlich',
...
'Person not permitted to enter premises!': 'Person darf das Gelände nicht betreten!',
'Person not permitted to leave premises!': 'Person darf das Gelände nicht verlassen!',
...
'Person was already registered as absent': 'Person war bereits als abwesend gemeldet',
'Person was already registered as present': 'Person war bereits als anwesend gemeldet',
...
'Please select a distribution item set': 'Bitte wählen Sie einen Artikelsatz',
...
'Please select an organization': 'Bitte wählen Sie eine Organisation',
...
'Poor': 'Arm',
'Population (Adults)': 'Belegung (Erwachsene)',
'Population (Children)': 'Belegung (Kinder)',
'Population (Day)': 'Belegungszahl (Tag)',
'Population (Minors)': 'Belegung (Minderjährige)',
...
'Population Type Details': 'Details zum Bewohnertyp',
'Population Type added': 'Bewohnertyp hinzugefügt',
'Population Type deleted': 'Bewohnertyp gelöscht',
'Population Type updated': 'Bewohnertyp aktualisiert',
'Population Type': 'Bewohnertyp',
'Population Types': 'Bewohnertypen',
'Population and number of households': 'Bevölkerungs- und Haushaltsanzahl',
'Population##shelter': 'Belegung',
'Population': 'Belegung',
...
'Presence Registration': 'Anwesenheitsregistrierung',
'Presence Report': 'Anwesenheitsbericht',
'Presence in the shelter': 'Anwesend in Unterkunft',
'Presence registered': 'Anwesenheit registriert',
'Presence required': 'Anwesenheit erforderlich',
'Presence': 'Anwesenheit',
'Present##presence': 'Anwesend',
'Preview': 'Vorschau',
'Previous Total': 'Vorherige Summe',
'Previous': 'Vorherige',
'Price per Unit': 'Einzelpreis',
'Primary Occupancy': 'Primäre Belegung',
'Principal Ref.No.': 'Auftraggeber Az.',
...
'Provider not currently commissioned': 'Betreiber aktuell nicht beauftragt',
...
'Rarotongan; Cook Islands Maori': 'Rarotonganisch, Māori der Cookinseln',
...
'Reason for unlisting': 'Grund für Nichtlistung',
'Reason must be specified': 'Grund muss angegeben werden',
'Reason required for suspended-status': 'Grund für Aussetzung erforderlich',
'Reason': 'Grund',
...
'Reception Centers Overview': 'Übersicht Erstaufnahmeeinrichtungen',
...
'Recipient list updated': 'Empfängerliste aktualisiert',
'Recipient updated': 'Empfänger aktualisiert',
'Recipient': 'Empfänger',
...
'Reference number to use in communication with the principal client, e.g. %(examples)s': 'Aktenzeichen zur Verwendung bei Kommunikation mit dem Auftraggeber, z.B. %(examples)s',
...
'Register Defect': 'Mangel registrieren',
'Register Distribution': 'Austeilung Registrieren',
...
'Registration Card (system-generated)': 'Registrierungskarte (systemgeneriert)',
'Registration Cards': 'Registrierungskarten',
...
'Registration card invalid': 'Registrierungskarte ungültig',
...
'Registration is currently permitted': 'Austeilung ist aktuell zulässig',
...
'Registration requires that the person is checked-in at a shelter': 'Registrierung erfordert dass die Person in einer Unterkunft eingecheckt ist',
'Registration successful': 'Registrierung erfolgreich',
'Registration updated': 'Anmeldung aktualisiert',
'Registration': 'Registrierung',
'Regular testing': 'Regelmässige Testung',
...
'Remove all assigned recipients?': 'Alle zugewiesenen Empfänger entfernen?',
'Remove all recipients': 'Alle Empfänger entfernen',
'Remove existing data before import': 'Existierende Daten vor dem Import entfernen',
'Remove recipients': 'Empfänger entfernen',
...
'Report for this date exists - please update the existing report instead': 'Meldung für dieses Datum existiert bereits - bitte aktualisieren Sie diese falls erforderlich',
...
'Representative Details': 'Details zum Vertreter',
'Representative Information required': 'Vertreterangaben erforderlich',
'Representative Status': 'Vertreterstatus',
'Representatives Documentation': 'Dokumentation zu Vertretern',
...
'Requested##demand': 'Angefordert',
'Requested': 'Angefragt',
'Requester': 'Anfragender',
'Requesting Organization': 'Anfragende Organisation',
...
'Resident': 'Bewohner',
'Residents Overview': 'Bewohnerübersicht',
...
'Response Details': 'Details zur Antwort',
...
'Response for this organization already registered': 'Antwort für diese Organisation bereits registriert',
...
'Restricts access to this entry (e.g. medical notes are only accessible for medical team)': 'Beschränkt den Zugriff auf diesen Eintrag (z.B. medizinische Notizen nur sichtbar für medizinisches Team)',
...
'Romania': 'Rumänien',
'Romanian; Moldavian; Moldovan': 'Rumänisch',
'Romansh': 'Bündnerromanisch, Romanisch',
'Romany': 'Romani, Romanes',
...
'Save current options as new filter': 'Aktuelle Optionen als neuen Filter speichern',
'Save': 'Speichern',
...
'Scanned Copy': 'Eingescannte Kopie',
...
'Search After Save?': 'Nach dem Speichern durchsuchen?',
'Search Distributions': 'Austeilungen suchen',
'Search Query': 'Suchanfrage',
'Search Results': 'Suchergebnisse',
'Search Staff & Volunteers': 'Mitarbeiter und Freiwillige suchen',
...
'Search for a Project by name, code, location, or description.': 'Projekte nach Name, Code, Ort oder Beschreibung suchen',
'Search for a Project by name, code, or description.': 'Projekte nach Name, Code oder Beschreibung suchen',
...
'Search for an item by Year of Manufacture.': 'Suche Artikel nach Herstellungsjahr',
'Search for an item by brand.': 'Suche Artikel nach Marke',
'Search for an item by catalog.': 'Suche Artikel nach Katalog',
'Search for an item by category.': 'Suche Artikel nach Kategorie',
'Search for an item by its code, name, model and/or comment.': 'Suche Artikel nach Code, Name, Modell und/oder Kommentar',
'Search for an item by text.': 'Suche Artikel über Text.',
'Search for items by donating organization.': 'Suche Artikel nach Spender-Organisation',
'Search for items by owning organization.': 'Suche Artikel nach Eigentümer-Organisation',
...
'Search for office by organization or branch.': 'Suche Geschäftstellen nach Organisation oder Zweigorganisation.',
...
'Self-registration not permitted. Please register with authorized staff at the site.': 'Selbstanmeldung nicht gestattet. Bitte melden Sie sich bei autorisiertem Personal vor Ort an.',
...
'Send this newsletter': 'Dieses Rundschreiben senden',
'Send': 'Senden',
'Sender Email': 'Emailadresse des Absenders',
'Sender': 'Absender',
...
'Shelter Flag': 'Unterkunftsflagge',
...
'Shelter Status Details': 'Details zum Unterkunftsstatus',
...
'Shelter or housing unit required': 'Unterkunft oder Wohneinheit erforderlich',
...
'Sidamo': 'Sidama',
'Sign Languages': 'Gebärdensprache',
...
'Signed form for registration': 'Unterschriebenes Formblatt zur Erfassung',
'Siksika': 'Blackfoot',
'Singapore': 'Singapur',
...
'Sotho, Southern': 'Sesotho, Süd-Sotho',
'Sought': 'Gesucht',
...
'Staff Member deleted': 'Mitarbeiter gelöscht',
...
'Staging Area': 'Sammelbereich',
'Stairs': 'Treppen',
'Standard Moroccan Tamazight': 'Marokkanisches Tamazight',
'Standard quantity must be less than or equal maximum quantity': 'Standardmenge muss kleiner oder gleich der Maximalmenge sein',
...
'Statement on Pending Criminal Proceedings': 'Erklärung zu anhängigen Ermittlungs-/Strafverfahren',
'Stationery': 'Büromaterial',
'Statistic': 'Statistik',
'Statistics': 'Statistiken',
'Status "done" marks the note as final and prevents further modifications': 'Status "fertig" markiert die Notiz als endgültig und verhindert weitere Änderungen.',
'Status Code': 'Statuscode',
'Status Comment': 'Kommentar zum Status',
'Status History': 'Statushistorie',
'Status Reason': 'Grund für Status',
...
'Status updated on': 'Status aktualisiert',
'Status updated': 'Status aktualisiert',
'Status': 'Status',
...
'Subject Group##med': 'Probandengruppe',
'Subject': 'Betreff',
...
'Sweden': 'Schweden',
'Swedish': 'Schwedisch',
'Swiss German; Alemannic; Alsatian': 'Schweizerdeutsch',
...
'Tamashek': 'Tuareg',
'Task Description required': 'Aufgabenbeschreibung erforderlich',
'Task Description': 'Beschreibung der Aufgabe',
'Task Details': 'Details zur Aufgabe',
'Task List added': 'Aufgabenliste hinzugefügt',
'Task List deleted': 'Aufgabenliste gelöscht',
'Task List updated': 'Aufgabenliste aktualisiert',
...
'Testing Device Details': 'Details zum Testgerät',
'Testing Device created': 'Testgerät hinzugefügt',
'Testing Device deleted': 'Testgerät gelöscht',
'Testing Device updated': 'Testgerät aktualisiert',
'Testing Device used': 'Verwendetes Testgerät',
'Testing Devices': 'Testgeräte',
...
'The activity to register participation for with this type of event': 'Die Aktivität für die die Teilnahme mit diesen Ereignistyp registriert wird',
...
'The number of free allocable places': 'Die Anzahl belegbarer freier Plätze',
'The number of free places': 'Die Anzahl freier Plätze',
...
'The organization requesting the delegation': 'Die Organisation die die Delegierung angefragt hat',
...
'The selected appointments will be marked as completed.': 'Die ausgewählten Termine werden als erledigt markiert',
'The selected residents will be checked-out from their shelter.': 'Die ausgewählten Bewohner werden aus ihrer Unterkunft ausgecheckt.',
...
'The total number of allocable places': 'Die Gesamtzahl belegbarer Plätze',
...
'The type of dependency from the rest of the family/household (leave empty for independent adults). Use the comments field to elaborate if required.': 'Die Art der Abhängigkeit von anderen Familien-/Haushaltsmitgliedern (leer lassen für selbständige Erwachsene). Benutzen Sie das Kommentarfeld für genauere Angaben, falls erforderlich.',
...
'There are beneficiaries registered after that date': 'Es wurden Leistungsempfänger nach diesem Daten registriert',
'There are beneficiaries registered before that date': 'Es wurden Leistungsempfänger vor diesem Datum registriert',
...
'This event type can not currently be registered': 'Dieser Ereignistyp kann zurzeit nicht registriert werden',
...
'This organization has been invited before!': 'Diese Organisation wurde bereits eingeladen!',
...
'This unit is for transitory accommodation upon arrival, or buffer in case of capacity excess': 'Diese Einheit dient zur vorübergehenden Unterbringung bei der Ankunft, oder als Puffer im Falle einer Kapazitätsüberschreitung',
...
'Tornado': 'Wirbelsturm',
'Total # of Target Beneficiaries': 'Gesamtzahl der Leistungsempfänger',
...
'Total Beneficiaries': 'Gesamtzahl Leistungsempfänger',
...
'Total Recipients': 'Anzahl Empfänger',
...
'Unapproved##actionable': 'Nicht freigegeben',
...
'Update saved filter': 'Filter aktualisieren',
...
'Use this field for details about position or relationships of the family member': 'Nutzen Sie dieses Feld für Details zu Stellung bzw. Verwandschaftsverhältnissen des Familienmitglieds',
...
'Utilization % (Average)': 'Auslastung % (Durchschnitt)',
...
'Verification updated': 'Verifizierung aktualisiert',
...
'Verify signature: %(signature)s': 'Signatur prüfen: %(signature)s',
'Very Good': 'Sehr gut',
'Very High': 'Sehr hoch',
...
'Vulnerability Type created': 'Vulnerabilitätstyp angelegt',
'Vulnerability Type deleted': 'Vulnerabilitätstyp gelöscht',
'Vulnerability Type updated': 'Vulnerabilitätstyp aktualisiert',
...
'Warning: this housing unit is full': 'Warnung: diese Wohneinheit ist voll',
'Warning: this shelter is full': 'Warnung: diese Unterkunft ist voll',
...
'Yemen': 'Jemen',
'Yes': 'Ja',
'Yes, check-out the selected residents': 'Ja, die ausgewählten Bewohner auschecken',
'Yes, delete the selected details': 'Ja, die ausgewählten Details löschen',
'Yes, generate a new registration card': 'Ja, eine neue Registrierungskarte erstellen',
'Yes, mark the selected appointments as completed': 'Ja, die ausgewählten Termine als erledigt markieren',
'Yiddish': 'Jiddisch',
...
'You have to select a housing unit belonging to the shelter': 'Sie müssen eine Wohneinheit auswählen, die zur Unterkunft gehört',
...
'You must be reported as present at the site yourself in order to register the presence of others.': 'Sie müssen selbst vor Ort anwesend gemeldet sein, um die Anwesenheit anderer melden zu können.',
...
'You must confirm the action': 'Sie müssen die Aktion bestätigen',
...
'Zambia': 'Sambia',
'Zapotec': 'Zapotekisch',
'Zaza; Dimili; Dimli; Kirdki; Kirmanjki; Zazaki': 'Zazaisch',
...
'female': 'weiblich',
'first or last name': 'Vor- oder Nachname',
'flag': 'Flagge',
'flags': 'Flaggen',
'fluent': 'fliessend',
...
'in Housing Units': 'in Wohneinheiten',
...
'not provided': 'nicht vorliegend',
'not required': 'nicht erforderlich',
'not specified': 'nicht angegeben',
'not up to requirements': 'nicht den Anforderungen entsprechend',
...
'private': 'privat',
'provided / appropriate': 'vorliegend / sachgemäß',
...
'separated': 'getrennt',
'set by Administrator': 'durch Administrator festgelegt',
'set##unit': 'Satz',
'shaved': 'rasiert',
'short': 'kurz',
'short<6cm': 'kurz < 6cm',
