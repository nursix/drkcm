"""
    RLPRCM: Migrant Reception Center and Case Management System
...
def config(settings):
    ...
    # PrePopulate data
    settings.base.prepopulate += ("RLPRCM",)
    settings.base.prepopulate_demo += ("RLPRCM/Demo",)

    # Theme (folder to use for views/layout.html)
    settings.base.theme = "RLP"
    settings.base.theme_config = "RLPRCM"
    settings.base.theme_layouts = "RLPRCM"

    # Custom models/controllers
    settings.base.models = "templates.RLPRCM.models"
