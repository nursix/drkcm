...
def config(settings):
    """
        ...
        http://sahanafoundation.org/deployments/los-angles-county-department-of-public-health/
    """
    ...
    # -----------------------------------------------------------------------------
    # Pre-Populate
    settings.base.prepopulate += ("historic/CRMT", "default/users", "historic/Demo")
    ...
    settings.base.theme = "historic.CRMT"
    ...
    settings.ui.hierarchy_theme = dict(css = "../themes/CRMT",
                                       icons = True,
                                       stripes = False,
                                       )
    ...
    $(document).ready(function(){
     $('.slick-slider').slick({
      dots:true
        ...
        S3CustomController()._view("CRMT", "dashboard.html")
