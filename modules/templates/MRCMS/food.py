...
# =============================================================================
class MRCMSRegisterFoodEvent(DVRRegisterCaseEvent):
    """
        Special variant of DVRRegisterCaseEvent for MRCMS food distribution,
    ...
    def inject_js(widget_id, options):
        ...
        # @Todo: minify?
        #if s3.debug:
        #    script = "/%s/static/themes/JUH/js/food.js" % appname
        #else:
        #    script = "/%s/static/themes/JUH/js/food.min.js" % appname
        script = "/%s/static/themes/JUH/js/food.js" % appname
