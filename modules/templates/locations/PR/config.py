...
def config(settings):
    """
        Template settings for Puerto Rico
    ...
    # Pre-Populate
    settings.base.prepopulate.append("locations/PR")

    # Restrict to specific country/countries
    settings.gis.countries.append("PR")
    ...
    settings.L10n.timezone = "America/Puerto_Rico"
