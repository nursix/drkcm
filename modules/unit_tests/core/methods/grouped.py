...
# python web2py.py -S eden -M -R applications/eden/modules/unit_tests/core/methods/grouped.py
#
import unittest

from core import S3GroupedItems, S3GroupAggregate

from unit_tests import run_suite

# =============================================================================
class GroupedItemsTests(unittest.TestCase):
