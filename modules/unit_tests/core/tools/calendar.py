...
# python web2py.py -S eden -M -R applications/eden/modules/unit_tests/core/tools/calendar.py
#
import datetime
import dateutil
import dateutil.tz
...
class CalendarTests(unittest.TestCase):
    ...
    def testConstructionWithSubclass(self):
        ...
        c._calendars[CALENDAR] = TestCalendar

        # Verify defaults
        assertEqual(c.name, CALENDAR)
        assertTrue(type(c.calendar) is TestCalendar)
    ...
    def testSubclassing(self):
        ...
        assertEqual(s3.calendar_test_parse, TestCalendar.CALENDAR)
        assertEqual(s3.calendar_test_gdate, TestCalendar.CALENDAR)

        # Call format_date
        s3.calendar_test_format = None
        c.format_date(datetime.date(1977, 3, 15), dtfmt = "%Y-%m-%d")
        assertEqual(s3.calendar_test_format, TestCalendar.CALENDAR)
        assertEqual(s3.calendar_test_cdate, TestCalendar.CALENDAR)
...
# =============================================================================
class NepaliCalendarTests(unittest.TestCase):
