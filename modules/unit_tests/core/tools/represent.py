...
# python web2py.py -S eden -M -R applications/eden/modules/unit_tests/core/tools/represent.py
#
import unittest
...
# =============================================================================
class BulkRepresentTests(unittest.TestCase):
...
# =============================================================================
class ExtractLazyFKRepresentationTests(unittest.TestCase):
...
#=============================================================================
class ExportLazyFKRepresentationTests(unittest.TestCase):
...
if __name__ == "__main__":
    ...
    run_suite(
        BulkRepresentTests,
        ExtractLazyFKRepresentationTests,
        ExportLazyFKRepresentationTests,
    )
